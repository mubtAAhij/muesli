...
actor TranscriptionCoordinator {
    ...
    func preloadRequired(
        ...
        case "whisper":
            ...
            let warming = ModelDownloadProgress.preparing(
                ...
                message: String(localized: "transcription_runtime.status.warming_up_model", defaultValue: "Warming up model...", bundle: .module, comment: "Status text shown while transcription model is warming up.")
            )
            ...
            progress?(1.0, nil)
            progressSnapshot?(warming.replacing(phase: .ready, message: String(localized: "transcription_runtime.status.model_ready", defaultValue: "Model ready", bundle: .module, comment: "Status text shown when transcription model is ready.")))
        case "nemotron35":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 1, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.nemotron35_requires_macos15_or_later", defaultValue: "Nemotron 3.5 requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Nemotron 3.5 model requiring newer macOS."),
                ])
            }
        case "qwen":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 2, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.qwen3_asr_requires_macos15_or_later", defaultValue: "Qwen3 ASR requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Qwen3 ASR model requiring newer macOS."),
                ])
            }
        case "cohere":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 4, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.cohere_transcribe_requires_macos15_or_later", defaultValue: "Cohere Transcribe requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Cohere Transcribe model requiring newer macOS."),
                ])
            }
        case "indicasr":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 6, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.indic_asr_requires_macos15_or_later", defaultValue: "Indic ASR requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Indic ASR model requiring newer macOS."),
                ])
            }
        case "sensevoice":
        ...
        case "gemma4-litert":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 7, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.gemma4_e2b_requires_macos15_or_later", defaultValue: "Gemma 4 E2B requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Gemma 4 E2B model requiring newer macOS."),
                ])
            }
        case "apple-speech":
            if #available(macOS 26.0, *) {
        ...
        default:
            throw NSError(domain: "MuesliTranscriptionRuntime", code: 5, userInfo: [
                NSLocalizedDescriptionKey: String(format: String(localized: "transcription_runtime.error.unknown_backend", defaultValue: "Unknown transcription backend: %@", bundle: .module, comment: "Error text for unsupported transcription backend."), "\(backend.backend)"),
            ])
        }
    ...
    private func transcribeWithQwen3(url: URL) async throws -> SpeechTranscriptionResult {
        if #available(macOS 15, *) {
            ...
            throw NSError(domain: "Muesli", code: 1, userInfo: [
                NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.qwen3_asr_requires_macos15_or_later", defaultValue: "Qwen3 ASR requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Qwen3 ASR model in secondary code path."),
            ])
        }
    }
    ...
    private func transcribeWithGemma4LiteRT(url: URL) async throws -> SpeechTranscriptionResult {
        if #available(macOS 15, *) {
            ...
            throw NSError(domain: "MuesliTranscriptionRuntime", code: 7, userInfo: [
                NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.gemma4_e2b_requires_macos15_or_later", defaultValue: "Gemma 4 E2B requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Gemma 4 E2B model in secondary code path."),
            ])
        }
    }
    ...
    private func transcribeWithCohere(
        ...
        if #available(macOS 15, *) {
            ...
            throw NSError(domain: "Muesli", code: 1, userInfo: [
                NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.cohere_transcribe_requires_macos15_or_later", defaultValue: "Cohere Transcribe requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Cohere Transcribe model in secondary code path."),
            ])
        }
    }
    ...
    private func transcribeWithIndicASR(
        ...
        if #available(macOS 15, *) {
            ...
            throw NSError(domain: "Muesli", code: 1, userInfo: [
                NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.indic_asr_requires_macos15_or_later", defaultValue: "Indic ASR requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Indic ASR model in secondary code path."),
            ])
        }
    }
    ...
    private func transcribeWithNemotron35(url: URL) async throws -> SpeechTranscriptionResult {
        if #available(macOS 15, *) {
            ...
            throw NSError(domain: "Muesli", code: 1, userInfo: [
                NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.nemotron35_requires_macos15_or_later", defaultValue: "Nemotron 3.5 requires macOS 15 or later.", bundle: .module, comment: "Compatibility error for Nemotron 3.5 model in secondary code path."),
            ])
        }
    }
