    ...
    func preloadRequired(
        ...
        case "whisper":
            ...
            let warming = ModelDownloadProgress.preparing(
                ...
                message: String(localized: "transcription_runtime.status.warming_up_model", defaultValue: "Warming up model...", bundle: .module, comment: "Status shown while initializing transcription model.")
            )
        ...
        case "nemotron35":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 1, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.nemotron35_requires_macos15_or_later", defaultValue: "Nemotron 3.5 requires macOS 15 or later.", bundle: .module, comment: "Error shown when Nemotron 3.5 backend is unavailable on older macOS versions."),
                ])
            }
        case "qwen":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 2, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.qwen3_asr_requires_macos15_or_later", defaultValue: "Qwen3 ASR requires macOS 15 or later.", bundle: .module, comment: "Error shown when Qwen3 ASR backend is unavailable on older macOS versions."),
                ])
            }
        case "cohere":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 4, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.cohere_transcribe_requires_macos15_or_later", defaultValue: "Cohere Transcribe requires macOS 15 or later.", bundle: .module, comment: "Error shown when Cohere Transcribe backend is unavailable on older macOS versions."),
                ])
            }
        case "indicasr":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 6, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.indic_asr_requires_macos15_or_later", defaultValue: "Indic ASR requires macOS 15 or later.", bundle: .module, comment: "Error shown when Indic ASR backend is unavailable on older macOS versions."),
                ])
            }
        case "sensevoice":
        ...
        case "gemma4-litert":
            if #available(macOS 15, *) {
                ...
                throw NSError(domain: "MuesliTranscriptionRuntime", code: 7, userInfo: [
                    NSLocalizedDescriptionKey: String(localized: "transcription_runtime.error.gemma4_e2b_requires_macos15_or_later", defaultValue: "Gemma 4 E2B requires macOS 15 or later.", bundle: .module, comment: "Error shown when Gemma 4 E2B backend is unavailable on older macOS versions."),
                ])
            }
        case "apple-speech":
            if #available(macOS 26.0, *) {
        ...
        default:
            throw NSError(domain: "MuesliTranscriptionRuntime", code: 5, userInfo: [
                NSLocalizedDescriptionKey: String(format: String(localized: "transcription_runtime.error.unknown_backend", defaultValue: "Unknown transcription backend: %@", bundle: .module, comment: "Error shown when an unsupported transcription backend identifier is encountered."), "\(backend.backend)"),
            ])
        }
