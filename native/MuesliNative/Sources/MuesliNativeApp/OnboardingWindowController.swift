...
final class OnboardingWindowController: NSObject, NSWindowDelegate {
    ...
    private func buildWindow() {
        ...
        window.title = String(localized: "onboarding_window.welcome_title", defaultValue: "Welcome to Muesli", bundle: .module, comment: "Title shown on the onboarding welcome window")
