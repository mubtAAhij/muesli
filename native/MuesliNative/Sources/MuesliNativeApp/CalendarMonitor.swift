...
final class CalendarMonitor {
        ...
        for event in events {
            ...
            if startDate <= now && endDate > now {
                ...
                return UpcomingMeetingEvent(
                    id: eventID,
                    title: event.title ?? String(localized: "calendar_monitor.fallback.meeting_title", defaultValue: "Meeting", bundle: .module, comment: "Fallback title used when a calendar meeting has no subject."),
                    startDate: startDate,
    ...
    private static func typeLabel(for type: EKCalendarType) -> String {
        ...
        @unknown default: return String(localized: "calendar_monitor.source_type.calendar", defaultValue: "Calendar", bundle: .module, comment: "Calendar source type label for generic calendar sources.")
        }
    }
