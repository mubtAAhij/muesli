...
final class CalendarMonitor {
        ...
        for event in events {
            ...
            if startDate <= now && endDate > now {
                ...
                return UpcomingMeetingEvent(
                    id: eventID,
                    title: event.title ?? String(localized: "calendar_monitor.fallback.meeting_title", defaultValue: "Meeting", bundle: .module, comment: "Fallback meeting title used when calendar event title is unavailable."),
                    startDate: startDate,
    ...
    private static func typeLabel(for type: EKCalendarType) -> String {
        switch type {
        case .local: return String(localized: "calendar_monitor.source_type.local", defaultValue: "Local", bundle: .module, comment: "Calendar source type label for local calendars.")
        case .calDAV: return String(localized: "calendar_monitor.source_type.caldav", defaultValue: "CalDAV", bundle: .module, comment: "Calendar source type label for CalDAV calendars.")
        case .exchange: return String(localized: "calendar_monitor.source_type.exchange", defaultValue: "Exchange", bundle: .module, comment: "Calendar source type label for Exchange calendars.")
        case .subscription: return String(localized: "calendar_monitor.source_type.subscription", defaultValue: "Subscription", bundle: .module, comment: "Calendar source type label for subscribed calendars.")
        case .birthday: return String(localized: "calendar_monitor.source_type.birthday", defaultValue: "Birthday", bundle: .module, comment: "Calendar source type label for birthday calendars.")
        @unknown default: return String(localized: "calendar_monitor.source_type.calendar", defaultValue: "Calendar", bundle: .module, comment: "Calendar source type label for generic calendar source.")
        }
    }
