        ...
        for event in events {
            ...
            if startDate <= now && endDate > now {
                ...
                return UpcomingMeetingEvent(
                    id: eventID,
                    title: event.title ?? String(localized: "calendar_monitor.fallback.meeting_title", defaultValue: "Meeting", bundle: .module, comment: "Fallback calendar event title when no meeting title is available"),
                    startDate: startDate,
