...
enum FeatureTourCatalog {
    ...
    static func latest(
        ...
        var steps = [
            FeatureTourStep(
                id: "timeline",
                eyebrow: String(localized: "feature_tour.timeline.heading", defaultValue: "ONE TIMELINE", bundle: .module, comment: "Feature tour heading introducing unified timeline feature."),
                title: String(localized: "feature_tour.timeline.title", defaultValue: "Dictations and meetings, together", bundle: .module, comment: "Feature tour title describing combined dictations and meetings timeline."),
                message: String(localized: "feature_tour.timeline.body", defaultValue: "Timeline puts your recent work in one chronological view. Open it from the sidebar whenever you want to retrace what you dictated or discussed.", bundle: .module, comment: "Feature tour body copy explaining timeline usage."),
        ...
        if includeApplicationFilter {
            steps.append(FeatureTourStep(
                id: "timeline-apps",
                eyebrow: String(localized: "feature_tour.timeline_apps.heading", defaultValue: "FILTER BY APP", bundle: .module, comment: "Feature tour heading introducing app filter in timeline."),
                title: String(localized: "feature_tour.timeline_apps.title", defaultValue: "Find dictations by destination app", bundle: .module, comment: "Feature tour title for filtering timeline entries by destination app."),
                message: String(localized: "feature_tour.timeline_apps.body", defaultValue: "Use Apps to narrow Timeline to dictations sent to a specific destination, such as Mail, Notes, or your browser.", bundle: .module, comment: "Feature tour body copy for app-based timeline filtering."),
        ...
        if includeAppleSpeech {
            steps.append(FeatureTourStep(
                id: "apple-speech",
                eyebrow: String(localized: "feature_tour.apple_speech.heading", defaultValue: "ON-DEVICE SPEECH", bundle: .module, comment: "Feature tour heading introducing on-device Apple Speech transcription."),
                title: String(localized: "feature_tour.apple_speech.title", defaultValue: "Try Apple's native on-device speech model", bundle: .module, comment: "Feature tour title encouraging use of Apple's on-device speech model."),
                message: String(localized: "feature_tour.apple_speech.body", defaultValue: "On macOS 26, Apple Speech can transcribe without a separate model download. Use your system language or choose another supported language in Models.", bundle: .module, comment: "Feature tour body copy explaining Apple Speech availability and language selection."),
        ...
        if includeMeetingPeople {
            steps.append(FeatureTourStep(
                id: "meeting-people",
                eyebrow: String(localized: "feature_tour.meeting_attendees.heading", defaultValue: "MEETING ATTENDEES", bundle: .module, comment: "Feature tour heading introducing meeting attendees support."),
                title: String(localized: "feature_tour.meeting_attendees.title", defaultValue: "Meeting attendees are now available!", bundle: .module, comment: "Feature tour title announcing meeting attendees capability."),
                message: String(localized: "feature_tour.meeting_attendees.body", defaultValue: "See organizers and attendees from calendar events, or add people from Apple Contacts directly to a meeting.", bundle: .module, comment: "Feature tour body copy describing attendee sources and contact integration."),
