...
struct InsightsShareSheet: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            HStack {
                VStack(alignment: .leading, spacing: 3) {
                    Text(String(localized: "insights_share.title", defaultValue: "Share your activity", bundle: .module, comment: "Title for insights sharing sheet."))
                        ...
                        .tracking(-0.4)
                    Text(String(localized: "insights_share.subtitle.privacy", defaultValue: "A private snapshot with no transcripts or account details", bundle: .module, comment: "Subtitle describing privacy of shared insights image."))
                        .font(.system(size: 12))
                        .foregroundStyle(.secondary)
                }
                Spacer()
                Button(String(localized: "common.done", defaultValue: "Done", bundle: .module, comment: "Common done button label.")) { dismiss() }
            ...
            .accessibilityLabel(String(localized: "insights_share.preview.accessibility_label", defaultValue: "Preview of your Muesli activity image", bundle: .module, comment: "Accessibility label for share preview image."))
            ...
            if let saveErrorMessage {
                HStack(alignment: .top, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        Text(String(localized: "insights_share.error.save_failed", defaultValue: "The image couldn’t be saved", bundle: .module, comment: "Error text shown when saving share image fails."))
                    ...
                    .buttonStyle(.plain)
                    .accessibilityLabel(String(localized: "insights_share.error.dismiss.accessibility_label", defaultValue: "Dismiss save error", bundle: .module, comment: "Accessibility label for dismissing save error message."))
                }
                .padding(10)
            ...
            HStack(spacing: 10) {
                Button {
                    ...
                    Label(String(localized: "insights_share.action.copy_image", defaultValue: "Copy Image", bundle: .module, comment: "Action button label to copy generated image."), systemImage: "doc.on.doc")
                }
                ...
                Button {
                    ...
                    Label(String(localized: "insights_share.action.save_png", defaultValue: "Save PNG", bundle: .module, comment: "Action button label to save generated image as PNG."), systemImage: "arrow.down.to.line")
                }

                Button {
                    shareImage()
                } label: {
                    Label(String(localized: "insights_share.action.share", defaultValue: "Share…", bundle: .module, comment: "Action button label to open share sheet."), systemImage: "square.and.arrow.up")
                }
    ...
    private func copyImage() {
        ...
        showConfirmation(String(localized: "insights_share.confirmation.copied", defaultValue: "Copied", bundle: .module, comment: "Confirmation text shown after copying image."))
    }
    ...
    private func saveImage() {
        ...
        panel.begin { response in
            ...
            Task { @MainActor in
                ...
                case .saved:
                    saveErrorMessage = nil
                    showConfirmation(String(localized: "insights_share.confirmation.saved", defaultValue: "Saved", bundle: .module, comment: "Confirmation text shown after saving image."))
...
enum InsightsShareRenderer {
    ...
    static func renderTemplate() -> NSImage? {
        ...
        let renderer = ImageRenderer(
            content: InsightsShareCard(snapshot: snapshot, rangeLabel: String(localized: "insights_share.card.your_range", defaultValue: "YOUR RANGE", bundle: .module, comment: "Insights card heading for selected time range."), showsNumbers: false)
                .frame(width: size.width, height: size.height)
        )
        renderer.scale = 1
        renderer.isOpaque = true
...
private struct InsightsShareCard: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Text(String(localized: "insights_share.metric.words_captured", defaultValue: "WORDS CAPTURED", bundle: .module, comment: "Metric label for words captured count."))
                ...
                HStack(spacing: 0) {
                    ...
                    shareDivider
                    shareDatum(value: showsNumbers ? "\(Int(snapshot.selected.averageWPM.rounded()))" : "—", label: String(localized: "insights_share.metric.average_wpm", defaultValue: "AVERAGE WPM", bundle: .module, comment: "Metric label for average words-per-minute value."))
                    shareDivider
                    shareDatum(value: showsNumbers ? dayCount(snapshot.currentStreakDays) : "—", label: String(localized: "insights_share.metric.current_streak", defaultValue: "CURRENT STREAK", bundle: .module, comment: "Metric label for current streak length."))
                    shareDivider
                    shareDatum(value: showsNumbers ? dayCount(snapshot.longestStreakDays) : "—", label: String(localized: "insights_share.metric.longest_streak", defaultValue: "LONGEST STREAK", bundle: .module, comment: "Metric label for longest streak length."))
                }
                .padding(.vertical, 24)
                ...
                HStack {
                    Text(String(localized: "insights_share.footer.privacy_tagline", defaultValue: "Private by design. Made on this Mac.", bundle: .module, comment: "Footer privacy tagline on share card."))
    ...
    private func dayCount(_ value: Int) -> String {
        "\(value) \(value == 1 ? String(localized: "insights_share.day_count.day_singular", defaultValue: "DAY", bundle: .module, comment: "Singular day unit label on share card.") : String(localized: "insights_share.day_count.day_plural", defaultValue: "DAYS", bundle: .module, comment: "Plural day unit label on share card."))"
    }
}
