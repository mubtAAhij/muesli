...
struct SettingsView: View {
    private enum PendingDataDestruction {
        ...
        var title: String {
            switch self {
            case .dictations:
                return String(localized: "settings.clear_history.dictations.title", defaultValue: "Clear dictation history?", bundle: .module, comment: "Confirmation alert title for clearing dictation history.")
            case .meetings:
                return String(localized: "settings.clear_history.meetings.title", defaultValue: "Clear meeting history?", bundle: .module, comment: "Confirmation alert title for clearing meeting history.")
            }
        }
        ...
        var message: String {
            switch self {
            case .dictations:
                return String(localized: "settings.clear_history.dictations.message", defaultValue: "This will permanently remove all saved dictations. This cannot be undone.", bundle: .module, comment: "Warning message shown when clearing dictation history.")
            case .meetings:
                return String(localized: "settings.clear_history.meetings.message", defaultValue: "This will permanently remove all saved meetings, notes, transcripts, and retained audio recordings. This cannot be undone.", bundle: .module, comment: "Warning message shown when clearing meeting history.")
            }
        }
        ...
        var confirmLabel: String {
            switch self {
            case .dictations:
                return String(localized: "settings.clear_history.dictations.confirm", defaultValue: "Clear Dictations", bundle: .module, comment: "Destructive confirmation button for clearing dictations.")
            case .meetings:
                return String(localized: "settings.clear_history.meetings.confirm", defaultValue: "Clear Meetings", bundle: .module, comment: "Destructive confirmation button for clearing meetings.")
            }
        }
    }
    ...
    private var meetingLiveTranscriptDescription: String {
        ...
        guard appState.config.enableLiveStreamingPartials,
              downloadedMeetingLiveCaptionBackends.contains(selected) else {
            return String(localized: "settings.meeting_live_transcript.description.completed_only", defaultValue: "Shows completed transcript segments only.", bundle: .module, comment: "Description for transcript mode showing only completed segments.")
        }
        if usesUnifiedMeetingTranscript {
            return String(localized: "settings.meeting_live_transcript.description.live_and_final", defaultValue: "Creates the live and final transcript.", bundle: .module, comment: "Description for transcript mode that includes live and final output.")
        }
        return String(localized: "settings.meeting_live_transcript.description.low_latency_preview", defaultValue: "Adds a low-latency preview.", bundle: .module, comment: "Description for transcript mode with low-latency preview.")
    }
    ...
    private var selectedMeetingBackendLabel: String {
        ...
        return meetingBackendOptions.first?.label ?? String(localized: "settings.meeting_backend.no_downloaded_models", defaultValue: "No downloaded models", bundle: .module, comment: "Status text shown when no meeting backend models are downloaded.")
    }
    ...
    private var cleanupBackendDescription: String {
        if appState.selectedPostProcessorBackend == .local {
            return downloadedPostProcOptions.isEmpty
                ? String(localized: "settings.cleanup_backend.description.download_model", defaultValue: "Download a cleanup model from Models to refine dictations on this Mac.", bundle: .module, comment: "Guidance text for downloading a cleanup model.")
        ...
        if appState.selectedPostProcessorBackend == .gemma4LiteRT {
            return Gemma4LiteRTModelStore.isAvailableLocally()
                ? String(localized: "settings.cleanup_backend.description.gemma4_refinement", defaultValue: "Uses the downloaded Gemma 4 model to refine dictated text on this Mac.", bundle: .module, comment: "Description for Gemma 4 cleanup backend behavior.")
                : String(localized: "settings.cleanup_backend.description.download_gemma4_for_cleanup", defaultValue: "Download Gemma 4 E2B from Models to use it for cleanup.", bundle: .module, comment: "Guidance text for downloading Gemma 4 cleanup model.")
        }
        return String(format: String(localized: "settings.cleanup_backend.description.sends_to_backend_with_latency", defaultValue: "Sends dictated text to %@ and may add latency.", bundle: .module, comment: "Description for remote cleanup backend with potential latency."), "\(appState.selectedPostProcessorBackend.label)")
    }
    ...
    private var selectedDictationMicrophoneLabel: String {
        ...
        return dictationMicrophoneOptions.first(where: { $0.uid == selectedUID })?.label ?? String(localized: "settings.microphone.option.automatic", defaultValue: "Automatic", bundle: .module, comment: "Microphone selection option for automatic device choice.")
    }
    ...
    private var selectedMeetingMicrophoneLabel: String {
        ...
        return meetingMicrophoneOptions.first(where: { $0.uid == selectedUID })?.label ?? String(localized: "settings.microphone.option.automatic", defaultValue: "Automatic", bundle: .module, comment: "Microphone selection option for automatic device choice.")
    }

    private func microphoneOptions(selectedUID: String?) -> [MicrophoneOption] {
        var options = [MicrophoneOption(uid: nil, label: String(localized: "settings.microphone.option.automatic", defaultValue: "Automatic", bundle: .module, comment: "Microphone selection option for automatic device choice."))]
        ...
        if let selectedUID, !options.contains(where: { $0.uid == selectedUID }) {
            options.append(MicrophoneOption(uid: selectedUID, label: String(localized: "settings.microphone.option.selected_unavailable", defaultValue: "Selected microphone unavailable", bundle: .module, comment: "Warning shown when previously selected microphone is unavailable.")))
        }
        return options
    }
        ...
        ScrollViewReader { scrollProxy in
            ScrollView {
                VStack(alignment: .leading, spacing: MuesliTheme.spacing24) {
                    Text(String(localized: "settings.title", defaultValue: "Settings", bundle: .module, comment: "Title for the settings screen."))
            ...
            .alert(
                pendingDataDestruction?.title ?? String(localized: "settings.alert.confirm_destructive_action.title", defaultValue: "Confirm Destructive Action", bundle: .module, comment: "Alert title asking user to confirm destructive action."),
                isPresented: Binding(
                    get: { pendingDataDestruction != nil },
                    set: { if !$0 { pendingDataDestruction = nil } }
                )
            ) {
                Button(String(localized: "settings.action.cancel", defaultValue: "Cancel", bundle: .module, comment: "Cancel button title in settings alerts."), role: .cancel) {
                    pendingDataDestruction = nil
                }
                Button(pendingDataDestruction?.confirmLabel ?? String(localized: "settings.action.delete", defaultValue: "Delete", bundle: .module, comment: "Destructive delete button title in settings alerts."), role: .destructive) {
            ...
            .alert(
                String(localized: "settings.alert.enable_accessibility.title", defaultValue: "Enable Accessibility?", bundle: .module, comment: "Alert title prompting accessibility permission enablement."),
                ...
                Button(String(localized: "settings.alert.action.enable", defaultValue: "Enable", bundle: .module, comment: "Primary action button to enable a requested permission.")) {
                    controller.requestDictionaryCorrectionAccessibilityEnable()
                }
            } message: {
                Text(String(localized: "settings.alert.enable_accessibility.message", defaultValue: "Dictionary suggestions briefly read focused app text via Accessibility after dictation. Grant access, then relaunch Muesli to turn suggestions on.", bundle: .module, comment: "Accessibility alert message explaining why permission is needed."))
            }
    ...
    private static let accentPresets: [(hex: String, name: String)] = [
        ("2563eb", String(localized: "settings.accent_presets.blue", defaultValue: "Blue", bundle: .module, comment: "Accent color preset name for blue.")),
        ("ef4444", String(localized: "settings.accent_presets.red", defaultValue: "Red", bundle: .module, comment: "Accent color preset name for red.")),
        ("f59e0b", String(localized: "settings.accent_presets.amber", defaultValue: "Amber", bundle: .module, comment: "Accent color preset name for amber.")),
        ("10b981", String(localized: "settings.accent_presets.green", defaultValue: "Green", bundle: .module, comment: "Accent color preset name for green.")),
        ("8b5cf6", String(localized: "settings.accent_presets.purple", defaultValue: "Purple", bundle: .module, comment: "Accent color preset name for purple.")),
        ("ec4899", String(localized: "settings.accent_presets.pink", defaultValue: "Pink", bundle: .module, comment: "Accent color preset name for pink.")),
        ("1e1e2e", String(localized: "settings.accent_presets.dark", defaultValue: "Dark", bundle: .module, comment: "Accent color preset name for dark theme accent.")),
    ]

    private func screenContextDescription(includesScreenOCR: Bool) -> String {
        if !accessibilityGranted {
            return String(localized: "settings.screen_context.description.grant_accessibility_then_toggle", defaultValue: "Grant Accessibility, then toggle again if needed.", bundle: .module, comment: "Screen context helper text when accessibility permission is missing.")
        }
        if includesScreenOCR, !screenRecordingGranted {
            return String(localized: "settings.screen_context.description.app_text_plus_screen_recording_ocr", defaultValue: "Adds nearby app text for post-processing. Screen Recording enables OCR context.", bundle: .module, comment: "Screen context description when OCR requires screen recording permission.")
        }
        if includesScreenOCR {
            return String(localized: "settings.screen_context.description.app_text_and_ocr", defaultValue: "Adds nearby app text and OCR context.", bundle: .module, comment: "Screen context description when both app text and OCR context are enabled.")
        }
        return String(localized: "settings.screen_context.description.app_text_only", defaultValue: "Adds nearby app text for post-processing.", bundle: .module, comment: "Screen context description when only app text context is enabled.")
    }

    private var dictationOCRContextDescription: String {
        if !appState.config.enableScreenContext {
            return String(localized: "settings.dictation_ocr_context.description.turn_on_app_context_first", defaultValue: "Turn on App context first.", bundle: .module, comment: "Helper text prompting user to enable app context before OCR context.")
        }
        if !screenRecordingGranted {
            return String(localized: "settings.dictation_ocr_context.description.grant_screen_recording", defaultValue: "Grant Screen Recording to add frontmost-window OCR text.", bundle: .module, comment: "Helper text prompting user to grant Screen Recording permission for OCR context.")
        }
        return String(localized: "settings.dictation_ocr_context.description.ocr_text_cloud_cleanup_notice", defaultValue: "Adds frontmost-window OCR text. Cloud cleanup may send this text to the selected provider.", bundle: .module, comment: "Description explaining OCR context and cloud cleanup privacy implications.")
    }
    ...
    private var generalSettingsPane: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing24) {
            settingsSection(String(localized: "settings.section.general", defaultValue: "General", bundle: .module, comment: "Settings section header for general preferences.")) {
                VStack(alignment: .leading, spacing: MuesliTheme.spacing8) {
                    settingsRow(String(localized: "settings.general.launch_at_login", defaultValue: "Launch at login", bundle: .module, comment: "Settings row title for launch-at-login preference.")) {
                ...
                settingsRow(String(localized: "settings.general.open_dashboard_on_launch", defaultValue: "Open dashboard on launch", bundle: .module, comment: "Settings row title for opening dashboard at app launch.")) {
            ...
            settingsSection(String(localized: "settings.section.data", defaultValue: "Data", bundle: .module, comment: "Settings section header for data management options.")) {
                HStack(spacing: MuesliTheme.spacing12) {
                    actionButton(String(localized: "settings.data.clear_dictation_history", defaultValue: "Clear dictation history", bundle: .module, comment: "Settings action title to clear dictation history."), role: .destructive) {
                        pendingDataDestruction = .dictations
                    }
                    actionButton(String(localized: "settings.data.clear_meeting_history", defaultValue: "Clear meeting history", bundle: .module, comment: "Settings action title to clear meeting history."), role: .destructive) {
                        pendingDataDestruction = .meetings
                    }
                    .disabled(controller.isMeetingRecording())
                    .help(String(localized: "settings.general.help.stop_recording_before_clear_history-stop-the-current-meeting-rec", defaultValue: "Stop the current meeting recording before clearing meeting history.", bundle: .module, comment: "Help text shown when meeting recording must be stopped before clearing history."))
                }
            }
        }
    }
    ...
    private var launchAtLoginApprovalPrompt: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            ...
            Text(String(localized: "settings.launch_at_login.requires_approval_system_settings", defaultValue: "Requires approval in System Settings", bundle: .module, comment: "Status text indicating launch-at-login needs System Settings approval."))
                .font(MuesliTheme.caption())
                .foregroundStyle(MuesliTheme.textTertiary)
            ...
            Button {
                ...
                HStack(spacing: 6) {
                    ...
                    Text(String(localized: "settings.launch_at_login.action.open", defaultValue: "Open", bundle: .module, comment: "Button title to open System Settings from launch-at-login section."))
                }
            }
            .buttonStyle(.plain)
            ...
            .help(String(localized: "settings.launch_at_login.help.open_login_items_system_settings", defaultValue: "Open Login Items in System Settings", bundle: .module, comment: "Help/action label to navigate to Login Items in System Settings."))
        }
    ...
    private var syncSettingsPane: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing24) {
            settingsSection(String(localized: "settings.sync.icloud_text_sync.section_title", defaultValue: "iCloud Text Sync", bundle: .module, comment: "Section title for iCloud text synchronization settings.")) {
                settingsRow(String(localized: "settings.sync.private_icloud_sync", defaultValue: "Private iCloud sync", bundle: .module, comment: "Toggle title for private iCloud synchronization feature.")) {
                    settingsSwitch(isOn: appState.config.iCloudSyncEnabled) { newValue in
                        controller.setICloudSyncEnabledFromSettings(newValue)
                    }
                }
                settingsDescription(String(localized: "settings.sync.description.private_icloud_scope", defaultValue: "Sync dictation text, meeting transcripts, notes, summaries, and manual notes with Muesli for iPhone through your private iCloud account. Audio recordings are never synced.", bundle: .module, comment: "Description of what data is synced via private iCloud and what is excluded."))
                ...
                HStack(spacing: MuesliTheme.spacing12) {
                    VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                        ...
                        if let lastSyncedText = syncLastSyncedText {
                            Text(String(format: String(localized: "settings.sync.status.last_synced", defaultValue: "Last synced: %@", bundle: .module, comment: "Status label showing the last synchronization time."), "\(lastSyncedText)"))
                                .font(MuesliTheme.caption())
                                .foregroundStyle(MuesliTheme.textTertiary)
                        }
                    ...
                    actionButton(String(localized: "settings.sync.action.sync_now", defaultValue: "Sync now", bundle: .module, comment: "Button title to trigger immediate synchronization."), systemImage: "arrow.triangle.2.circlepath") {
            ...
            settingsSection(String(localized: "settings.sync.iphone_bridge.section_title", defaultValue: "iPhone Bridge", bundle: .module, comment: "Section title for iPhone bridge settings.")) {
                ...
                settingsDescription(String(localized: "settings.sync.iphone_bridge.description.keep_timeline_card", defaultValue: "Keep the timeline bridge card available while users connect Muesli on iPhone.", bundle: .module, comment: "Description for keeping timeline bridge card visible until iPhone is connected."))

                Divider().background(MuesliTheme.surfaceBorder)

                HStack(spacing: MuesliTheme.spacing12) {
                    VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                        Text(String(localized: "settings.sync.muesli_for_iphone", defaultValue: "Muesli for iPhone", bundle: .module, comment: "Section title for iPhone companion app information."))
                            .font(MuesliTheme.body())
                            .foregroundStyle(MuesliTheme.textPrimary)
                        Text(String(localized: "settings.sync.iphone_description", defaultValue: "Use iPhone for offline meetings, keyboard dictation, and private iCloud text sync with this Mac.", bundle: .module, comment: "Description of iPhone companion capabilities."))
                            .font(MuesliTheme.caption())
                            .foregroundStyle(MuesliTheme.textTertiary)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                    Spacer(minLength: MuesliTheme.spacing16)
                    actionButton(String(localized: "settings.sync.action.open_ios_app_page", defaultValue: "Open iOS app page", bundle: .module, comment: "Action button title to open iOS app listing.")) {
    ...
    private var syncStatusText: String {
        if !appState.config.iCloudSyncEnabled {
            return String(localized: "settings.sync.status.off_turn_on_bridge", defaultValue: "Sync is off. Turn it on to bridge this Mac with Muesli for iPhone.", bundle: .module, comment: "Status message shown when sync is disabled for iPhone bridge.")
        }
        return appState.iCloudSyncStatus ?? String(localized: "settings.sync.status.private_icloud_ready", defaultValue: "Private iCloud text sync is ready.", bundle: .module, comment: "Status message shown when private iCloud text sync is configured.")
    }
    ...
    private var syncLinkedDeviceText: String? {
        ...
        if let remoteDeviceName = appState.iCloudBridgeCompanionDeviceName {
            if let platform = appState.iCloudBridgeRemoteDevicePlatform {
                return String(format: String(localized: "settings.sync.linked_device.with_platform_and_name", defaultValue: "Linked %@: %@", bundle: .module, comment: "Linked device status including platform label and device name."), "\(syncDeviceLabel(for: platform))", "\(remoteDeviceName)")
            }
        ...
        return String(localized: "settings.sync.linked_device.none_iphone_yet", defaultValue: "No linked iPhone yet.", bundle: .module, comment: "Status message when no iPhone is linked.")
    }
    ...
    private var dictationModelSettingsSection: some View {
        settingsSection(String(localized: "settings.section.speech_recognition", defaultValue: "Speech Recognition", bundle: .module, comment: "Section header for speech recognition settings.")) {
            settingsRow(String(localized: "settings.speech_recognition.dictation_model", defaultValue: "Dictation model", bundle: .module, comment: "Settings row title for selecting dictation model."), controlWidth: meetingControlWidth) {
                settingsMenu(
            ...
            if !disabledDictationBackendLabels.isEmpty {
                settingsDescription(String(localized: "settings.speech_recognition.description.gemma4_unavailable_with_cleanup_backend", defaultValue: "Gemma 4 dictation is unavailable while Gemma 4 is the cleanup backend.", bundle: .module, comment: "Description explaining temporary unavailability of Gemma 4 dictation model."))
            }
            if appState.selectedBackend.backend == BackendOption.cohereTranscribe.backend {
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.speech_recognition.cohere_language", defaultValue: "Cohere language", bundle: .module, comment: "Settings row title for selecting Cohere transcription language."), controlWidth: meetingControlWidth) {
                    cohereLanguageMenu
                }
            }
            if appState.selectedBackend.backend == BackendOption.indicASR.backend {
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.speech_recognition.indic_language", defaultValue: "Indic language", bundle: .module, comment: "Settings row title for selecting Indic transcription language."), controlWidth: meetingControlWidth) {
                    indicLanguageMenu
                }
            }
            if appState.selectedBackend.supportsWhisperLanguageSelection {
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.speech_recognition.whisper_language", defaultValue: "Whisper language", bundle: .module, comment: "Settings row title for selecting Whisper transcription language."), controlWidth: meetingControlWidth) {
                    whisperLanguageMenu
                }
            }
        }
    ...
    private var meetingTranscriptionSettingsSection: some View {
        settingsSection(String(localized: "settings.section.transcription", defaultValue: "Transcription", bundle: .module, comment: "Section header for transcription capture settings.")) {
            settingsRow(
                "Microphone",
                description: String(localized: "settings.transcription.microphone.description.only_affects_muesli", defaultValue: "Only affects Muesli. Changes apply immediately.", bundle: .module, comment: "Description for microphone setting scope and apply behavior."),
            ...
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(
                String(localized: "settings.transcription.show_transcript_on_hover", defaultValue: "Show transcript on hover", bundle: .module, comment: "Toggle label for showing transcript preview on hover."),
            ...
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(
                String(localized: "settings.transcription.live_preview_model", defaultValue: "Live preview model", bundle: .module, comment: "Row title for selecting live preview transcription model."),
                ...
                if !downloadedMeetingLiveCaptionBackends.isEmpty {
                    ...
                    Text(String(localized: "settings.meeting_transcription.download_from_models", defaultValue: "Download from Models", bundle: .module, comment: "Action label to open models area for downloading transcription models."))
            ...
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(String(localized: "settings.transcription.final_transcript", defaultValue: "Final transcript", bundle: .module, comment: "Row title for selecting final transcript model."), controlWidth: meetingControlWidth) {
                if usesUnifiedMeetingTranscript {
                    Text(String(format: String(localized: "settings.transcription.final_transcript.same_model", defaultValue: "%@ (same model)", bundle: .module, comment: "Final transcript option label indicating same model as live preview."), "\(MeetingLiveCaptionBackend.nemotron35.label)"))
                        .font(MuesliTheme.body())
                        .foregroundStyle(MuesliTheme.textSecondary)
                        .frame(width: meetingControlWidth, alignment: .trailing)
                } else if meetingBackendOptions.isEmpty {
                    Text(String(localized: "settings.meeting_transcription.no_downloaded_models", defaultValue: "No downloaded models", bundle: .module, comment: "Status text shown when no transcription models are downloaded."))
                        .font(MuesliTheme.body())
                        .foregroundStyle(MuesliTheme.textTertiary)
            ...
            if usesUnifiedMeetingTranscript {
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.transcription.language", defaultValue: "Language", bundle: .module, comment: "Row title for transcription language selection."), controlWidth: meetingControlWidth) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.transcription.cohere_language", defaultValue: "Cohere language", bundle: .module, comment: "Row title for Cohere transcription language selection."), controlWidth: meetingControlWidth) {
                    cohereLanguageMenu
                }
            } else if appState.selectedMeetingTranscriptionBackend.backend == BackendOption.indicASR.backend {
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.transcription.indic_language", defaultValue: "Indic language", bundle: .module, comment: "Row title for Indic transcription language selection."), controlWidth: meetingControlWidth) {
                    indicLanguageMenu
                }
            } else if appState.selectedMeetingTranscriptionBackend.supportsWhisperLanguageSelection {
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.transcription.whisper_language", defaultValue: "Whisper language", bundle: .module, comment: "Row title for Whisper transcription language selection."), controlWidth: meetingControlWidth) {
                    whisperLanguageMenu
                }
            }
        }
    ...
    private var dictationCleanupSettingsSection: some View {
        settingsSection(String(localized: "settings.section.dictation_cleanup", defaultValue: "Dictation Cleanup", bundle: .module, comment: "Section header for dictation cleanup settings.")) {
            settingsRow(
                String(localized: "settings.dictation_cleanup.cleanup_backend", defaultValue: "Cleanup backend", bundle: .module, comment: "Row title for selecting dictation cleanup backend."),
            ...
            if !disabledCleanupBackendLabels.isEmpty {
                settingsDescription(String(localized: "settings.dictation_cleanup.description.gemma4_unavailable_with_dictation_model", defaultValue: "Gemma 4 cleanup is unavailable while Gemma 4 is the dictation model.", bundle: .module, comment: "Description explaining Gemma 4 cleanup availability constraint."))
            }
            if appState.selectedPostProcessorBackend == .local {
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.dictation_cleanup.model", defaultValue: "Cleanup model", bundle: .module, comment: "Row title for selecting dictation cleanup model."), controlWidth: meetingControlWidth) {
                    if downloadedPostProcOptions.isEmpty {
                        compactActionButton(String(localized: "settings.dictation_cleanup.action.view_cleanup_models", defaultValue: "View cleanup models", bundle: .module, comment: "Action label to view available cleanup models."), systemImage: "arrow.right") {
                ...
                settingsRow(String(localized: "settings.dictation_cleanup.model", defaultValue: "Cleanup model", bundle: .module, comment: "Row title for selecting dictation cleanup model."), controlWidth: meetingControlWidth) {
                    if Gemma4LiteRTModelStore.isAvailableLocally() {
                        Text(String(localized: "settings.dictation_cleanup.model.gemma_4_e2b_downloaded", defaultValue: "Gemma 4 E2B (Downloaded)", bundle: .module, comment: "Cleanup model option label when Gemma 4 E2B is downloaded."))
                            .font(.system(size: 12, weight: .medium))
                            .foregroundStyle(MuesliTheme.textSecondary)
                            .frame(width: meetingControlWidth, alignment: .trailing)
                    } else {
                        compactActionButton(String(localized: "settings.dictation_cleanup.action.view_gemma_model", defaultValue: "View Gemma model", bundle: .module, comment: "Action label to open Gemma model details/download page."), systemImage: "arrow.right") {
                            controller.showModels(category: .postProcessing)
                        }
                        .frame(width: meetingControlWidth, alignment: .trailing)
                    }
    ...
    private func hostedCleanupSettings(for backend: TranscriptCleanupBackendOption) -> some View {
        ...
        case .some(.chatGPT):
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(String(localized: "settings.hosted_cleanup.account", defaultValue: "Account", bundle: .module, comment: "Row title for hosted cleanup account selection."), controlWidth: meetingControlWidth) {
        ...
        case .some(.openAI):
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(String(localized: "settings.hosted_cleanup.api_key", defaultValue: "API Key", bundle: .module, comment: "Row title for entering hosted cleanup provider API key."), controlWidth: meetingControlWidth) {
                PastableSecureField(
        ...
        case .some(.openRouter):
            ...
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(String(localized: "settings.hosted_cleanup.model_preset", defaultValue: "Model preset", bundle: .module, comment: "Row title for selecting hosted cleanup model preset."), controlWidth: meetingControlWidth) {
                settingsModelMenu(
            ...
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(String(localized: "settings.hosted_cleanup.custom_model_id", defaultValue: "Custom model ID", bundle: .module, comment: "Row title for entering a custom hosted cleanup model identifier."), controlWidth: meetingControlWidth) {
        ...
        case .some(.ollama):
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(String(localized: "settings.hosted_cleanup.ollama_url", defaultValue: "Ollama URL", bundle: .module, comment: "Row title for configuring Ollama server URL."), controlWidth: meetingControlWidth) {
                PastableTextField(
        ...
        case .some(.lmStudio):
            Divider().background(MuesliTheme.surfaceBorder)
            settingsRow(String(localized: "settings.hosted_cleanup.lm_studio_url", defaultValue: "LM Studio URL", bundle: .module, comment: "Row title for configuring LM Studio server URL."), controlWidth: meetingControlWidth) {
                PastableTextField(
            ...
            settingsRow(String(localized: "settings.dictation_cleanup.model", defaultValue: "Cleanup model", bundle: .module, comment: "Row title for selecting dictation cleanup model."), controlWidth: meetingControlWidth) {
                settingsModelTextField(
                    ...
                    placeholder: String(localized: "settings.hosted_cleanup.loaded_lm_studio_model", defaultValue: "Loaded LM Studio model", bundle: .module, comment: "Row title indicating currently loaded LM Studio model.")
                ) { controller.updatePostProcessorModel($0, for: backend) }
            }
        case .some(.customLLM):
    ...
    private var cleanupPromptSettings: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
            settingsRow(String(localized: "settings.cleanup_prompt.cleanup_preset", defaultValue: "Cleanup preset", bundle: .module, comment: "Row title for selecting cleanup prompt preset."), controlWidth: meetingControlWidth) {
                FixedWidthPopUp(
            ...
            HStack {
                Spacer()
                compactActionButton(String(localized: "settings.cleanup_prompt.action.manage_presets", defaultValue: "Manage Presets…", bundle: .module, comment: "Action label to open cleanup preset management."), systemImage: "slider.horizontal.3") {
    ...
    private var meetingSummarySettingsSection: some View {
        settingsSection(String(localized: "settings.section.meeting_summaries", defaultValue: "Meeting Summaries", bundle: .module, comment: "Section header for meeting summary settings.")) {
            settingsRow(String(localized: "settings.meeting_summaries.summary_backend", defaultValue: "Summary backend", bundle: .module, comment: "Row title for selecting meeting summary backend."), controlWidth: meetingControlWidth) {
                settingsMenu(
            ...
            if appState.selectedMeetingSummaryBackend == .chatGPT {
                settingsRow(String(localized: "settings.meeting_summaries.account", defaultValue: "Account", bundle: .module, comment: "Row title for selecting account used by meeting summary backend."), controlWidth: meetingControlWidth) {
                    chatGPTAccountControl()
                }
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.meeting_summaries.model", defaultValue: "Model", bundle: .module, comment: "Row title for selecting meeting summary model."), controlWidth: meetingControlWidth) {
                    settingsModelMenu(
                ...
                settingsRow(String(localized: "settings.hosted_cleanup.api_key", defaultValue: "API Key", bundle: .module, comment: "Label for hosted cleanup API key setting"), controlWidth: meetingControlWidth) {
                    PastableSecureField(
                        text: appState.config.openAIAPIKey,
                        placeholder: "sk-...",
                        onChange: { val in controller.updateConfig { $0.openAIAPIKey = val } }
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.meeting_summaries.model", defaultValue: "Model", bundle: .module, comment: "Label for meeting summaries model setting"), controlWidth: meetingControlWidth) {
                    settingsModelMenu(
                ...
                settingsRow(String(localized: "settings.meeting_summaries.ollama_url", defaultValue: "Ollama URL", bundle: .module, comment: "Label for meeting summaries Ollama URL setting"), controlWidth: meetingControlWidth) {
                    PastableTextField(
                        text: appState.config.ollamaURL,
                        placeholder: "http://localhost:11434",
                        onChange: { val in controller.updateConfig { $0.ollamaURL = val } }
                ...
                settingsRow(String(localized: "settings.meeting_summaries.lm_studio_url", defaultValue: "LM Studio URL", bundle: .module, comment: "Label for meeting summaries LM Studio URL setting"), controlWidth: meetingControlWidth) {
                    PastableTextField(
                        text: appState.config.lmStudioURL,
                        placeholder: "http://localhost:1234",
                        onChange: { val in controller.updateConfig { $0.lmStudioURL = val } }
                ...
                settingsRow(String(localized: "settings.meeting_summaries.model", defaultValue: "Model", bundle: .module, comment: "Label for meeting summaries model setting"), controlWidth: meetingControlWidth) {
                    settingsModelTextField(
                        ...
                        placeholder: String(localized: "settings.meeting_summaries.select_loaded_lm_studio_model", defaultValue: "Select a loaded LM Studio model", bundle: .module, comment: "Prompt to select a loaded LM Studio model for meeting summaries")
    ...
    private func customLLMSettingsRows(model: String, onModelChange: @escaping (String) -> Void) -> some View {
        ...
        Divider().background(MuesliTheme.surfaceBorder)
        settingsRow(String(localized: "settings.custom_llm.endpoint", defaultValue: "Endpoint", bundle: .module, comment: "Label for custom LLM endpoint setting"), controlWidth: meetingControlWidth) {
            PastableTextField(
        ...
        Divider().background(MuesliTheme.surfaceBorder)
        settingsRow(String(localized: "settings.custom_llm.api_key", defaultValue: "API Key", bundle: .module, comment: "Label for custom LLM API key setting"), controlWidth: meetingControlWidth) {
            PastableSecureField(
                text: appState.config.customLLMAPIKey,
                placeholder: appState.config.customLLMFormat == CustomLLMFormat.anthropic.rawValue
                    ? String(localized: "settings.custom_llm.api_key.required_for_anthropic", defaultValue: "Required for Anthropic API", bundle: .module, comment: "Help text indicating API key is required for Anthropic API")
                    : String(localized: "settings.custom_llm.api_key.optional_for_local_servers", defaultValue: "Optional for local servers", bundle: .module, comment: "Help text indicating API key is optional for local servers"),
    ...
    private var dictationSettingsPane: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing24) {
            ...
            settingsSection(String(localized: "settings.section.transcription", defaultValue: "Transcription", bundle: .module, comment: "Title for transcription settings section")) {
                settingsRow(
                    "Microphone",
                    description: String(localized: "settings.dictation.microphone.description.automatic_system_or_mac_mic", defaultValue: "Automatic uses system input, or Mac mic with AirPods.", bundle: .module, comment: "Description for dictation microphone automatic behavior")
                ) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.dictation.ai_transcript_cleanup", defaultValue: "AI transcript cleanup", bundle: .module, comment: "Label for AI transcript cleanup setting")) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(
                    String(localized: "settings.dictation.dictionary_suggestions", defaultValue: "Dictionary suggestions", bundle: .module, comment: "Label for dictionary suggestions setting"),
                    ...
                    .help(String(localized: "settings.dictation.help.ocr_context_brief_description", defaultValue: "Briefly reads focused app text after dictation to detect corrections.", bundle: .module, comment: "Help text explaining OCR context behavior after dictation"))
                }
            }

            dictationCleanupSettingsSection

            settingsSection(String(localized: "settings.section.advanced", defaultValue: "Advanced", bundle: .module, comment: "Title for advanced settings section")) {
                settingsRow(String(localized: "settings.dictation.pause_media_during_dictation", defaultValue: "Pause media during dictation", bundle: .module, comment: "Toggle label to pause media during dictation")) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.dictation.mute_system_audio_during_dictation", defaultValue: "Mute system audio during dictation", bundle: .module, comment: "Toggle label to mute system audio during dictation")) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                screenContextRow(String(localized: "settings.dictation.app_context", defaultValue: "App context", bundle: .module, comment: "Label for app context dictation setting"))
                Divider().background(MuesliTheme.surfaceBorder)
    ...
    private var computerUseSettingsPane: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing24) {
            settingsSection(String(localized: "settings.section.computer_use", defaultValue: "Computer Use", bundle: .module, comment: "Title for computer use settings section")) {
                settingsRow(String(localized: "settings.computer_use.enable_planner", defaultValue: "Enable planner", bundle: .module, comment: "Toggle label to enable computer use planner"), controlWidth: meetingControlWidth) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.computer_use.planner_model", defaultValue: "Planner model", bundle: .module, comment: "Label for computer use planner model setting"), controlWidth: meetingControlWidth) {
                    settingsModelMenu(
                ...
                settingsRow(String(localized: "settings.computer_use.timeout", defaultValue: "Timeout", bundle: .module, comment: "Label for computer use timeout setting"), controlWidth: meetingControlWidth) {
                    Stepper(
                        ...
                        Text(String(format: String(localized: "settings.computer_use.timeout.seconds", defaultValue: "%d seconds", bundle: .module, comment: "Timeout value in seconds for computer use"), max(appState.config.computerUseTimeoutSeconds, 1)))
                            .font(MuesliTheme.body())
                            .foregroundStyle(MuesliTheme.textPrimary)
                    }
                }
    ...
    private var meetingsSettingsPane: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing24) {
            ...
            settingsSection(String(localized: "settings.section.meeting_context", defaultValue: "Meeting Context", bundle: .module, comment: "Title for meeting context settings section")) {
            ...
            settingsSection(String(localized: "settings.section.meeting_notes", defaultValue: "Meeting Notes", bundle: .module, comment: "Title for meeting notes settings section")) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.meetings.summary_retries", defaultValue: "Summary retries", bundle: .module, comment: "Label for meeting summary retries setting"), controlWidth: meetingControlWidth) {
                    Stepper(
                        value: Binding(
                            get: {
                ...
                settingsDescription(String(localized: "settings.meetings.summary_retries.description", defaultValue: "Retry transient AI summary failures before saving failed notes.", bundle: .module, comment: "Description for meeting summary retries setting"))
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.meetings.templates", defaultValue: "Templates", bundle: .module, comment: "Label for meeting templates section"), controlWidth: meetingControlWidth) {
                    actionButton(String(localized: "settings.meetings.action.manage_templates", defaultValue: "Manage Templates…", bundle: .module, comment: "Button title to manage meeting templates")) {
                        controller.showMeetingTemplatesManager()
                    }
                }
            }

            settingsSection(String(localized: "settings.section.recording", defaultValue: "Recording", bundle: .module, comment: "Title for recording settings section")) {
                settingsRow(String(localized: "settings.meetings.auto_record_calendar_meetings", defaultValue: "Auto-record calendar meetings", bundle: .module, comment: "Toggle label for auto-recording calendar meetings")) {
                ...
                if appState.config.meetingRecordingSavePolicy != .never {
                    Divider().background(MuesliTheme.surfaceBorder)
                    settingsRow(String(localized: "settings.meetings.recording_format", defaultValue: "Recording format", bundle: .module, comment: "Label for meeting recording format setting")) {
                        settingsMenu(
                    ...
                    settingsDescription(String(localized: "settings.meetings.recording_format.description", defaultValue: "M4A is recommended for smaller files. WAV is lossless and uses more storage.", bundle: .module, comment: "Description for meeting recording format options"))
                }
            }

            settingsSection(String(localized: "settings.section.auto_export", defaultValue: "Auto Export", bundle: .module, comment: "Title for auto export settings section")) {
                settingsRow(String(localized: "settings.meetings.auto_export_meetings", defaultValue: "Auto-export meetings", bundle: .module, comment: "Toggle label for auto-exporting meetings")) {
                ...
                if appState.config.autoExportMarkdownEnabled {
                    ...
                    Divider().background(MuesliTheme.surfaceBorder)
                    settingsRow(String(localized: "settings.meetings.content", defaultValue: "Content", bundle: .module, comment: "Label for auto export content setting")) {
                        settingsMenu(
                    ...
                    Divider().background(MuesliTheme.surfaceBorder)
                    settingsRow(String(localized: "settings.meetings.file_format", defaultValue: "File format", bundle: .module, comment: "Label for auto export file format setting")) {
                        settingsMenu(
                ...
                Text(String(localized: "settings.meetings.auto_export.description", defaultValue: "Automatically saves each completed meeting to the chosen folder in the selected format.", bundle: .module, comment: "Description for auto export behavior"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textTertiary)
                    .padding(.horizontal, MuesliTheme.spacing16)
            }

            settingsSection(String(localized: "settings.section.meeting_notifications", defaultValue: "Meeting Notifications", bundle: .module, comment: "Title for meeting notifications settings section")) {
                ...
                settingsDescription(String(localized: "settings.meetings.notifications.scheduled_meetings.description", defaultValue: "Show notifications for calendar meetings with a join link.", bundle: .module, comment: "Description for scheduled meeting notifications setting"))

                if appState.config.showScheduledMeetingNotifications {
                    Divider().background(MuesliTheme.surfaceBorder)

                    settingsRow(String(localized: "settings.meetings.notifications.reminder_timing", defaultValue: "Reminder timing", bundle: .module, comment: "Label for meeting reminder timing setting")) {
                        settingsMenu(
                    ...
                    settingsDescription(String(localized: "settings.meetings.notifications.reminder_timing.description", defaultValue: "At start time avoids early calendar-only prompts before you join.", bundle: .module, comment: "Description for reminder timing setting"))
                }
                ...
                settingsDescription(String(localized: "settings.meetings.notifications.auto_detected_meetings.description", defaultValue: "Show notifications when a call is detected from browser, camera, microphone, or app audio activity.", bundle: .module, comment: "Description for auto-detected meeting notifications setting"))
            ...
            settingsSection(String(localized: "settings.section.calendars", defaultValue: "Calendars", bundle: .module, comment: "Title for calendars settings section")) {
                settingsRow(String(localized: "settings.meetings.calendars.upcoming_meetings", defaultValue: "Upcoming meetings", bundle: .module, comment: "Toggle label for upcoming meetings setting"), controlWidth: meetingControlWidth) {
                    settingsMenu(
            ...
            if appState.isGoogleCalendarAvailable {
                settingsSection(String(localized: "settings.section.calendar", defaultValue: "Calendar", bundle: .module, comment: "Title for calendar settings section")) {
                    settingsRow(String(localized: "settings.meetings.calendar.google_calendar", defaultValue: "Google Calendar", bundle: .module, comment: "Toggle label for Google Calendar integration")) {
                        googleCalendarControl
                    }
                }
            }

            settingsSection(String(localized: "settings.section.advanced", defaultValue: "Advanced", bundle: .module, comment: "Title for advanced settings subsection")) {
                settingsRow(String(localized: "settings.meetings.advanced.enable_post_meeting_hook", defaultValue: "Enable post-meeting hook", bundle: .module, comment: "Toggle label for enabling post-meeting hook"), controlWidth: meetingControlWidth) {
    ...
    private var appearanceSettingsPane: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing24) {
            settingsSection(String(localized: "settings.section.floating_indicator", defaultValue: "Floating Indicator", bundle: .module, comment: "Title for floating indicator settings section")) {
                settingsRow(String(localized: "settings.appearance.show_floating_indicator", defaultValue: "Show floating indicator", bundle: .module, comment: "Toggle label to show floating indicator")) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.appearance.show_hotkey_on_floating_indicator", defaultValue: "Show hotkey on floating indicator", bundle: .module, comment: "Toggle label to show hotkey on floating indicator")) {
            ...
            settingsSection(String(localized: "settings.section.appearance", defaultValue: "Appearance", bundle: .module, comment: "Title for appearance settings section")) {
                settingsRow(String(localized: "settings.appearance.dark_mode", defaultValue: "Dark mode", bundle: .module, comment: "Toggle label for dark mode setting")) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.appearance.show_hotkey_in_menu_bar", defaultValue: "Show hotkey in menu bar", bundle: .module, comment: "Toggle label to show hotkey in menu bar")) {
                ...
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.appearance.play_sound_effects", defaultValue: "Play sound effects", bundle: .module, comment: "Toggle label for sound effects setting")) {
                    settingsSwitch(isOn: appState.config.soundEnabled) { newValue in
                        controller.updateConfig { $0.soundEnabled = newValue }
                    }
                }
                Divider().background(MuesliTheme.surfaceBorder)
                settingsRow(String(localized: "settings.appearance.show_next_meeting_in_menu_bar", defaultValue: "Show next meeting in menu bar", bundle: .module, comment: "Toggle label to show next meeting in menu bar")) {
            ...
            if appState.config.maraudersMapUnlocked {
                settingsSection(String(localized: "settings.section.marauders_map", defaultValue: "Marauder’s Map", bundle: .module, comment: "Title for Marauder’s Map settings section")) {
                    settingsRow(String(localized: "settings.appearance.meeting_countdown_audio", defaultValue: "Meeting countdown audio", bundle: .module, comment: "Label for meeting countdown audio setting")) {
                        maraudersMapControl
                    }
                    Divider().background(MuesliTheme.surfaceBorder)
                    settingsRow("") {
                        Button {
                            ...
                            Text(String(localized: "settings.appearance.mischief_managed", defaultValue: "Mischief Managed", bundle: .module, comment: "Label for disabling Marauder's Map effect"))
                                .font(.system(size: 11))
        ...
        if appState.isChatGPTAuthenticated {
            Button {
                ...
                HStack(spacing: 5) {
                    ...
                    Text(String(localized: "settings.chatgpt_account.signed_in_sign_out", defaultValue: "Signed in · Sign Out", bundle: .module, comment: "Status and action text when signed in to ChatGPT account"))
                        .font(.system(size: 11, weight: .medium))
            ...
            HStack(spacing: 6) {
                ProgressView()
                    .controlSize(.small)
                Text(String(localized: "settings.chatgpt_account.signing_in", defaultValue: "Signing in...", bundle: .module, comment: "Progress text while signing in to ChatGPT account"))
                    .font(.system(size: 11))
                    .foregroundStyle(MuesliTheme.textSecondary)
            }
        } else {
                ...
                Button {
                    ...
                    HStack(spacing: 5) {
                        OpenAILogoShape()
                            .fill(.white)
                            .frame(width: 10, height: 10)
                        Text(String(localized: "settings.chatgpt_account.sign_in_with_chatgpt", defaultValue: "Sign in with ChatGPT", bundle: .module, comment: "Button label to sign in with ChatGPT"))
                            .font(.system(size: 11, weight: .medium))
                            .foregroundStyle(.white)
                            .lineLimit(1)
                    }
    ...
    private var googleCalendarControl: some View {
        if appState.isGoogleCalendarAuthenticated {
            Button {
                ...
                HStack(spacing: 5) {
                    Image(systemName: "calendar")
                        .font(.system(size: 10))
                        .foregroundStyle(.white)
                    Text(String(localized: "settings.google_calendar.connected_disconnect", defaultValue: "Connected · Disconnect", bundle: .module, comment: "Status and action text when Google Calendar is connected"))
                        .font(.system(size: 11, weight: .medium))
                        .foregroundStyle(.white)
                        .lineLimit(1)
                }
            ...
            HStack(spacing: 6) {
                ProgressView()
                    .controlSize(.small)
                Text(String(localized: "settings.google_calendar.connecting", defaultValue: "Connecting...", bundle: .module, comment: "Progress text while connecting Google Calendar"))
                    .font(.system(size: 11))
                    .foregroundStyle(MuesliTheme.textSecondary)
            }
            ...
            VStack(alignment: .leading, spacing: 4) {
                HStack(spacing: 5) {
                    ...
                    Text(String(localized: "settings.google_calendar.connect", defaultValue: "Connect Google Calendar", bundle: .module, comment: "Button label to connect Google Calendar"))
                        .font(.system(size: 11, weight: .medium))
                        .foregroundStyle(.white.opacity(0.4))
                        .lineLimit(1)
                }
                ...
                Text(String(localized: "settings.google_calendar.oauth_verification_pending", defaultValue: "Google OAuth verification pending", bundle: .module, comment: "Status text for pending Google OAuth verification"))
                    .font(.system(size: 10))
                    .foregroundStyle(MuesliTheme.textTertiary)
            }
        } else {
    ...
    private func pickCustomAudioFile() {
        ...
        panel.title = String(localized: "settings.appearance.audio_picker.choose_clip", defaultValue: "Choose an audio clip", bundle: .module, comment: "Prompt title for choosing an audio clip file")
    ...
    private func pickMeetingHookFile() {
        let panel = NSOpenPanel()
        panel.title = String(localized: "settings.meetings.hook_script.choose_prompt", defaultValue: "Choose a hook script", bundle: .module, comment: "Prompt title for choosing a post-meeting hook script")
        panel.prompt = String(localized: "settings.meetings.hook_script.choose_button", defaultValue: "Choose Script", bundle: .module, comment: "Button title for choosing a hook script file")
        panel.allowsMultipleSelection = false
        panel.canChooseDirectories = false
    ...
    private func pickAutoExportFolder() {
        let panel = NSOpenPanel()
        panel.title = String(localized: "settings.meetings.auto_export.choose_folder_prompt", defaultValue: "Choose a folder for exported notes", bundle: .module, comment: "Prompt title for choosing notes export folder")
        panel.prompt = String(localized: "settings.meetings.auto_export.choose_folder_button", defaultValue: "Choose Folder", bundle: .module, comment: "Button title for choosing export destination folder")
        panel.allowsMultipleSelection = false
    ...
    private var permissionsSection: some View {
        settingsSection(String(localized: "settings.permissions.section", defaultValue: "Permissions", bundle: .module, comment: "Title for permissions settings section")) {
            permissionStatusRow(
                "Microphone",
                granted: micGranted,
    ...
    private func permissionStatusRow(_ name: String, granted: Bool, action: @escaping () -> Void, pane: String) -> some View {
        HStack {
            ...
            Spacer()
            if granted {
                Text(String(localized: "settings.permissions.status.granted", defaultValue: "Granted", bundle: .module, comment: "Permission status text when access is granted"))
                    .font(.system(size: 11))
                    .foregroundStyle(MuesliTheme.success)
            } else {
                Button(String(localized: "settings.permissions.action.grant", defaultValue: "Grant", bundle: .module, comment: "Action button title to grant permission")) {
                    action()
                }
                .buttonStyle(.plain)
                .font(.system(size: 11, weight: .medium))
            ...
            .buttonStyle(.plain)
            .help(String(localized: "settings.permissions.help.open_in_system_settings", defaultValue: "Open in System Settings", bundle: .module, comment: "Helper text directing user to system settings"))
        }
        .frame(minHeight: 32)
    }
    ...
    private func screenContextControl(width: CGFloat? = nil) -> some View {
        if accessibilityGranted {
            ...
            Button {
                ...
                Text(String(localized: "settings.permissions.action.grant", defaultValue: "Grant", bundle: .module, comment: "Action button title to grant permission"))
    ...
    private func summaryRetryLabel(_ retryCount: Int) -> String {
        ...
        switch clamped {
        case 0:
            return String(localized: "settings.meetings.summary_retries.none", defaultValue: "No retries", bundle: .module, comment: "Option label for zero summary retries")
        case 1:
            return String(localized: "settings.meetings.summary_retries.one", defaultValue: "1 retry", bundle: .module, comment: "Option label for one summary retry")
        default:
            return String(format: String(localized: "settings.meetings.summary_retries.many", defaultValue: "%d retries", bundle: .module, comment: "Option label for multiple summary retries"), clamped)
        }
    }
    ...
    private var mutedMeetingDetectionAppsControl: some View {
        ...
        return VStack(alignment: .leading, spacing: 10) {
            Text(String(localized: "settings.meeting_detection.muted_apps.description", defaultValue: "Don't notify me when a call is detected in these apps:", bundle: .module, comment: "Description for muted app notifications list"))
                .font(MuesliTheme.body())
                .foregroundStyle(MuesliTheme.textPrimary)
    ...
    private var calendarSourceGroups: [CalendarSourceGroup] {
        ...
        if appState.isGoogleCalendarAuthenticated && !appState.availableGoogleCalendars.isEmpty {
            let items = appState.availableGoogleCalendars.map { cal in
                CalendarToggleItem(
                    id: cal.id,
                    title: cal.summary + (cal.isPrimary ? " " + String(localized: "settings.calendars.primary_suffix", defaultValue: "(Primary)", bundle: .module, comment: "Suffix appended to mark primary calendar") : ""),
                    colorHex: cal.colorHex,
                    isEnabled: !disabled.contains(cal.id)
                )
            }
            groups.append(CalendarSourceGroup(
                ...
                subtitle: String(localized: "settings.calendars.google.connected_directly", defaultValue: "Connected directly to Muesli", bundle: .module, comment: "Status text for direct Google calendar connection"),
    ...
    private var calendarSourcesControl: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing16) {
            ...
            if appState.isGoogleCalendarAuthenticated && !appState.availableEventKitCalendars.isEmpty {
                Text(String(localized: "settings.calendars.google_duplicates_explanation", defaultValue: "Google calendars may appear once from macOS Calendar and once from Muesli's Google connection. Turn off both copies to hide that calendar completely.", bundle: .module, comment: "Explanation for duplicate Google calendars from two sources"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textTertiary)
                    .fixedSize(horizontal: false, vertical: true)
            }
        ...
        VStack(alignment: .leading, spacing: 10) {
            HStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text("\(group.subtitle) • \(group.items.count) \(group.items.count == 1 ? String(localized: "settings.calendar_source.count.singular", defaultValue: "calendar", bundle: .module, comment: "Singular noun for calendar count summary") : String(localized: "settings.calendar_source.count.plural", defaultValue: "calendars", bundle: .module, comment: "Plural noun for calendar count summary"))")
                        .font(.system(size: 11))
                        .foregroundStyle(MuesliTheme.textTertiary)
                        .lineLimit(1)
                }
    ...
    private func calendarSourceSubtitle(for sourceTitle: String) -> String {
        ...
        if normalized == "icloud" {
            return String(localized: "settings.calendars.source_subtitle.icloud_account", defaultValue: "iCloud account in macOS Calendar", bundle: .module, comment: "Subtitle describing iCloud calendar source")
        }
        if normalized == "subscribed calendars" {
            return String(localized: "settings.calendars.source_subtitle.subscribed", defaultValue: "Subscribed in macOS Calendar", bundle: .module, comment: "Subtitle describing subscribed calendar source")
        }
        if normalized == "other" {
            return String(localized: "settings.calendars.source_subtitle.system_calendars", defaultValue: "System calendars from macOS", bundle: .module, comment: "Subtitle describing system calendars source")
        }
        return String(localized: "settings.calendars.source_subtitle.account_macos", defaultValue: "Calendar account in macOS", bundle: .module, comment: "Subtitle describing macOS calendar account source")
    }
    ...
    private var googleCalendarListLoadStateView: some View {
        ...
        case .loading:
            Text(String(localized: "settings.google_calendar.loading_calendars", defaultValue: "Loading Google calendars…", bundle: .module, comment: "Status text while Google calendars are loading"))
                .font(MuesliTheme.caption())
                .foregroundStyle(MuesliTheme.textTertiary)
        case .failed(let message):
            HStack(spacing: 8) {
                Text(String(format: String(localized: "settings.google_calendar.load_failed_with_message", defaultValue: "Failed to load Google calendars: %@", bundle: .module, comment: "Error text when loading Google calendars fails with message"), "\(message)"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textTertiary)
                Button(String(localized: "settings.google_calendar.retry", defaultValue: "Retry", bundle: .module, comment: "Action button to retry loading Google calendars")) {
        ...
        HStack(spacing: 8) {
            HStack(spacing: 8) {
                ...
                if appState.config.autoExportMarkdownFolderPath.isEmpty {
                    Text(String(localized: "settings.auto_export.choose_folder", defaultValue: "Choose a folder…", bundle: .module, comment: "Button label to choose auto export folder"))
                        .font(.system(size: 12))
                        .foregroundStyle(MuesliTheme.textTertiary)
                        .lineLimit(1)
                } else {
            ...
            .help(appState.config.autoExportMarkdownFolderPath.isEmpty ? String(localized: "settings.auto_export.no_destination_folder_selected", defaultValue: "No destination folder selected", bundle: .module, comment: "Placeholder text when no auto export destination folder is selected") : appState.config.autoExportMarkdownFolderPath)
            ...
            if !appState.config.autoExportMarkdownFolderPath.isEmpty {
                ...
                .buttonStyle(.plain)
                .accessibilityLabel(String(localized: "settings.auto_export.clear_destination_folder_accessibility_label", defaultValue: "Clear destination folder", bundle: .module, comment: "Accessibility label for clearing destination folder selection"))
                .help(String(localized: "settings.auto_export.help.clear_destination_folder", defaultValue: "Clear destination folder", bundle: .module, comment: "Help text for clearing destination folder selection"))
            }
            ...
            .buttonStyle(.plain)
            .accessibilityLabel(String(localized: "settings.auto_export.choose_destination_folder", defaultValue: "Choose destination folder", bundle: .module, comment: "Prompt title for choosing destination folder"))
            .help(String(localized: "settings.auto_export.choose_destination_folder", defaultValue: "Choose destination folder", bundle: .module, comment: "Button title for choosing destination folder"))
        }
    }
        ...
        HStack(spacing: 8) {
            HStack(spacing: 8) {
                ...
                if appState.config.meetingHookPath.isEmpty {
                    Text(String(localized: "settings.meeting_hook.choose_script", defaultValue: "Choose a script…", bundle: .module, comment: "Button label to choose meeting hook script"))
                        .font(.system(size: 12))
                        .foregroundStyle(MuesliTheme.textTertiary)
                        .lineLimit(1)
                } else {
            ...
            .frame(maxWidth: .infinity)
            .help(appState.config.meetingHookPath.isEmpty ? String(localized: "settings.meeting_hook.no_script_selected", defaultValue: "No hook script selected", bundle: .module, comment: "Placeholder text when no hook script is selected") : appState.config.meetingHookPath)
            ...
            if !appState.config.meetingHookPath.isEmpty {
                ...
                .buttonStyle(.plain)
                .help(String(localized: "settings.meeting_hook.help.clear_script", defaultValue: "Clear hook script", bundle: .module, comment: "Help text for clearing selected hook script"))
            }
            ...
            .buttonStyle(.plain)
            .help(String(localized: "settings.meeting_hook.help.choose_script", defaultValue: "Choose hook script", bundle: .module, comment: "Help text for choosing hook script"))
        }
    ...
    private var meetingHookTimeoutControl: some View {
        Stepper(
            ...
            Text(String(format: String(localized: "settings.meeting_hook.timeout.seconds", defaultValue: "%d seconds", bundle: .module, comment: "Meeting hook timeout value in seconds"), max(appState.config.meetingHookTimeoutSeconds, 1)))
                .font(MuesliTheme.body())
                .foregroundStyle(MuesliTheme.textPrimary)
                .monospacedDigit()
    ...
    private func meetingTemplateMenu(selectionID: String, onChange: @escaping (String) -> Void) -> some View {
        ...
        let selectedLabel = allItems.first(where: { $0.id == selectionID })?.label ?? String(localized: "settings.common.auto", defaultValue: "Auto", bundle: .module, comment: "Common auto option label")
        FixedWidthPopUp(
    ...
    private var openRouterFreeModelMenu: some View {
        if isLoadingOpenRouterFreeModels {
            HStack(spacing: 8) {
                ProgressView()
                    .controlSize(.small)
                Text(String(localized: "settings.open_router_free_model.loading_models", defaultValue: "Loading models", bundle: .module, comment: "Status text while loading OpenRouter free models"))
                    .font(.system(size: 12, weight: .medium))
                    .foregroundStyle(MuesliTheme.textTertiary)
            }
            .frame(maxWidth: .infinity, alignment: .trailing)
            ...
            HStack(spacing: 8) {
                ...
                Button(String(localized: "settings.open_router_free_model.load", defaultValue: "Load", bundle: .module, comment: "Action button label to load OpenRouter free models")) {
    ...
    private func keyStatusRow(key: String) -> some View {
        HStack(spacing: 6) {
            ...
            Text(key.isEmpty ? String(localized: "settings.api_key.status.not_configured", defaultValue: "No API key configured", bundle: .module, comment: "Status text when API key is not configured") : String(localized: "settings.api_key.status.configured", defaultValue: "Key configured", bundle: .module, comment: "Status text when API key is configured"))
                .font(.system(size: 11))
    ...
    private func recordingSaveLabel(for policy: MeetingRecordingSavePolicy) -> String {
        switch policy {
        case .never:
            return String(localized: "settings.meetings.recording_save.never", defaultValue: "Never", bundle: .module, comment: "Option label for never saving recordings")
        case .prompt:
            return String(localized: "settings.meetings.recording_save.ask_every_time", defaultValue: "Ask every time", bundle: .module, comment: "Option label for prompting before saving recordings")
        case .always:
            return String(localized: "settings.meetings.recording_save.always", defaultValue: "Always", bundle: .module, comment: "Option label for always saving recordings")
        }
    }
    ...
    private func scheduledMeetingLeadTimeLabel(for leadTime: ScheduledMeetingNotificationLeadTime) -> String {
        switch leadTime {
        case .atStart:
            return String(localized: "settings.meetings.reminder_timing.at_start", defaultValue: "At start time", bundle: .module, comment: "Reminder timing option at meeting start time")
        case .oneMinute:
            return String(localized: "settings.meetings.reminder_timing.one_min_before", defaultValue: "1 min before", bundle: .module, comment: "Reminder timing option one minute before meeting")
        case .threeMinutes:
            return String(localized: "settings.meetings.reminder_timing.three_min_before", defaultValue: "3 min before", bundle: .module, comment: "Reminder timing option three minutes before meeting")
        case .fiveMinutes:
            return String(localized: "settings.meetings.reminder_timing.five_min_before", defaultValue: "5 min before", bundle: .module, comment: "Reminder timing option five minutes before meeting")
        }
    }
