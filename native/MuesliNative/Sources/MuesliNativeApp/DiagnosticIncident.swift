...
enum DiagnosticIncidentKind: String, Codable, CaseIterable, Sendable {
    ...
    var title: String {
        switch self {
        case .manualReport: return String(localized: "diagnostic_incident.title.manual_report", defaultValue: "Manual problem report", bundle: .module, comment: "Diagnostic incident title for manually submitted problem reports.")
        case .dictationAudioFailed: return String(localized: "diagnostic_incident.title.dictation_audio_failed", defaultValue: "Dictation audio capture failed", bundle: .module, comment: "Diagnostic incident title when dictation audio capture fails.")
        case .dictationTranscriptionFailed: return String(localized: "diagnostic_incident.title.dictation_transcription_failed", defaultValue: "Dictation transcription failed", bundle: .module, comment: "Diagnostic incident title when dictation transcription fails.")
        case .streamingDictationStartFailed: return String(localized: "diagnostic_incident.title.streaming_dictation_start_failed", defaultValue: "Streaming dictation failed to start", bundle: .module, comment: "Diagnostic incident title when streaming dictation fails during startup.")
        case .streamingDictationRuntimeFailed: return String(localized: "diagnostic_incident.title.streaming_dictation_runtime_failed", defaultValue: "Streaming dictation failed", bundle: .module, comment: "Diagnostic incident title when streaming dictation fails during runtime.")
        case .meetingStartFailed: return String(localized: "diagnostic_incident.title.meeting_start_failed", defaultValue: "Meeting recording failed to start", bundle: .module, comment: "Diagnostic incident title when meeting recording fails to start.")
        case .meetingMicrophoneCaptureFailed: return String(localized: "diagnostic_incident.title.meeting_microphone_capture_failed", defaultValue: "Meeting microphone capture failed", bundle: .module, comment: "Diagnostic incident title when meeting microphone capture fails.")
        case .meetingSystemAudioCaptureFailed: return String(localized: "diagnostic_incident.title.meeting_system_audio_capture_failed", defaultValue: "Meeting system audio capture failed", bundle: .module, comment: "Diagnostic incident title when meeting system audio capture fails.")
        case .meetingProcessingFailed: return String(localized: "diagnostic_incident.title.meeting_processing_failed", defaultValue: "Meeting processing failed", bundle: .module, comment: "Diagnostic incident title when meeting post-processing fails.")
        case .meetingRecordingSaveFailed: return String(localized: "diagnostic_incident.title.meeting_recording_save_failed", defaultValue: "Meeting recording save failed", bundle: .module, comment: "Diagnostic incident title when saving a meeting recording fails.")
        }
    }
...
struct DiagnosticIncident: Codable, Equatable, Identifiable, Sendable {
    ...
    var issueTitle: String {
        String(format: String(localized: "diagnostic.report.issue_title", defaultValue: "[Diagnostic] %@", bundle: .module, comment: "Generated diagnostic issue title prefixed with diagnostic tag and incident kind title."), "\(kind.title)")
    }
    ...
    var issueBody: String {
        String(
            format: String(
                ...
                bundle: .module,
                comment: "Template for diagnostic issue body with anonymized incident metadata placeholders."
            ),
            "\(kind.rawValue)",
            "\(severity.rawValue)",
            "\(userImpact.rawValue)",
