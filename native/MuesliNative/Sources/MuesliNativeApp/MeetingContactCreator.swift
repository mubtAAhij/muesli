...
enum MeetingContactCreatorError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .accessDenied:
            return String(localized: "meeting_contact_creator.error.contacts_permission_required", defaultValue: "Muesli does not have permission to add contacts. Enable Contacts access in System Settings.", bundle: .module, comment: "Error shown when app lacks Contacts permission while creating a contact.")
        case .missingIdentifier:
            return String(localized: "meeting_contact_creator.error.missing_contact_identifier", defaultValue: "Apple Contacts saved the person without returning an identifier. Try choosing them from Contacts instead.", bundle: .module, comment: "Error shown when Contacts save succeeds but no identifier is returned.")
        }
    }
}
