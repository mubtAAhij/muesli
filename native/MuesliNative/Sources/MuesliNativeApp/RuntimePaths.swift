...
struct RuntimePaths {
    ...
    static func resolve() throws -> RuntimePaths {
        ...
        throw NSError(domain: "MuesliRuntime", code: 1, userInfo: [
            NSLocalizedDescriptionKey: String(localized: "runtime_paths.error.could_not_locate_bundle_or_repo", defaultValue: "Could not locate app bundle or repo root.", bundle: .module, comment: "Error when runtime paths cannot locate app bundle or repository root."),
        ])
    }
}
