...
struct DictionaryView: View {
    ...
    var body: some View {
        ...
        .alert(String(localized: "dictionary.accessibility_alert.title", defaultValue: "Enable Accessibility?", bundle: .module, comment: "Title of alert asking user to enable accessibility permissions for dictionary suggestions"), isPresented: $isShowingAccessibilityPrompt) {
            Button(String(localized: "common.button.cancel", defaultValue: "Cancel", bundle: .module, comment: "Cancel button title in accessibility enable alert"), role: .cancel) {
                controller.cancelDictionaryCorrectionAccessibilityEnableRequest()
            }
            Button(String(localized: "dictionary.accessibility_alert.enable", defaultValue: "Enable", bundle: .module, comment: "Confirm button title to enable accessibility permissions")) {
        ...
        .alert(
            String(localized: "dictionary.view.title", defaultValue: "Dictionary", bundle: .module, comment: "Window or section title for the dictionary view"),
            isPresented: Binding(
                get: { dictionaryAlertMessage != nil },
                set: { if !$0 { dictionaryAlertMessage = nil } }
            )
        ) {
            Button(String(localized: "common.button.ok", defaultValue: "OK", bundle: .module, comment: "OK button title in dictionary alerts"), role: .cancel) { dictionaryAlertMessage = nil }
        } message: {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing8) {
            HStack {
                Text(String(localized: "dictionary.title", defaultValue: "Dictionary", bundle: .module, comment: "Title for the dictionary view"))
                    .font(MuesliTheme.title1())
                    .foregroundStyle(MuesliTheme.textPrimary)
                Spacer()
                Toggle(
                    String(localized: "dictionary.header.suggestions_toggle", defaultValue: "Dictionary suggestions", bundle: .module, comment: "Label for toggle controlling dictionary suggestions"),
                    isOn: Binding(
                ...
                .help(String(localized: "dictionary.header.help.accessibility_summary", defaultValue: "Briefly reads focused app text after dictation to detect corrections.", bundle: .module, comment: "Help text describing dictionary suggestions behavior"))
                .featureTourTarget(.dictionarySuggestions)
                Button {
                    importDictionary()
                } label: {
                    Label(String(localized: "dictionary.header.import", defaultValue: "Import", bundle: .module, comment: "Button title to import dictionary entries"), systemImage: "square.and.arrow.down")
                ...
                .buttonStyle(.plain)
                .help(String(localized: "dictionary.header.import.help", defaultValue: "Import dictionary entries from a JSON file", bundle: .module, comment: "Help tooltip for import dictionary button"))
                Button {
                    exportDictionary()
                } label: {
                    Label(String(localized: "dictionary.header.export", defaultValue: "Export", bundle: .module, comment: "Button title to export dictionary entries"), systemImage: "square.and.arrow.up")
                        .font(.system(size: 12, weight: .medium))
                        .foregroundStyle(MuesliTheme.textPrimary)
                        .padding(.horizontal, MuesliTheme.spacing12)
                        .padding(.vertical, MuesliTheme.spacing8)
                ...
                .buttonStyle(.plain)
                .help(String(localized: "dictionary.header.export.help", defaultValue: "Export the current dictionary as JSON", bundle: .module, comment: "Help tooltip for export dictionary button"))
                Button {
                    isAdding = true
                    newWord = ""
                    newReplacement = ""
                    ...
                    HStack(spacing: 4) {
                        ...
                        Text(String(localized: "dictionary.header.add_new", defaultValue: "Add new", bundle: .module, comment: "Button title to add a new dictionary entry"))
    ...
    private func importDictionary() {
        ...
        panel.title = String(localized: "dictionary.import.panel_title", defaultValue: "Import Muesli Dictionary", bundle: .module, comment: "Title for import dictionary file picker panel")
        panel.message = String(localized: "dictionary.import.panel_message", defaultValue: "Choose a JSON dictionary file", bundle: .module, comment: "Message in import dictionary file picker panel")
        panel.prompt = String(localized: "dictionary.import.panel_confirm", defaultValue: "Import", bundle: .module, comment: "Confirm button title in import dictionary file picker")
            ...
            do {
                ...
                if totalChanged == 0 {
                    dictionaryAlertMessage = imported.isEmpty
                        ? String(localized: "dictionary.import.result.no_entries", defaultValue: "The selected dictionary did not contain any entries.", bundle: .module, comment: "Alert message when imported dictionary file has no entries")
                        : String(localized: "dictionary.import.result.already_present", defaultValue: "All dictionary entries were already present.", bundle: .module, comment: "Alert message when imported dictionary entries are already in dictionary")
                } else {
                    var details = [String(format: String(localized: "dictionary.import.result.added_fragment", defaultValue: "Imported %d new", bundle: .module, comment: "Import result fragment reporting number of newly added entries"), result.addedCount), String(format: String(localized: "dictionary.import.result.updated_fragment", defaultValue: "updated %d", bundle: .module, comment: "Import result fragment reporting number of updated entries"), result.updatedCount)]
                    if result.skippedCount > 0 {
                        details.append(String(format: String(localized: "dictionary.import.result.skipped_fragment", defaultValue: "skipped %d", bundle: .module, comment: "Import result fragment reporting number of skipped entries"), result.skippedCount))
                    }
                    dictionaryAlertMessage = details.joined(separator: ", ") + " " + String(localized: "dictionary.import.result.entries_suffix", defaultValue: "dictionary entries.", bundle: .module, comment: "Import result suffix appended after counts summary")
                }
            } catch {
    ...
    private func exportDictionary() {
        ...
        panel.title = String(localized: "dictionary.export.panel_title", defaultValue: "Export Muesli Dictionary", bundle: .module, comment: "Title for export dictionary save panel")
        panel.prompt = String(localized: "dictionary.export.panel_confirm", defaultValue: "Export", bundle: .module, comment: "Confirm button title in export save panel")
            ...
            HStack {
                VStack(alignment: .leading, spacing: 3) {
                    Text(String(localized: "dictionary.suggestions.title", defaultValue: "Suggested Corrections", bundle: .module, comment: "Section title for suggested corrections list"))
                        ...
                        .foregroundStyle(MuesliTheme.textPrimary)
                    Text(String(localized: "dictionary.suggestions.description", defaultValue: "Corrections Muesli noticed by briefly reading focused app text after dictation.", bundle: .module, comment: "Description text for suggested corrections section"))
                        .font(MuesliTheme.caption())
    ...
    private var suggestionRangeText: String {
        ...
        return String(format: String(localized: "dictionary.suggestions.range", defaultValue: "%d-%d of %d", bundle: .module, comment: "Pagination summary showing displayed suggestion range and total count"), start, end, count)
    }
    ...
    private var suggestionPaginationControls: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            ...
            DictionaryIconButton(
                ...
                label: String(localized: "dictionary.suggestions.pagination.previous", defaultValue: "Previous suggestions", bundle: .module, comment: "Button label to navigate to previous suggestions page"),
            ...
            DictionaryIconButton(
                ...
                label: String(localized: "dictionary.suggestions.pagination.next", defaultValue: "Next suggestions", bundle: .module, comment: "Button label to navigate to next suggestions page"),
                tint: MuesliTheme.textSecondary,
    ...
    private var emptyState: some View {
        VStack(spacing: MuesliTheme.spacing8) {
            Image(systemName: "character.book.closed")
                .font(.system(size: 28))
                .foregroundStyle(MuesliTheme.textTertiary)
            Text(String(localized: "dictionary.empty_state.title", defaultValue: "No custom words yet", bundle: .module, comment: "Empty state title when dictionary has no custom words"))
                .font(MuesliTheme.body())
                .foregroundStyle(MuesliTheme.textSecondary)
    ...
    private var columnHeader: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            Text(String(localized: "dictionary.table.column.match", defaultValue: "Match", bundle: .module, comment: "Table column header for match term"))
                .frame(maxWidth: .infinity, alignment: .leading)
            Color.clear
                .frame(width: DictionaryRowMetrics.arrowWidth)
            Text(String(localized: "dictionary.table.column.replace", defaultValue: "Replace", bundle: .module, comment: "Table column header for replacement term"))
                .frame(maxWidth: .infinity, alignment: .leading)
            Text(String(localized: "dictionary.table.column.threshold", defaultValue: "Threshold", bundle: .module, comment: "Table column header for fuzzy match threshold"))
    ...
    private var addWordRow: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            TextField(String(localized: "dictionary.table.cell.word", defaultValue: "Word", bundle: .module, comment: "Fallback label for dictionary word cell"), text: $newWord)
            ...
            Image(systemName: "arrow.right")
                ...
                .foregroundStyle(MuesliTheme.textTertiary)
                .frame(width: DictionaryRowMetrics.arrowWidth)
            TextField(String(localized: "dictionary.form.replace_with", defaultValue: "Replace with", bundle: .module, comment: "Field label prompting replacement text for a dictionary entry"), text: $newReplacement)
                .textFieldStyle(.roundedBorder)
                .frame(maxWidth: .infinity)
            ThresholdEditor(value: $newThreshold)
            DictionaryIconButton(
                systemName: "checkmark",
                label: String(localized: "dictionary.add_word.button", defaultValue: "Add word", bundle: .module, comment: "Button title to add a new custom dictionary word"),
            ...
            DictionaryIconButton(
                systemName: "xmark",
                label: String(localized: "dictionary.add_word.cancel", defaultValue: "Cancel", bundle: .module, comment: "Cancel button title in add word workflow"),
...
private struct DictionarySuggestionRow: View {
    ...
    private var detailText: String {
        var parts = [String(format: String(localized: "dictionary.suggestion.seen_count", defaultValue: "Seen %dx", bundle: .module, comment: "Label showing how many times a suggestion was observed"), suggestion.occurrenceCount)]
...
private struct DictionaryWordEditorRow: View {
    ...
    var body: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            TextField(String(localized: "dictionary.form.word", defaultValue: "Word", bundle: .module, comment: "Field label for dictionary word text"), text: $draftWord)
                .textFieldStyle(.roundedBorder)
                .frame(maxWidth: .infinity)
            Image(systemName: "arrow.right")
                .font(.system(size: 10, weight: .semibold))
                .foregroundStyle(MuesliTheme.textTertiary)
                .frame(width: DictionaryRowMetrics.arrowWidth)
            TextField(String(localized: "dictionary.form.replace_with", defaultValue: "Replace with", bundle: .module, comment: "Field label prompting replacement text while editing a dictionary word"), text: $draftReplacement)
                .textFieldStyle(.roundedBorder)
                .frame(maxWidth: .infinity)
            ThresholdEditor(value: $draftThreshold)
            DictionaryIconButton(
                systemName: "checkmark",
                label: String(localized: "dictionary.edit_word.save", defaultValue: "Save word", bundle: .module, comment: "Button title to save changes to a dictionary word"),
...
private struct ThresholdEditor: View {
    ...
    var body: some View {
        ...
        .help(String(localized: "dictionary.form.matching_threshold", defaultValue: "Matching threshold", bundle: .module, comment: "Label describing fuzzy matching threshold control"))
        .accessibilityLabel(String(localized: "dictionary.form.matching_threshold", defaultValue: "Matching threshold", bundle: .module, comment: "Accessibility label for matching threshold control"))
    ...
    private var thresholdPopover: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
            HStack {
                Text(String(localized: "dictionary.table.column.threshold", defaultValue: "Threshold", bundle: .module, comment: "Table column header for matching threshold value"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textTertiary)
                Spacer()
                HStack(spacing: 4) {
...
private struct ThresholdSlider: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "dictionary.form.matching_threshold", defaultValue: "Matching threshold", bundle: .module, comment: "Tooltip or helper label for matching threshold setting"))
