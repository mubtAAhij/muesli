...
final class DictationAudioSessionManager: @unchecked Sendable {
    private enum StartupError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .noAudioBuffer:
                return String(localized: "dictation_audio.error.microphone_capture_no_audio", defaultValue: "Microphone capture did not deliver audio.", comment: "Error when microphone capture yields no audio")
            }
        }
    }
