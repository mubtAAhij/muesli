...
enum MeetingExportContent: String, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .notes: return String(localized: "meeting_export.scope.notes", defaultValue: "Notes", bundle: .module, comment: "")
        case .transcript: return String(localized: "meeting_export.scope.transcript", defaultValue: "Transcript", bundle: .module, comment: "")
        case .fullMeeting: return String(localized: "meeting_export.scope.full_meeting", defaultValue: "Full Meeting", bundle: .module, comment: "")
        }
    }
...
enum MeetingAutoExportFileFormat: String, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .markdown: return String(localized: "meeting_export.format.markdown", defaultValue: "Markdown", bundle: .module, comment: "")
        case .pdf: return String(localized: "meeting_export.format.pdf", defaultValue: "PDF", bundle: .module, comment: "")
        case .markdownAndPDF: return String(localized: "meeting_export.format.markdown_and_pdf", defaultValue: "Markdown and PDF", bundle: .module, comment: "")
        }
    }
...
struct MeetingExporter {
            ...
            presentSavePanel(panel) { url in
                if formatPicker.selectedFormat == .pdf {
                    do {
                        ...
                        showError(String(localized: "meeting_export.error.title.export_failed", defaultValue: "Export Failed", bundle: .module, comment: ""), error.localizedDescription)
                    }
                } else {
    ...
    static func buildMarkdown(meeting: MeetingRecord, content: MeetingExportContent) -> String {
        ...
        parts.append("")
        parts.append(String(format: String(localized: "meeting_export.markdown.date_line", defaultValue: "**Date:** %@", bundle: .module, comment: ""), "\(formatExportDate(meeting.startTime))"))
        parts.append(String(format: String(localized: "meeting_export.markdown.duration_line", defaultValue: "**Duration:** %@", bundle: .module, comment: ""), "\(formatExportDuration(meeting.durationSeconds))"))
        parts.append(String(format: String(localized: "meeting_export.markdown.words_line", defaultValue: "**Words:** %d", bundle: .module, comment: ""), meeting.wordCount))
        if let name = meeting.selectedTemplateName, !name.isEmpty {
            parts.append(String(format: String(localized: "meeting_export.markdown.template_line", defaultValue: "**Template:** %@", bundle: .module, comment: ""), "\(name)"))
        }
        parts.append("")
        parts.append("---")
        parts.append("")
        ...
        case .notes:
            if meeting.notesState == .structuredNotes {
                ...
                parts.append(String(localized: "meeting_export.markdown.no_structured_notes", defaultValue: "*No structured notes available. Raw transcript included below.*", bundle: .module, comment: ""))
                parts.append("")
                parts.append(String(localized: "meeting_export.markdown.raw_transcript_heading", defaultValue: "## Raw Transcript", bundle: .module, comment: ""))
                parts.append("")
        ...
        case .fullMeeting:
            if meeting.notesState == .structuredNotes {
                ...
                parts.append(String(localized: "meeting_export.markdown.no_structured_notes_short", defaultValue: "*No structured notes available.*", bundle: .module, comment: ""))
            }
            parts.append("")
            parts.append("---")
            parts.append("")
    ...
    private static func writeMarkdown(_ text: String, to url: URL) {
        DispatchQueue.global(qos: .userInitiated).async {
            do {
                ...
                DispatchQueue.main.async { showError(String(localized: "meeting_export.error.title.export_failed", defaultValue: "Export Failed", bundle: .module, comment: ""), error.localizedDescription) }
            }
        }
    }
    ...
    private static func formatExportDuration(_ seconds: Double) -> String {
        ...
        if rounded >= 3600 {
            return String(format: String(localized: "meeting_export.duration.hours_minutes", defaultValue: "%dh %dm", bundle: .module, comment: ""), rounded / 3600, (rounded % 3600) / 60)
        }
        if rounded >= 60 {
            let m = rounded / 60
            let s = rounded % 60
            return s == 0 ? String(format: String(localized: "meeting_export.duration.minutes", defaultValue: "%d minutes", bundle: .module, comment: ""), m) : String(format: String(localized: "meeting_export.duration.minutes_seconds_short", defaultValue: "%dm %ds", bundle: .module, comment: ""), m, s)
        }
        return String(format: String(localized: "meeting_export.duration.seconds_short", defaultValue: "%ds", bundle: .module, comment: ""), rounded)
    }
...
private class ExportFormatAccessory: NSObject {
    ...
    init(panel: NSSavePanel) {
        ...
        let label = NSTextField(labelWithString: String(localized: "meeting_export.menu.format_label", defaultValue: "Format:", bundle: .module, comment: ""))
        ...
        button.addItems(withTitles: [String(localized: "meeting_export.menu.format.pdf", defaultValue: "PDF", bundle: .module, comment: ""), String(localized: "meeting_export.menu.format.markdown", defaultValue: "Markdown", bundle: .module, comment: "")])
