...
enum MeetingTemplates {
    ...
    static let auto = MeetingTemplateDefinition(
        ...
        promptBody: String(
            ...
            """,
            bundle: .module,
            comment: "Prompt template for automatic meeting summary."
        )
    )
    ...
    static let builtIns: [MeetingTemplateDefinition] = [
        MeetingTemplateDefinition(
            ...
            category: String(localized: "meeting_templates.category.team", defaultValue: "Team", bundle: .module, comment: "Category label for team meeting templates."),
            icon: "person.2.fill",
            kind: .builtin,
            promptBody: String(
        ...
        MeetingTemplateDefinition(
            ...
            promptBody: String(
                ...
                """,
                bundle: .module,
                comment: "Prompt template for customer discovery meeting notes."
            )
        ),
        MeetingTemplateDefinition(
            id: "hiring",
            ...
            promptBody: String(
                ...
                """,
                bundle: .module,
                comment: "Prompt template for hiring meeting notes."
            )
        ),
        MeetingTemplateDefinition(
            id: "stand-up",
            ...
            promptBody: String(
                ...
                """,
                bundle: .module,
                comment: "Prompt template for stand-up meeting notes."
            )
        ),
        MeetingTemplateDefinition(
    ...
    static let customIconOptions: [CustomIconOption] = [
        ...
        CustomIconOption(symbolName: "briefcase.fill", label: String(localized: "meeting_templates.custom_icon.hiring", defaultValue: "Hiring", bundle: .module, comment: "Custom icon label for hiring template.")),
        CustomIconOption(symbolName: "calendar", label: String(localized: "meeting_templates.custom_icon.weekly", defaultValue: "Weekly", bundle: .module, comment: "Custom icon label for weekly template.")),
        CustomIconOption(symbolName: "figure.stand", label: String(localized: "meeting_templates.custom_icon.stand_up", defaultValue: "Stand-Up", bundle: .module, comment: "Custom icon label for stand-up template.")),
        CustomIconOption(symbolName: "person.fill.questionmark", label: String(localized: "meeting_templates.custom_icon.interview", defaultValue: "Interview", bundle: .module, comment: "Custom icon label for interview template.")),
        CustomIconOption(symbolName: "person.fill.checkmark", label: String(localized: "meeting_templates.custom_icon.review", defaultValue: "Review", bundle: .module, comment: "Custom icon label for review template.")),
        CustomIconOption(symbolName: "building.2.fill", label: String(localized: "meeting_templates.custom_icon.business", defaultValue: "Business", bundle: .module, comment: "Custom icon label for business template.")),
        CustomIconOption(symbolName: "chart.line.uptrend.xyaxis", label: String(localized: "meeting_templates.custom_icon.strategy", defaultValue: "Strategy", bundle: .module, comment: "Custom icon label for strategy template.")),
        CustomIconOption(symbolName: "dollarsign.circle", label: String(localized: "meeting_templates.custom_icon.sales", defaultValue: "Sales", bundle: .module, comment: "Custom icon label for sales template.")),
        CustomIconOption(symbolName: "megaphone.fill", label: String(localized: "meeting_templates.custom_icon.marketing", defaultValue: "Marketing", bundle: .module, comment: "Custom icon label for marketing template.")),
        CustomIconOption(symbolName: "hammer.fill", label: String(localized: "meeting_templates.custom_icon.execution", defaultValue: "Execution", bundle: .module, comment: "Custom icon label for execution template.")),
        CustomIconOption(symbolName: "shippingbox.fill", label: String(localized: "meeting_templates.custom_icon.ops", defaultValue: "Ops", bundle: .module, comment: "Custom icon label for operations template.")),
        CustomIconOption(symbolName: "doc.text.fill", label: String(localized: "meeting_templates.custom_icon.docs", defaultValue: "Docs", bundle: .module, comment: "Custom icon label for documentation template.")),
        CustomIconOption(symbolName: "checklist", label: String(localized: "meeting_templates.custom_icon.checklist", defaultValue: "Checklist", bundle: .module, comment: "Custom icon label for checklist template.")),
        CustomIconOption(symbolName: "lightbulb.fill", label: String(localized: "meeting_templates.custom_icon.ideas", defaultValue: "Ideas", bundle: .module, comment: "Custom icon label for ideas template.")),
        CustomIconOption(symbolName: "waveform.path.ecg", label: String(localized: "meeting_templates.custom_icon.health", defaultValue: "Health", bundle: .module, comment: "Custom icon label for health template.")),
        CustomIconOption(symbolName: "graduationcap.fill", label: String(localized: "meeting_templates.custom_icon.learning", defaultValue: "Learning", bundle: .module, comment: "Custom icon label for learning template.")),
        CustomIconOption(symbolName: "globe", label: String(localized: "meeting_templates.custom_icon.global", defaultValue: "Global", bundle: .module, comment: "Custom icon label for global template.")),
        CustomIconOption(symbolName: "phone.fill", label: String(localized: "meeting_templates.custom_icon.calls", defaultValue: "Calls", bundle: .module, comment: "Custom icon label for calls template.")),
        CustomIconOption(symbolName: "message.fill", label: String(localized: "meeting_templates.custom_icon.conversation", defaultValue: "Conversation", bundle: .module, comment: "Custom icon label for conversation template.")),
        CustomIconOption(symbolName: "person.3.fill", label: String(localized: "meeting_templates.custom_icon.team", defaultValue: "Team", bundle: .module, comment: "Custom icon label for team template.")),
        CustomIconOption(symbolName: "target", label: String(localized: "meeting_templates.custom_icon.goals", defaultValue: "Goals", bundle: .module, comment: "Custom icon label for goals template.")),
        CustomIconOption(symbolName: "flag.fill", label: String(localized: "meeting_templates.custom_icon.milestones", defaultValue: "Milestones", bundle: .module, comment: "Custom icon label for milestones template.")),
        CustomIconOption(symbolName: "sparkles", label: String(localized: "meeting_templates.custom_icon.enhanced", defaultValue: "Enhanced", bundle: .module, comment: "Custom icon label for enhanced template.")),
        CustomIconOption(symbolName: "wand.and.stars", label: String(localized: "meeting_templates.custom_icon.creative", defaultValue: "Creative", bundle: .module, comment: "Custom icon label for creative template.")),
        CustomIconOption(symbolName: "paperplane.fill", label: String(localized: "meeting_templates.custom_icon.launch", defaultValue: "Launch", bundle: .module, comment: "Custom icon label for launch template.")),
        CustomIconOption(symbolName: "gearshape.fill", label: String(localized: "meeting_templates.custom_icon.systems", defaultValue: "Systems", bundle: .module, comment: "Custom icon label for systems template.")),
        CustomIconOption(symbolName: "folder.fill", label: String(localized: "meeting_templates.custom_icon.projects", defaultValue: "Projects", bundle: .module, comment: "Custom icon label for projects template.")),
        CustomIconOption(symbolName: "clock.fill", label: String(localized: "meeting_templates.custom_icon.timeline", defaultValue: "Timeline", bundle: .module, comment: "Custom icon label for timeline template.")),
        CustomIconOption(symbolName: "bolt.fill", label: String(localized: "meeting_templates.custom_icon.sprint", defaultValue: "Sprint", bundle: .module, comment: "Custom icon label for sprint template.")),
    ]
    ...
    static func customDefinition(from customTemplate: CustomMeetingTemplate) -> MeetingTemplateDefinition {
        MeetingTemplateDefinition(
            ...
            category: String(localized: "meeting_templates.custom.title", defaultValue: "Custom", bundle: .module, comment: "Title for custom meeting template option."),
