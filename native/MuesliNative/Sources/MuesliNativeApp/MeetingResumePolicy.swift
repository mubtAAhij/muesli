...
enum MeetingResumePolicy {
    ...
    static let resumeSeparator = "\n\n" + String(localized: "meeting_resume_policy.resume_separator", defaultValue: "— Resumed —", bundle: .module, comment: "Separator inserted in meeting notes when recording resumes.") + "\n\n"
