...
enum SettingsPane: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .general: return String(localized: "app_state.section.general.title", defaultValue: "General", comment: "")
        case .sync: return String(localized: "app_state.section.sync.title", defaultValue: "Sync", comment: "")
        case .dictation: return String(localized: "app_state.section.dictation.title", defaultValue: "Dictation", comment: "")
        case .computerUse: return String(localized: "app_state.section.computer_use.title", defaultValue: "Computer Use", comment: "")
        case .meetings: return String(localized: "app_state.section.meetings.title", defaultValue: "Meetings", comment: "")
        case .appearance: return String(localized: "app_state.section.appearance.title", defaultValue: "Appearance", comment: "")
        }
    }
}
...
enum ModelsCategory: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .dictation: return String(localized: "app_state.section.dictation.title", defaultValue: "Dictation", comment: "")
        case .streaming: return String(localized: "app_state.section.live_meetings.title", defaultValue: "Live Meetings", comment: "")
        case .postProcessing: return String(localized: "app_state.section.cleanup.title", defaultValue: "Cleanup", comment: "")
        }
    }
}
...
enum HistoryDateFilter: String, CaseIterable, Hashable {
    ...
    var label: String {
        switch self {
        case .all: return String(localized: "app_state.time_range.all_time.label", defaultValue: "All time", comment: "")
        case .last2Days: return String(localized: "app_state.time_range.last_2_days.label", defaultValue: "Last 2 days", comment: "")
        case .lastWeek: return String(localized: "app_state.time_range.last_week.label", defaultValue: "Last week", comment: "")
        case .last2Weeks: return String(localized: "app_state.time_range.last_2_weeks.label", defaultValue: "Last 2 weeks", comment: "")
        case .lastMonth: return String(localized: "app_state.time_range.last_month.label", defaultValue: "Last month", comment: "")
        case .last3Months: return String(localized: "app_state.time_range.last_3_months.label", defaultValue: "Last 3 months", comment: "")
        }
    }
...
final class AppState {
    ...
    var insightsBackLabel: String {
        insightsReturnTab == .dictations ? String(localized: "app_state.insights.back_to_dictations", defaultValue: "Back to Dictations", comment: "") : String(localized: "app_state.insights.back_to_timeline", defaultValue: "Back to Timeline", comment: "")
    }
