...
struct SidebarView: View {
    ...
    private var pendingUpdateCTA: UpdateCTA? {
        ...
        case .available:
            return UpdateCTA(
                label: String(localized: "sidebar.update.cta_title", defaultValue: "Update", bundle: .module, comment: "Call-to-action title for update prompt in sidebar."),
                icon: "arrow.down",
                foreground: updateCTAForeground,
                accessibilityLabel: String(localized: "sidebar.update.available", defaultValue: "Update available", bundle: .module, comment: "Status title indicating an app update is available."),
                tooltip: String(localized: "sidebar.update.open_about_for_instructions", defaultValue: "Open About for update instructions", bundle: .module, comment: "Guidance to open About page for update instructions.")
            )
        case .downloaded:
            return UpdateCTA(
                label: String(localized: "sidebar.update.ready_title", defaultValue: "Ready", bundle: .module, comment: "Status title indicating update is ready to install."),
                icon: "arrow.clockwise",
                foreground: updateCTAForeground,
                accessibilityLabel: String(localized: "sidebar.update.ready_message", defaultValue: "Update ready to install", bundle: .module, comment: "Status message indicating update is ready for installation."),
                tooltip: String(localized: "sidebar.update.open_about_for_instructions", defaultValue: "Open About for update instructions", bundle: .module, comment: "Guidance to open About page for update instructions.")
            )
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
            ...
            sidebarItem(tab: .timeline, icon: "clock.fill", label: String(localized: "sidebar.timeline", defaultValue: "Timeline", bundle: .module, comment: "Sidebar navigation item title for timeline view."))
            sidebarItem(tab: .dictations, icon: "mic.fill", label: String(localized: "sidebar.dictations", defaultValue: "Dictations", bundle: .module, comment: "Sidebar navigation item title for dictations view."))
            meetingsSection
            sidebarItem(tab: .dictionary, icon: "character.book.closed", label: String(localized: "sidebar.dictionary", defaultValue: "Dictionary", bundle: .module, comment: "Sidebar navigation item title for dictionary view."))
            sidebarItem(tab: .models, icon: "square.and.arrow.down", label: String(localized: "sidebar.models", defaultValue: "Models", bundle: .module, comment: "Sidebar navigation item title for models view."))
            sidebarItem(tab: .shortcuts, icon: "keyboard", label: String(localized: "sidebar.shortcuts", defaultValue: "Shortcuts", bundle: .module, comment: "Sidebar navigation item title for shortcuts view."))

            Spacer()

            modelPreparationStatus
            spreadTheWordSection
            sidebarItem(tab: .settings, icon: "gearshape", label: String(localized: "sidebar.settings", defaultValue: "Settings", bundle: .module, comment: "Sidebar navigation item title for settings view."))
            sidebarItem(tab: .about, icon: "info.circle", label: String(localized: "sidebar.about", defaultValue: "About", bundle: .module, comment: "Sidebar navigation item title for about view."), updateCTA: pendingUpdateCTA)
            darkModeToggle
        ...
        .alert(
            String(format: String(localized: "sidebar.folder.delete.confirmation_title", defaultValue: "Delete \"%@\"?", bundle: .module, comment: "Confirmation alert title for deleting a folder by name."), "\(folderToDelete?.name ?? "")"),
            isPresented: $showDeleteConfirmation
        ) {
            Button(String(localized: "common.cancel", defaultValue: "Cancel", bundle: .module, comment: "Common cancel action button title."), role: .cancel) {
                folderToDelete = nil
            }
            Button(String(localized: "sidebar.folder.delete.confirmation_action", defaultValue: "Delete", bundle: .module, comment: "Destructive confirmation action title for folder deletion."), role: .destructive) {
    ...
    private var sidebarHeader: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
            ...
            if !userName.isEmpty {
                Text(String(format: String(localized: "sidebar.greeting.with_name", defaultValue: "Hi, %@", bundle: .module, comment: "Greeting shown in sidebar with the user's name."), "\(userName)"))
    ...
    private var meetingsSection: some View {
        VStack(alignment: .leading, spacing: 2) {
            ...
            HStack(spacing: MuesliTheme.spacing12) {
                ...
                .buttonStyle(.plain)
                .help(String(localized: "sidebar.meetings.new_folder.help", defaultValue: "New Meeting Folder", bundle: .module, comment: "Tooltip/help text for creating a new meeting folder."))
            }
            ...
            if meetingsExpanded {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    meetingFilterRow(
                        icon: "tray.2",
                        label: String(localized: "sidebar.meetings.filter.all", defaultValue: "All Meetings", bundle: .module, comment: "Filter option label for showing all meetings."),
                    ...
                    ForEach(folderTree.visibleFolders) { folder in
                        ...
                        if renamingFolderID == folder.id {
                            ...
                            .contextMenu {
                                ...
                                Button(String(localized: "sidebar.meetings.rename", defaultValue: "Rename", bundle: .module, comment: "Context menu action to rename folder or meeting group.")) {
                                    renamingFolderID = folder.id
                                    renamingFolderName = folder.name
                                }
                                if folder.parentID != nil {
                                    Button(String(localized: "sidebar.folder.move_to_top_level", defaultValue: "Move to Top Level", bundle: .module, comment: "Context menu action to move a folder to top level.")) {
    ...
    private func folderRenameField(folder: MeetingFolder) -> some View {
        HStack(spacing: MuesliTheme.spacing8) {
            Image(systemName: "folder")
                ...
                .foregroundStyle(MuesliTheme.accent)
                .frame(width: sidebarIconColumnWidth)
            TextField(String(localized: "sidebar.folder.rename.placeholder", defaultValue: "Folder name", bundle: .module, comment: "Placeholder text for folder rename field."), text: $renamingFolderName)
                .font(MuesliTheme.callout())
                .textFieldStyle(.plain)
                .onSubmit {
    ...
    private func createNewFolder() {
        if let id = controller.createFolder(name: String(localized: "sidebar.folder.new_folder.title.primary", defaultValue: "New Folder", bundle: .module, comment: "Primary title label for creating a new folder.")) {
            withAnimation(.easeInOut(duration: 0.15)) {
                meetingsExpanded = true
            }
            renamingFolderID = id
            renamingFolderName = String(localized: "sidebar.folder.new_folder.title.secondary", defaultValue: "New Folder", bundle: .module, comment: "Secondary title label for creating a new folder.")
            controller.showMeetingsHome(folderID: id)
        }
    }

    private func createNewSubfolder(parentID: Int64) {
        if let id = controller.createSubfolder(name: String(localized: "sidebar.folder.new_folder.title.tertiary", defaultValue: "New Folder", bundle: .module, comment: "Tertiary title label for creating a new folder."), parentID: parentID) {
            withAnimation(.easeInOut(duration: 0.15)) {
                meetingsExpanded = true
                collapsedFolderIDs.remove(parentID)
            }
            renamingFolderID = id
            renamingFolderName = String(localized: "sidebar.folder.new_folder.title.quaternary", defaultValue: "New Folder", bundle: .module, comment: "Quaternary title label for creating a new folder.")
            controller.showMeetingsHome(folderID: id)
        }
    }
}
