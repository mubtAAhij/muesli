...
struct MeetingCandidate: Equatable {
    enum Platform: String, Equatable {
        ...
        var displayName: String {
            ...
            case .teams: return String(localized: "meeting_candidate.platform.teams", defaultValue: "Teams", bundle: .module, comment: "Display name for Teams platform.")
...
final class MeetingCandidateResolver {
    ...
    static let browserApps: [String: String] = [
        "com.google.Chrome": String(localized: "meeting_candidate.browser_app.chrome", defaultValue: "Chrome", bundle: .module, comment: "Browser app name for Chrome."),
        ...
        "com.microsoft.edgemac": String(localized: "meeting_candidate.browser_app.edge", defaultValue: "Edge", bundle: .module, comment: "Browser app name for Edge."),
    ...
    func resolve(_ snapshot: MeetingSignalSnapshot) -> MeetingCandidate? {
        ...
        if let calendarEvent = snapshot.calendarEvent {
            ...
            return candidate(
                ...
                appName: app?.name ?? String(localized: "meeting_candidate.fallback.meeting", defaultValue: "Meeting", bundle: .module, comment: "Fallback meeting label when platform cannot be determined."),
                url: nil,
                title: calendarEvent.title,
