...
struct MeetingCandidate: Equatable {
    enum Platform: String, Equatable {
        ...
        var displayName: String {
            switch self {
            case .googleMeet: return String(localized: "meeting_candidate.platform.google_meet", defaultValue: "Google Meet", comment: "")
            case .zoom: return String(localized: "meeting_candidate.platform.zoom", defaultValue: "Zoom", comment: "")
            case .teams: return String(localized: "meeting_candidate.platform.teams", defaultValue: "Teams", comment: "")
            case .webex: return String(localized: "meeting_candidate.platform.webex", defaultValue: "Webex", comment: "")
            case .facetime: return String(localized: "meeting_candidate.platform.facetime", defaultValue: "FaceTime", comment: "")
            case .slack: return String(localized: "meeting_candidate.platform.slack", defaultValue: "Slack", comment: "")
            case .whatsApp: return String(localized: "meeting_candidate.platform.whatsapp", defaultValue: "WhatsApp", comment: "")
            case .unknown: return String(localized: "meeting_candidate.platform.generic", defaultValue: "Meeting", comment: "")
            }
        }
    }
...
final class MeetingCandidateResolver {
    ...
    static let dedicatedApps: [String: (name: String, platform: MeetingCandidate.Platform)] = [
        "us.zoom.xos": (String(localized: "meeting_candidate.dedicated_app.zoom", defaultValue: "Zoom", comment: ""), .zoom),
        "us.zoom.ZoomPhone": (String(localized: "meeting_candidate.dedicated_app.zoom_phone", defaultValue: "Zoom Phone", comment: ""), .zoom),
        "com.apple.FaceTime": (String(localized: "meeting_candidate.dedicated_app.facetime", defaultValue: "FaceTime", comment: ""), .facetime),
        "com.microsoft.teams2": (String(localized: "meeting_candidate.dedicated_app.teams", defaultValue: "Teams", comment: ""), .teams),
        "com.microsoft.teams": (String(localized: "meeting_candidate.dedicated_app.teams", defaultValue: "Teams", comment: ""), .teams),
        "com.tinyspeck.slackmacgap": (String(localized: "meeting_candidate.dedicated_app.slack", defaultValue: "Slack", comment: ""), .slack),
        "com.webex.meetingmanager": (String(localized: "meeting_candidate.dedicated_app.webex", defaultValue: "Webex", comment: ""), .webex),
        "com.cisco.webexmeetingsapp": (String(localized: "meeting_candidate.dedicated_app.webex", defaultValue: "Webex", comment: ""), .webex),
        "net.whatsapp.WhatsApp": (String(localized: "meeting_candidate.dedicated_app.whatsapp", defaultValue: "WhatsApp", comment: ""), .whatsApp),
    ]
    ...
    static let browserApps: [String: String] = [
        "com.google.Chrome": String(localized: "meeting_candidate.browser_app.chrome", defaultValue: "Chrome", comment: ""),
        "com.brave.Browser": String(localized: "meeting_candidate.browser_app.brave", defaultValue: "Brave", comment: ""),
        "company.thebrowser.Browser": String(localized: "meeting_candidate.browser_app.arc", defaultValue: "Arc", comment: ""),
        "com.microsoft.edgemac": String(localized: "meeting_candidate.browser_app.edge", defaultValue: "Edge", comment: ""),
        "com.apple.Safari": String(localized: "meeting_candidate.browser_app.safari", defaultValue: "Safari", comment: ""),
    ]
    ...
    func resolve(_ snapshot: MeetingSignalSnapshot) -> MeetingCandidate? {
        ...
        if let calendarEvent = snapshot.calendarEvent {
            ...
            return candidate(
                ...
                appName: app?.name ?? String(localized: "meeting_candidate.fallback.meeting", defaultValue: "Meeting", comment: ""),
                url: nil,
                title: calendarEvent.title,
