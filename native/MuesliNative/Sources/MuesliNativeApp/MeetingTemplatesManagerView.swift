...
struct MeetingTemplatesManagerView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing20) {
            HStack(alignment: .top) {
                VStack(alignment: .leading, spacing: 4) {
                    Text(String(localized: "meeting_templates_manager.title", defaultValue: "Manage Templates", bundle: .module, comment: ""))
                        .font(MuesliTheme.title2())
                        .foregroundStyle(MuesliTheme.textPrimary)
                    Text(String(localized: "meeting_templates_manager.subtitle", defaultValue: "Create reusable prompt-based note formats for meetings.", bundle: .module, comment: ""))
                ...
                HStack(spacing: MuesliTheme.spacing8) {
                    if isCreatingTemplate || editingTemplateID != nil {
                        actionButton(String(localized: "common.cancel", defaultValue: "Cancel", bundle: .module, comment: ""), systemImage: "xmark") {
                            resetTemplateEditor()
                        }
                    } else {
                        actionButton(String(localized: "meeting_templates_manager.toolbar.new_template", defaultValue: "New template", bundle: .module, comment: ""), systemImage: "plus") {
                            beginCreatingTemplate()
                        }
                    }

                    actionButton(String(localized: "meeting_templates_manager.toolbar.done", defaultValue: "Done", bundle: .module, comment: ""), systemImage: "checkmark") {
                        onClose()
                    }
                    .disabled(isEditingTemplateInProgress)
                    .opacity(isEditingTemplateInProgress ? 0.55 : 1)
                    .help(isEditingTemplateInProgress ? String(localized: "meeting_templates_manager.close.help.editing_in_progress", defaultValue: "Finish or cancel template editing before closing.", bundle: .module, comment: "") : String(localized: "meeting_templates_manager.close.help", defaultValue: "Close template manager", bundle: .module, comment: ""))
                }
            }
        ...
        .alert(
            String(format: String(localized: "meeting_templates_manager.delete.alert_title", defaultValue: "Delete \"%@\"?", bundle: .module, comment: ""), "\(templateToDelete?.name ?? "")"),
            isPresented: Binding(
            ...
            Button(String(localized: "common.delete", defaultValue: "Delete", bundle: .module, comment: ""), role: .destructive) {
            ...
            Text(String(localized: "meeting_templates_manager.delete.warning_message", defaultValue: "This template will be permanently removed. Existing meetings will keep their saved template snapshot.", bundle: .module, comment: ""))
        }
    }
    ...
    private var emptyState: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            ...
            Text(String(localized: "meeting_templates_manager.empty_state.no_custom_templates", defaultValue: "No custom templates yet.", bundle: .module, comment: ""))
                .font(MuesliTheme.callout())
                .foregroundStyle(MuesliTheme.textTertiary)
        }
    ...
    private func customTemplateRow(_ template: CustomMeetingTemplate) -> some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing8) {
            HStack(alignment: .top, spacing: MuesliTheme.spacing12) {
                ...
                Spacer()
                HStack(spacing: MuesliTheme.spacing8) {
                    actionButton(String(localized: "meeting_templates_manager.template_row.edit", defaultValue: "Edit", bundle: .module, comment: ""), systemImage: "pencil") {
                        beginEditingTemplate(template)
                    }
                    actionButton(String(localized: "common.delete", defaultValue: "Delete", bundle: .module, comment: ""), systemImage: "trash", role: .destructive) {
    ...
    private var customTemplateEditor: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
            Text(isCreatingTemplate ? String(localized: "meeting_templates_manager.editor.new_template", defaultValue: "New template", bundle: .module, comment: "") : String(localized: "meeting_templates_manager.editor.edit_template", defaultValue: "Edit template", bundle: .module, comment: ""))
                .font(MuesliTheme.captionMedium())
                .foregroundStyle(MuesliTheme.textPrimary)

            VStack(alignment: .leading, spacing: 6) {
                Text(String(localized: "meeting_templates_manager.editor.name_label", defaultValue: "Name", bundle: .module, comment: ""))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textSecondary)
                TextField(String(localized: "meeting_templates_manager.editor.name_placeholder", defaultValue: "Customer follow-up", bundle: .module, comment: ""), text: $draftTemplateName)
                ...
                if showNameValidationError {
                    Text(String(localized: "meeting_templates_manager.editor.name_validation", defaultValue: "Enter a template name.", bundle: .module, comment: ""))
                        .font(MuesliTheme.caption())
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text(String(localized: "meeting_templates_manager.editor.icon_label", defaultValue: "Icon", bundle: .module, comment: ""))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textSecondary)
                customIconPicker
            }
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text(String(localized: "meeting_templates_manager.editor.prompt_label", defaultValue: "Prompt", bundle: .module, comment: ""))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textSecondary)
                ...
                if showPromptValidationError {
                    Text(String(localized: "meeting_templates_manager.editor.prompt_help", defaultValue: "Enter the prompt instructions for this template.", bundle: .module, comment: ""))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.recording)
                }
            }
            ...
            HStack {
                Spacer()
                actionButton(
                    isCreatingTemplate ? String(localized: "meeting_templates_manager.editor.create_template", defaultValue: "Create template", bundle: .module, comment: "") : String(localized: "meeting_templates_manager.editor.save_changes", defaultValue: "Save changes", bundle: .module, comment: ""),
    ...
    private var selectedIconLabel: String {
        MeetingTemplates.customIconOptions.first(where: { $0.symbolName == draftTemplateIcon })?.label ?? String(localized: "meeting_templates_manager.editor.icon_label.custom", defaultValue: "Custom", bundle: .module, comment: "")
    }
