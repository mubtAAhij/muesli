...
enum CohereTranscribeLanguage: String, CaseIterable, Codable, Sendable {
    ...
    var label: String {
        switch self {
        case .english: return String(localized: "cohere_transcribe.language.english", defaultValue: "English", bundle: .module, comment: "Language display name for English.")
        case .french: return String(localized: "cohere_transcribe.language.french", defaultValue: "French", bundle: .module, comment: "Language display name for French.")
        case .german: return String(localized: "cohere_transcribe.language.german", defaultValue: "German", bundle: .module, comment: "Language display name for German.")
        case .spanish: return String(localized: "cohere_transcribe.language.spanish", defaultValue: "Spanish", bundle: .module, comment: "Language display name for Spanish.")
        case .italian: return String(localized: "cohere_transcribe.language.italian", defaultValue: "Italian", bundle: .module, comment: "Language display name for Italian.")
        case .portuguese: return String(localized: "cohere_transcribe.language.portuguese", defaultValue: "Portuguese", bundle: .module, comment: "Language display name for Portuguese.")
        case .dutch: return String(localized: "cohere_transcribe.language.dutch", defaultValue: "Dutch", bundle: .module, comment: "Language display name for Dutch.")
        case .polish: return String(localized: "cohere_transcribe.language.polish", defaultValue: "Polish", bundle: .module, comment: "Language display name for Polish.")
        case .greek: return String(localized: "cohere_transcribe.language.greek", defaultValue: "Greek", bundle: .module, comment: "Language display name for Greek.")
        case .arabic: return String(localized: "cohere_transcribe.language.arabic", defaultValue: "Arabic", bundle: .module, comment: "Language display name for Arabic.")
        case .japanese: return String(localized: "cohere_transcribe.language.japanese", defaultValue: "Japanese", bundle: .module, comment: "Language display name for Japanese.")
        case .chinese: return String(localized: "cohere_transcribe.language.chinese", defaultValue: "Chinese", bundle: .module, comment: "Language display name for Chinese.")
        case .vietnamese: return String(localized: "cohere_transcribe.language.vietnamese", defaultValue: "Vietnamese", bundle: .module, comment: "Language display name for Vietnamese.")
        case .korean: return String(localized: "cohere_transcribe.language.korean", defaultValue: "Korean", bundle: .module, comment: "Language display name for Korean.")
        }
    }
...
enum CohereTranscribeModelStore {
    ...
    private static func downloadMissingFiles(
        ...
        try await ModelDownloadCoordinator.shared.download(manifest, to: directory) { snapshot in
            ...
            let current = snapshot.currentFile ?? String(localized: "cohere_transcribe.download.model_files", defaultValue: "model files", bundle: .module, comment: "Progress noun for downloaded model files.")
            let speed = ModelDownloadDisplayFormatting.rate(snapshot.bytesPerSecond)
            let detail = speed.isEmpty ? "" : " · " + speed
            progress?(fraction, String(localized: "cohere_transcribe.download.in_progress_prefix", defaultValue: "Downloading", bundle: .module, comment: "Prefix shown while download is in progress.") + " " + current + detail)
...
actor CohereTranscribeTranscriber {
    ...
    enum TranscriberError: Error, LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .notLoaded:
                return String(localized: "cohere_transcribe.error.models_not_loaded", defaultValue: "Cohere Transcribe models not loaded. Call loadModels() first.", bundle: .module, comment: "Error shown when inference is attempted before models are loaded.")
            }
        }
    }
