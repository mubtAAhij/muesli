...
actor Nemotron35StreamingTranscriber: NemotronStreamingTranscribing {
    ...
    private func performLoadModels(
        ...
        progressSnapshot?(ModelDownloadProgress.preparing(modelID: Nemotron35ModelStore.repoID, message: String(localized: "nemotron35_backend.status.preparing_coreml_models", defaultValue: "Preparing Nemotron 3.5 Core ML models...", comment: "Status shown while preparing Nemotron Core ML models")))
