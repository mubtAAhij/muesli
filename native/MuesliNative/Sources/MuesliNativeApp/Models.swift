...
struct BackendOption: Equatable {
    ...
    static let parakeetMultilingual = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v3.title", defaultValue: "Parakeet v3", bundle: Bundle.module, comment: "Title for Parakeet v3 backend option"),
        sizeLabel: String(localized: "backend_option.parakeet_v3.size", defaultValue: "~450 MB", bundle: Bundle.module, comment: "Approximate download size label for Parakeet v3 backend option"),
        description: String(localized: "backend_option.parakeet_v3.description", defaultValue: "The best default for everyday dictation: quick enough to feel responsive, reliable in normal rooms, and able to follow 25 languages.", bundle: Bundle.module, comment: "Description for Parakeet v3 backend option"),
        recommended: true
    )
    ...
    static let parakeetEnglish = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v2.title", defaultValue: "Parakeet v2", bundle: Bundle.module, comment: "Title for Parakeet v2 backend option"),
        sizeLabel: String(localized: "backend_option.parakeet_v2.size", defaultValue: "~450 MB", bundle: Bundle.module, comment: "Approximate download size label for Parakeet v2 backend option"),
        description: String(localized: "backend_option.parakeet_v2.description", defaultValue: "A quick, dependable English-only option. Choose it if you mainly dictate in English and prefer the older Parakeet model.", bundle: Bundle.module, comment: "Description for Parakeet v2 backend option"),
        recommended: false
    )
    ...
    static let whisperSmall = BackendOption(
        backend: "whisper",
        model: "small",
        label: String(localized: "backend_option.whisper_small.title", defaultValue: "Whisper Small Multilingual", bundle: Bundle.module, comment: "Title for Whisper Small multilingual backend option"),
        sizeLabel: String(localized: "backend_option.whisper_small.size", defaultValue: "~250 MB", bundle: Bundle.module, comment: "Approximate download size label for Whisper Small backend option"),
        description: String(localized: "backend_option.whisper_small.description", defaultValue: "A balanced multilingual Whisper option for everyday notes. It handles accents and background noise better than Tiny while keeping the download modest. Auto-detect language by default, or choose one yourself.", bundle: Bundle.module, comment: "Description for Whisper Small multilingual backend option"),
        recommended: false
    )
    ...
    static let whisperTiny = BackendOption(
        backend: "whisper",
        model: "tiny",
        label: String(localized: "backend_option.whisper_tiny.title", defaultValue: "Whisper Tiny Multilingual", bundle: Bundle.module, comment: "Title for Whisper Tiny multilingual backend option"),
        sizeLabel: String(localized: "backend_option.whisper_tiny.size", defaultValue: "~153 MB", bundle: Bundle.module, comment: "Approximate download size label for Whisper Tiny backend option"),
        description: String(localized: "backend_option.whisper_tiny.description", defaultValue: "The quickest Whisper download and lightest multilingual option for occasional notes. It gives up some accuracy on accents, noise, and longer speech. Auto-detect language by default, or choose one yourself.", bundle: Bundle.module, comment: "Description for Whisper Tiny multilingual backend option"),
        recommended: false
    )
    ...
    static let whisperLargeTurbo = BackendOption(
        ...
        label: String(localized: "backend_option.whisper_large_turbo.title", defaultValue: "Whisper Large Turbo Multilingual", bundle: Bundle.module, comment: "Title for Whisper Large Turbo multilingual backend option"),
        sizeLabel: String(localized: "backend_option.whisper_large_turbo.size", defaultValue: "~626 MB", bundle: Bundle.module, comment: "Approximate download size label for Whisper Large Turbo backend option"),
        description: String(localized: "backend_option.whisper_large_turbo.description", defaultValue: "Whisper's strongest multilingual option. Better for mixed languages and difficult audio, with a larger download and more processing time than Small. Auto-detect language by default, or pin a language.", bundle: Bundle.module, comment: "Description for Whisper Large Turbo multilingual backend option"),
        recommended: false
    )
    ...
    static let whisperTinyEnglish = BackendOption(
        backend: "whisper",
        model: "tiny.en",
        label: String(localized: "backend_option.whisper_tiny_english.title", defaultValue: "Whisper Tiny English", bundle: Bundle.module, comment: "Title for Whisper Tiny English-only backend option"),
        sizeLabel: String(localized: "backend_option.whisper_tiny_english.size", defaultValue: "~153 MB", bundle: Bundle.module, comment: "Approximate download size label for Whisper Tiny English backend option"),
        description: String(localized: "backend_option.whisper_tiny_english.description", defaultValue: "The quickest English-only Whisper option for lightweight notes. Choose it when you always speak English and do not need automatic language detection.", bundle: Bundle.module, comment: "Description for Whisper Tiny English-only backend option"),
        recommended: false
    )
    ...
    static let whisperSmallEnglish = BackendOption(
        backend: "whisper",
        model: "small.en",
        label: String(localized: "backend_option.whisper_small_english.title", defaultValue: "Whisper Small English", bundle: Bundle.module, comment: "Title for Whisper Small English-only backend option"),
        sizeLabel: String(localized: "backend_option.whisper_small_english.size", defaultValue: "~250 MB", bundle: Bundle.module, comment: "Approximate download size label for Whisper Small English backend option"),
        description: String(localized: "backend_option.whisper_small_english.description", defaultValue: "A balanced English-only Whisper option for everyday dictation. It handles accents and background noise better than Tiny when you do not need other languages.", bundle: Bundle.module, comment: "Description for Whisper Small English backend option"),
        recommended: false
    )
    ...
    static let whisperMediumEnglish = BackendOption(
        backend: "whisper",
        model: "medium.en",
        label: String(localized: "backend_option.whisper_medium_english.title", defaultValue: "Whisper Medium English", bundle: Bundle.module, comment: "Title for Whisper Medium English backend option"),
        sizeLabel: String(localized: "backend_option.whisper_medium_english.size", defaultValue: "~1.5 GB", bundle: Bundle.module, comment: "Approximate download size label for Whisper Medium English backend option"),
        description: String(localized: "backend_option.whisper_medium_english.description", defaultValue: "A larger English-only Whisper option for difficult accents and noisier recordings. It favors accuracy over download size and speed.", bundle: Bundle.module, comment: "Description for Whisper Medium English backend option"),
        recommended: false
    )
    ...
    static let nemotron35Multilingual = BackendOption(
        ...
        label: String(localized: "backend_option.nemotron35_multilingual.title", defaultValue: "Nemotron 3.5 Multilingual", bundle: Bundle.module, comment: "Title for Nemotron 3.5 multilingual backend option"),
        sizeLabel: String(localized: "backend_option.nemotron35_multilingual.size", defaultValue: "~665 MB", bundle: Bundle.module, comment: "Approximate download size label for Nemotron 3.5 multilingual backend option"),
        description: String(localized: "backend_option.nemotron35_multilingual.description", defaultValue: "Live text appears as you speak in more than 100 locales, including Hindi, Chinese, and Japanese, with language auto-detection and punctuation. It works for hold-to-talk, hands-free dictation, and meetings, but it only appends words—it does not go back to correct earlier text.", bundle: Bundle.module, comment: "Description for Nemotron 3.5 multilingual backend option"),
        recommended: false
    )
    ...
    static let cohereTranscribe = BackendOption(
        ...
        label: String(localized: "backend_option.cohere_transcribe.title", defaultValue: "Cohere Transcribe", bundle: Bundle.module, comment: "Title for Cohere Transcribe backend option"),
        sizeLabel: String(localized: "backend_option.cohere_transcribe.size", defaultValue: "~3.8 GB", bundle: Bundle.module, comment: "Approximate download size label for Cohere Transcribe backend option"),
        description: String(localized: "backend_option.cohere_transcribe.description", defaultValue: "The most deliberate option for difficult accents and tricky audio. It supports 14 languages and can be more accurate than faster models, but the download is large and you only see the result after you stop speaking.", bundle: Bundle.module, comment: "Description for Cohere Transcribe backend option"),
        recommended: false
    )
    ...
    static let indicASR = BackendOption(
        ...
        label: String(localized: "backend_option.indic_asr.title", defaultValue: "Indic ASR", bundle: Bundle.module, comment: "Title for Indic ASR backend option"),
        sizeLabel: String(localized: "backend_option.indic_asr.size", defaultValue: "~618 MB", bundle: Bundle.module, comment: "Approximate download size label for Indic ASR backend option"),
        description: String(localized: "backend_option.indic_asr.description", defaultValue: "Built specifically for seven Indian languages. Choose your language before recording; it can help where general multilingual models struggle, but results still vary enough to keep it experimental.", bundle: Bundle.module, comment: "Description for Indic ASR backend option"),
        recommended: false
    )
    ...
    static let gemma4E2BLiteRT = BackendOption(
        ...
        label: String(localized: "backend_option.gemma4_e2b.title", defaultValue: "Gemma 4 E2B", bundle: Bundle.module, comment: "Title for Gemma 4 E2B backend option"),
        sizeLabel: String(localized: "backend_option.gemma4_e2b.size", defaultValue: "~2.6 GB", bundle: Bundle.module, comment: "Approximate download size label for Gemma 4 E2B backend option"),
        description: String(localized: "backend_option.gemma4_e2b.description", defaultValue: "A research preview, not a dependable dictation model yet. It is large, slow to get ready, requires macOS 15 or later, and may produce an answer instead of a faithful transcript.", bundle: Bundle.module, comment: "Description for Gemma 4 E2B backend option"),
        recommended: false
    )
    ...
    static let appleSpeechAnalyzer = BackendOption(
        ...
        label: String(localized: "backend_option.apple_speech.title", defaultValue: "Apple Speech", bundle: Bundle.module, comment: "Title for Apple Speech backend option"),
        sizeLabel: String(localized: "backend_option.apple_speech.size", defaultValue: "System managed", bundle: Bundle.module, comment: "Size/status label indicating Apple Speech is managed by the system"),
        description: String(localized: "backend_option.apple_speech.description", defaultValue: "Apple's private, on-device speech model for macOS 26. It is designed for dictation, meetings, distant speakers, and long recordings, while macOS manages the language assets and updates.", bundle: Bundle.module, comment: "Description for Apple Speech backend option"),
        recommended: false
    )
    ...
    static let qwen3Asr = BackendOption(
        ...
        label: String(localized: "backend_option.qwen3_asr.title", defaultValue: "Qwen3 ASR", bundle: Bundle.module, comment: "Title for Qwen3 ASR backend option"),
        sizeLabel: String(localized: "backend_option.qwen3_asr.size", defaultValue: "~1.3 GB", bundle: Bundle.module, comment: "Approximate download size label for Qwen3 ASR backend option"),
        description: String(localized: "backend_option.qwen3_asr.description", defaultValue: "Strong multilingual transcription across 52 languages when accuracy matters more than instant results. Expect a short 2–3 second wait compared with Parakeet, and about 30 seconds of one-time preparation the first time it runs.", bundle: Bundle.module, comment: "Description for Qwen3 ASR backend option"),
        recommended: false
    )
...
enum Nemotron35Language: String, CaseIterable, Codable, Sendable {
    ...
    var label: String {
        switch self {
        case .auto: return String(localized: "language.label.auto_detect", defaultValue: "Auto-detect", bundle: Bundle.module, comment: "Language label for automatic language detection")
        case .english: return String(localized: "language.label.english", defaultValue: "English", bundle: Bundle.module, comment: "Language label for English")
        case .hindi: return String(localized: "language.label.hindi", defaultValue: "Hindi", bundle: Bundle.module, comment: "Language label for Hindi")
        case .spanish: return String(localized: "language.label.spanish", defaultValue: "Spanish", bundle: Bundle.module, comment: "Language label for Spanish")
        case .french: return String(localized: "language.label.french", defaultValue: "French", bundle: Bundle.module, comment: "Language label for French")
        case .german: return String(localized: "language.label.german", defaultValue: "German", bundle: Bundle.module, comment: "Language label for German")
        case .italian: return String(localized: "language.label.italian", defaultValue: "Italian", bundle: Bundle.module, comment: "Language label for Italian")
        case .portuguese: return String(localized: "language.label.portuguese", defaultValue: "Portuguese", bundle: Bundle.module, comment: "Language label for Portuguese")
        case .chinese: return String(localized: "language.label.chinese", defaultValue: "Chinese", bundle: Bundle.module, comment: "Language label for Chinese")
        case .japanese: return String(localized: "language.label.japanese", defaultValue: "Japanese", bundle: Bundle.module, comment: "Language label for Japanese")
        case .korean: return String(localized: "language.label.korean", defaultValue: "Korean", bundle: Bundle.module, comment: "Language label for Korean")
        case .russian: return String(localized: "language.label.russian", defaultValue: "Russian", bundle: Bundle.module, comment: "Language label for Russian")
        case .arabic: return String(localized: "language.label.arabic", defaultValue: "Arabic", bundle: Bundle.module, comment: "Language label for Arabic")
        }
    }
...
enum MeetingLiveCaptionBackend: String, CaseIterable, Codable, Sendable {
    ...
    var settingsLabel: String {
        switch self {
        case .parakeetRealtimeEOU: return String(format: String(localized: "settings.label.live_preview_only", defaultValue: "%@ (live preview only)", bundle: Bundle.module, comment: "Label suffix indicating live preview only mode"), "\(label)")
        case .nemotron35: return String(format: String(localized: "settings.label.live_and_final", defaultValue: "%@ (live + final)", bundle: Bundle.module, comment: "Label suffix indicating live plus final mode"), "\(label)")
        }
    }
...
struct SummaryModelPreset {
    ...
    static func menuPresets(_ presets: [SummaryModelPreset], currentModel: String) -> [SummaryModelPreset] {
        ...
        return presets + [SummaryModelPreset(id: trimmedModel, label: String(format: String(localized: "summary_model.custom", defaultValue: "Custom: %@", bundle: Bundle.module, comment: "Summary model label showing custom model name"), "\(trimmedModel)"))]
    }
...
extension OpenRouterModel {
    ...
    var summaryPresetLabel: String {
        if let contextLength, contextLength > 0 {
            return String(format: String(localized: "summary.preset.label_with_context", defaultValue: "%@ (%@ ctx)", bundle: Bundle.module, comment: "Summary preset label with context length suffix"), "\(name)", "\(Self.formatContextLength(contextLength))")
        }
        return name
    }
...
struct MeetingSummaryBackendOption: Equatable {
    ...
    static let customLLM = MeetingSummaryBackendOption(
        backend: "custom_llm",
        label: String(localized: "meeting_summary.backend.custom_llm", defaultValue: "Custom LLM", bundle: Bundle.module, comment: "Meeting summary backend label for custom LLM")
    )
...
struct PostProcessorOption: Identifiable, Equatable {
    ...
    static let finetunedV2 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v2.title", defaultValue: "Muesli Cleanup (Legacy)", bundle: Bundle.module, comment: "Title for legacy Muesli cleanup postprocessor"),
        sizeLabel: String(localized: "postprocessor.finetuned_v2.size", defaultValue: "~390 MB", bundle: Bundle.module, comment: "Approximate download size label for legacy Muesli cleanup postprocessor"),
        description: String(localized: "postprocessor.finetuned_v2.description", defaultValue: "An earlier cleanup model for Muesli dictation. It handles filler words, corrections, and spoken lists, but is less consistent than the current model.", bundle: Bundle.module, comment: "Description for legacy Muesli cleanup postprocessor"),
    ...
    static let qwen35_0_8b = PostProcessorOption(
        id: "qwen35-0.8b",
        label: String(localized: "postprocessor.qwen35_0_8b.title", defaultValue: "Qwen Basic Cleanup", bundle: Bundle.module, comment: "Title for Qwen Basic Cleanup postprocessor"),
        sizeLabel: String(localized: "postprocessor.qwen35_0_8b.size", defaultValue: "~533 MB", bundle: Bundle.module, comment: "Approximate download size label for Qwen Basic Cleanup postprocessor"),
        description: String(localized: "postprocessor.qwen35_0_8b.description", defaultValue: "A general-purpose option for typos and filler words. It may miss “scratch that” edits and spoken list formatting.", bundle: Bundle.module, comment: "Description for Qwen Basic Cleanup postprocessor"),
    ...
    static let finetunedV3 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v3.title", defaultValue: "Muesli Cleanup", bundle: Bundle.module, comment: "Title for Muesli Cleanup postprocessor"),
        sizeLabel: String(localized: "postprocessor.finetuned_v3.size", defaultValue: "~505 MB", bundle: Bundle.module, comment: "Approximate download size for Muesli Cleanup postprocessor"),
        description: String(localized: "postprocessor.finetuned_v3.description", defaultValue: "The best overall choice for everyday dictation. It removes filler words, follows “scratch that,” and turns spoken list cues into clean formatting.", bundle: Bundle.module, comment: "Description for Muesli Cleanup postprocessor"),
...
enum TranscriptCleanupPrompts {
    ...
    static let builtIns: [TranscriptCleanupPromptPreset] = [
        TranscriptCleanupPromptPreset(
            id: defaultID,
            name: String(localized: "transcript_cleanup_preset.default_cleanup.title", defaultValue: "Default Cleanup", bundle: Bundle.module, comment: "Title for default transcript cleanup preset"),
...
enum IndicatorAnchor: String, Codable, CaseIterable {
    ...
    var label: String {
        switch self {
        case .topLeading: return String(localized: "position.label.top_left", defaultValue: "Top Left", bundle: Bundle.module, comment: "Position label for top-left placement")
        case .topCenter: return String(localized: "position.label.top_center", defaultValue: "Top Center", bundle: Bundle.module, comment: "Position label for top-center placement")
        case .topTrailing: return String(localized: "position.label.top_right", defaultValue: "Top Right", bundle: Bundle.module, comment: "Position label for top-right placement")
        case .midLeading: return String(localized: "position.label.middle_left", defaultValue: "Middle Left", bundle: Bundle.module, comment: "Position label for middle-left placement")
        case .midTrailing: return String(localized: "position.label.middle_right", defaultValue: "Middle Right", bundle: Bundle.module, comment: "Position label for middle-right placement")
        case .bottomLeading: return String(localized: "position.label.bottom_left", defaultValue: "Bottom Left", bundle: Bundle.module, comment: "Position label for bottom-left placement")
        case .bottomCenter: return String(localized: "position.label.bottom_center", defaultValue: "Bottom Center", bundle: Bundle.module, comment: "Position label for bottom-center placement")
        case .bottomTrailing: return String(localized: "position.label.bottom_right", defaultValue: "Bottom Right", bundle: Bundle.module, comment: "Position label for bottom-right placement")
        case .custom: return String(localized: "position.label.custom", defaultValue: "Custom", bundle: Bundle.module, comment: "Position label for custom placement")
        }
    }
}
...
struct HotkeyConfig: Codable, Equatable {
    ...
    var label: String = String(localized: "modifier_key.label.right_option", defaultValue: "Right Option", bundle: Bundle.module, comment: "Modifier key label for right Option key")
    ...
    static func label(for keyCode: UInt16) -> String? {
        switch keyCode {
        case 55: return String(localized: "modifier_key.label.left_cmd", defaultValue: "Left Cmd", bundle: Bundle.module, comment: "Modifier key label for left Command key")
        case 54: return String(localized: "modifier_key.label.right_cmd", defaultValue: "Right Cmd", bundle: Bundle.module, comment: "Modifier key label for right Command key")
        case 63: return String(localized: "modifier_key.label.fn", defaultValue: "Fn", bundle: Bundle.module, comment: "Modifier key label for Function key")
        case 59: return String(localized: "modifier_key.label.left_ctrl", defaultValue: "Left Ctrl", bundle: Bundle.module, comment: "Modifier key label for left Control key")
        case 62: return String(localized: "modifier_key.label.right_ctrl", defaultValue: "Right Ctrl", bundle: Bundle.module, comment: "Modifier key label for right Control key")
        case 58: return String(localized: "modifier_key.label.left_option", defaultValue: "Left Option", bundle: Bundle.module, comment: "Modifier key label for left Option key")
        case 61: return String(localized: "modifier_key.label.right_option", defaultValue: "Right Option", bundle: Bundle.module, comment: "Modifier key label for right Option key")
        case 56: return String(localized: "modifier_key.label.left_shift", defaultValue: "Left Shift", bundle: Bundle.module, comment: "Modifier key label for left Shift key")
        case 60: return String(localized: "modifier_key.label.right_shift", defaultValue: "Right Shift", bundle: Bundle.module, comment: "Modifier key label for right Shift key")
        default: return nil
        }
    }
    ...
    static func symbolLabel(for keyCode: UInt16) -> String? {
        switch keyCode {
        case 55: return String(localized: "modifier_key.symbol.left_cmd", defaultValue: "Left ⌘", bundle: Bundle.module, comment: "Modifier key symbol label for left Command key")
        case 54: return String(localized: "modifier_key.symbol.right_cmd", defaultValue: "Right ⌘", bundle: Bundle.module, comment: "Modifier key symbol label for right Command key")
        case 63: return String(localized: "modifier_key.symbol.fn", defaultValue: "fn", bundle: Bundle.module, comment: "Modifier key symbol label for Function key")
        case 59: return String(localized: "modifier_key.symbol.left_ctrl", defaultValue: "Left ⌃", bundle: Bundle.module, comment: "Modifier key symbol label for left Control key")
        case 62: return String(localized: "modifier_key.symbol.right_ctrl", defaultValue: "Right ⌃", bundle: Bundle.module, comment: "Modifier key symbol label for right Control key")
        case 58: return String(localized: "modifier_key.symbol.left_option", defaultValue: "Left ⌥", bundle: Bundle.module, comment: "Modifier key symbol label for left Option key")
        case 61: return String(localized: "modifier_key.symbol.right_option", defaultValue: "Right ⌥", bundle: Bundle.module, comment: "Modifier key symbol label for right Option key")
        case 56: return String(localized: "modifier_key.symbol.left_shift", defaultValue: "Left ⇧", bundle: Bundle.module, comment: "Modifier key symbol label for left Shift key")
        case 60: return String(localized: "modifier_key.symbol.right_shift", defaultValue: "Right ⇧", bundle: Bundle.module, comment: "Modifier key symbol label for right Shift key")
        default: return nil
        }
    }
    ...
    static let computerUseDefault = HotkeyConfig(keyCode: 54, label: String(localized: "hotkey.default.computer_use.right_cmd", defaultValue: "Right Cmd", bundle: Bundle.module, comment: "Default computer-use hotkey label for right Command key"))
