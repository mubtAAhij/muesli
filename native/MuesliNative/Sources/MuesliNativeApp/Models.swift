...
struct BackendOption: Equatable {
    ...
    static let parakeetMultilingual = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v3.title", defaultValue: "Parakeet v3", comment: ""),
        sizeLabel: String(localized: "backend_option.parakeet_v3.size", defaultValue: "~450 MB", comment: ""),
        description: String(localized: "backend_option.parakeet_v3.description", defaultValue: "The best default for everyday dictation: quick enough to feel responsive, reliable in normal rooms, and able to follow 25 languages.", comment: ""),
        recommended: true
    )
    ...
    static let parakeetEnglish = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v2.title", defaultValue: "Parakeet v2", comment: ""),
        sizeLabel: String(localized: "backend_option.parakeet_v2.size", defaultValue: "~450 MB", comment: ""),
        description: String(localized: "backend_option.parakeet_v2.description", defaultValue: "A quick, dependable English-only option. Choose it if you mainly dictate in English and prefer the older Parakeet model.", comment: ""),
        recommended: false
    )
    ...
    static let whisperSmall = BackendOption(
        backend: "whisper",
        model: "small",
        label: String(localized: "backend_option.whisper_small.title", defaultValue: "Whisper Small Multilingual", comment: ""),
        sizeLabel: String(localized: "backend_option.whisper_small.size", defaultValue: "~250 MB", comment: ""),
        description: String(localized: "backend_option.whisper_small.description", defaultValue: "A balanced multilingual Whisper option for everyday notes. It handles accents and background noise better than Tiny while keeping the download modest. Auto-detect language by default, or choose one yourself.", comment: ""),
        recommended: false
    )
    ...
    static let whisperTiny = BackendOption(
        backend: "whisper",
        model: "tiny",
        label: String(localized: "backend_option.whisper_tiny.title", defaultValue: "Whisper Tiny Multilingual", comment: ""),
        sizeLabel: String(localized: "backend_option.whisper_tiny.size", defaultValue: "~153 MB", comment: ""),
        description: String(localized: "backend_option.whisper_tiny.description", defaultValue: "The quickest Whisper download and lightest multilingual option for occasional notes. It gives up some accuracy on accents, noise, and longer speech. Auto-detect language by default, or choose one yourself.", comment: ""),
        recommended: false
    )
    ...
    static let whisperLargeTurbo = BackendOption(
        ...
        label: String(localized: "backend_option.whisper_large_turbo.title", defaultValue: "Whisper Large Turbo Multilingual", comment: ""),
        sizeLabel: String(localized: "backend_option.whisper_large_turbo.size", defaultValue: "~626 MB", comment: ""),
        description: String(localized: "backend_option.whisper_large_turbo.description", defaultValue: "Whisper's strongest multilingual option. Better for mixed languages and difficult audio, with a larger download and more processing time than Small. Auto-detect language by default, or pin a language.", comment: ""),
        recommended: false
    )
    ...
    static let whisperTinyEnglish = BackendOption(
        backend: "whisper",
        model: "tiny.en",
        label: String(localized: "backend_option.whisper_tiny_english.title", defaultValue: "Whisper Tiny English", comment: ""),
        sizeLabel: String(localized: "backend_option.whisper_tiny_english.size", defaultValue: "~153 MB", comment: ""),
        description: String(localized: "backend_option.whisper_tiny_english.description", defaultValue: "The quickest English-only Whisper option for lightweight notes. Choose it when you always speak English and do not need automatic language detection.", comment: ""),
        recommended: false
    )
    ...
    static let whisperSmallEnglish = BackendOption(
        backend: "whisper",
        model: "small.en",
        label: String(localized: "backend_option.whisper_small_english.title", defaultValue: "Whisper Small English", comment: ""),
        sizeLabel: String(localized: "backend_option.whisper_small_english.size", defaultValue: "~250 MB", comment: ""),
        description: String(localized: "backend_option.whisper_small_english.description", defaultValue: "A balanced English-only Whisper option for everyday dictation. It handles accents and background noise better than Tiny when you do not need other languages.", comment: ""),
        recommended: false
    )
    ...
    static let whisperMediumEnglish = BackendOption(
        backend: "whisper",
        model: "medium.en",
        label: String(localized: "backend_option.whisper_medium_english.title", defaultValue: "Whisper Medium English", comment: ""),
        sizeLabel: String(localized: "backend_option.whisper_medium_english.size", defaultValue: "~1.5 GB", comment: ""),
        description: String(localized: "backend_option.whisper_medium_english.description", defaultValue: "A larger English-only Whisper option for difficult accents and noisier recordings. It favors accuracy over download size and speed.", comment: ""),
        recommended: false
    )
    ...
    static let nemotron35Multilingual = BackendOption(
        ...
        label: String(localized: "backend_option.nemotron35_multilingual.title", defaultValue: "Nemotron 3.5 Multilingual", comment: ""),
        sizeLabel: String(localized: "backend_option.nemotron35_multilingual.size", defaultValue: "~665 MB", comment: ""),
    ...
    static let cohereTranscribe = BackendOption(
        ...
        label: String(localized: "backend_option.cohere_transcribe.title", defaultValue: "Cohere Transcribe", comment: ""),
        sizeLabel: String(localized: "backend_option.cohere_transcribe.size", defaultValue: "~3.8 GB", comment: ""),
        description: String(localized: "backend_option.cohere_transcribe.description", defaultValue: "The most deliberate option for difficult accents and tricky audio. It supports 14 languages and can be more accurate than faster models, but the download is large and you only see the result after you stop speaking.", comment: ""),
        recommended: false
    )
    ...
    static let indicASR = BackendOption(
        ...
        label: String(localized: "backend_option.indic_asr.title", defaultValue: "Indic ASR", comment: ""),
        sizeLabel: String(localized: "backend_option.indic_asr.size", defaultValue: "~618 MB", comment: ""),
        description: String(localized: "backend_option.indic_asr.description", defaultValue: "Built specifically for seven Indian languages. Choose your language before recording; it can help where general multilingual models struggle, but results still vary enough to keep it experimental.", comment: ""),
        recommended: false
    )
    ...
    static let senseVoiceSmall = BackendOption(
        ...
        label: String(localized: "backend_option.sensevoice_small.title", defaultValue: "SenseVoice Small", comment: ""),
        sizeLabel: SenseVoiceTranscriber.downloadedModelSizeLabel,
        description: String(localized: "backend_option.sensevoice_small.description", defaultValue: "A compact option covering more than 50 languages, with punctuation included in the result. Quality varies by language and accent, so try it with your own voice before relying on it.", comment: ""),
        recommended: false
    )
    ...
    static let gemma4E2BLiteRT = BackendOption(
        ...
        label: String(localized: "backend_option.gemma4_e2b.title", defaultValue: "Gemma 4 E2B", comment: ""),
        sizeLabel: String(localized: "backend_option.gemma4_e2b.size", defaultValue: "~2.6 GB", comment: ""),
        description: String(localized: "backend_option.gemma4_e2b.description", defaultValue: "A research preview, not a dependable dictation model yet. It is large, slow to get ready, requires macOS 15 or later, and may produce an answer instead of a faithful transcript.", comment: ""),
        recommended: false
    )
    ...
    static let appleSpeechAnalyzer = BackendOption(
        ...
        label: String(localized: "backend_option.apple_speech.title", defaultValue: "Apple Speech", comment: ""),
        sizeLabel: String(localized: "backend_option.apple_speech.size", defaultValue: "System managed", comment: ""),
        description: String(localized: "backend_option.apple_speech.description", defaultValue: "Apple's private, on-device speech model for macOS 26. It is designed for dictation, meetings, distant speakers, and long recordings, while macOS manages the language assets and updates.", comment: ""),
        recommended: false
    )
    ...
    static let qwen3Asr = BackendOption(
        ...
        label: String(localized: "backend_option.qwen3_asr.title", defaultValue: "Qwen3 ASR", comment: ""),
        sizeLabel: String(localized: "backend_option.qwen3_asr.size", defaultValue: "~1.3 GB", comment: ""),
        description: String(localized: "backend_option.qwen3_asr.description", defaultValue: "Strong multilingual transcription across 52 languages when accuracy matters more than instant results. Expect a short 2–3 second wait compared with Parakeet, and about 30 seconds of one-time preparation the first time it runs.", comment: ""),
        recommended: false
    )
...
enum Nemotron35Language: String, CaseIterable, Codable, Sendable {
    ...
    var label: String {
        switch self {
        case .auto: return String(localized: "language.label.auto_detect", defaultValue: "Auto-detect", comment: "")
        case .english: return String(localized: "language.label.english", defaultValue: "English", comment: "")
        case .hindi: return String(localized: "language.label.hindi", defaultValue: "Hindi", comment: "")
        case .spanish: return String(localized: "language.label.spanish", defaultValue: "Spanish", comment: "")
        case .french: return String(localized: "language.label.french", defaultValue: "French", comment: "")
        case .german: return String(localized: "language.label.german", defaultValue: "German", comment: "")
        case .italian: return String(localized: "language.label.italian", defaultValue: "Italian", comment: "")
        case .portuguese: return String(localized: "language.label.portuguese", defaultValue: "Portuguese", comment: "")
        case .chinese: return String(localized: "language.label.chinese", defaultValue: "Chinese", comment: "")
        case .japanese: return String(localized: "language.label.japanese", defaultValue: "Japanese", comment: "")
        case .korean: return String(localized: "language.label.korean", defaultValue: "Korean", comment: "")
        case .russian: return String(localized: "language.label.russian", defaultValue: "Russian", comment: "")
        case .arabic: return String(localized: "language.label.arabic", defaultValue: "Arabic", comment: "")
        }
    }
...
enum MeetingLiveCaptionBackend: String, CaseIterable, Codable, Sendable {
    ...
    var settingsLabel: String {
        switch self {
        case .parakeetRealtimeEOU: return String(format: String(localized: "settings.label.live_preview_only", defaultValue: "%@ (live preview only)", comment: ""), "\(label)")
        case .nemotron35: return String(format: String(localized: "settings.label.live_and_final", defaultValue: "%@ (live + final)", comment: ""), "\(label)")
        }
    }
...
struct SummaryModelPreset {
    ...
    static func menuPresets(_ presets: [SummaryModelPreset], currentModel: String) -> [SummaryModelPreset] {
        ...
        return presets + [SummaryModelPreset(id: trimmedModel, label: String(format: String(localized: "summary_model.custom", defaultValue: "Custom: %@", comment: ""), "\(trimmedModel)"))]
    }
...
extension OpenRouterModel {
    ...
    var summaryPresetLabel: String {
        if let contextLength, contextLength > 0 {
            return String(format: String(localized: "summary.preset.label_with_context", defaultValue: "%@ (%@ ctx)", comment: ""), "\(name)", "\(Self.formatContextLength(contextLength))")
        }
        return name
    }
...
struct MeetingSummaryBackendOption: Equatable {
    ...
    static let customLLM = MeetingSummaryBackendOption(
        backend: "custom_llm",
        label: String(localized: "meeting_summary.backend.custom_llm", defaultValue: "Custom LLM", comment: "")
    )
...
struct PostProcessorOption: Identifiable, Equatable {
    ...
    static let finetunedV2 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v2.title", defaultValue: "Muesli Cleanup (Legacy)", comment: ""),
        sizeLabel: String(localized: "postprocessor.finetuned_v2.size", defaultValue: "~390 MB", comment: ""),
        description: String(localized: "postprocessor.finetuned_v2.description", defaultValue: "An earlier cleanup model for Muesli dictation. It handles filler words, corrections, and spoken lists, but is less consistent than the current model.", comment: ""),
    ...
    static let qwen35_0_8b = PostProcessorOption(
        id: "qwen35-0.8b",
        label: String(localized: "postprocessor.qwen35_0_8b.title", defaultValue: "Qwen Basic Cleanup", comment: ""),
        sizeLabel: String(localized: "postprocessor.qwen35_0_8b.size", defaultValue: "~533 MB", comment: ""),
        description: String(localized: "postprocessor.qwen35_0_8b.description", defaultValue: "A general-purpose option for typos and filler words. It may miss “scratch that” edits and spoken list formatting.", comment: ""),
    ...
    static let finetunedV3 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v3.title", defaultValue: "Muesli Cleanup", comment: ""),
        sizeLabel: String(localized: "postprocessor.finetuned_v3.size", defaultValue: "~505 MB", comment: ""),
        description: String(localized: "postprocessor.finetuned_v3.description", defaultValue: "The best overall choice for everyday dictation. It removes filler words, follows “scratch that,” and turns spoken list cues into clean formatting.", comment: ""),
...
enum TranscriptCleanupPrompts {
    ...
    static let builtIns: [TranscriptCleanupPromptPreset] = [
        TranscriptCleanupPromptPreset(
            id: defaultID,
            name: String(localized: "transcript_cleanup_preset.default_cleanup.title", defaultValue: "Default Cleanup", comment: ""),
...
enum IndicatorAnchor: String, Codable, CaseIterable {
    ...
    var label: String {
        switch self {
        case .topLeading: return String(localized: "position.label.top_left", defaultValue: "Top Left", comment: "")
        case .topCenter: return String(localized: "position.label.top_center", defaultValue: "Top Center", comment: "")
        case .topTrailing: return String(localized: "position.label.top_right", defaultValue: "Top Right", comment: "")
        case .midLeading: return String(localized: "position.label.middle_left", defaultValue: "Middle Left", comment: "")
        case .midTrailing: return String(localized: "position.label.middle_right", defaultValue: "Middle Right", comment: "")
        case .bottomLeading: return String(localized: "position.label.bottom_left", defaultValue: "Bottom Left", comment: "")
        case .bottomCenter: return String(localized: "position.label.bottom_center", defaultValue: "Bottom Center", comment: "")
        case .bottomTrailing: return String(localized: "position.label.bottom_right", defaultValue: "Bottom Right", comment: "")
        case .custom: return String(localized: "position.label.custom", defaultValue: "Custom", comment: "")
        }
    }
}
...
struct HotkeyConfig: Codable, Equatable {
    ...
    var label: String = String(localized: "modifier_key.label.right_option", defaultValue: "Right Option", comment: "")
    ...
    static func label(for keyCode: UInt16) -> String? {
        switch keyCode {
        case 55: return String(localized: "modifier_key.label.left_cmd", defaultValue: "Left Cmd", comment: "")
        case 54: return String(localized: "modifier_key.label.right_cmd", defaultValue: "Right Cmd", comment: "")
        case 63: return String(localized: "modifier_key.label.fn", defaultValue: "Fn", comment: "")
        case 59: return String(localized: "modifier_key.label.left_ctrl", defaultValue: "Left Ctrl", comment: "")
        case 62: return String(localized: "modifier_key.label.right_ctrl", defaultValue: "Right Ctrl", comment: "")
        case 58: return String(localized: "modifier_key.label.left_option", defaultValue: "Left Option", comment: "")
        case 61: return String(localized: "modifier_key.label.right_option", defaultValue: "Right Option", comment: "")
        case 56: return String(localized: "modifier_key.label.left_shift", defaultValue: "Left Shift", comment: "")
        case 60: return String(localized: "modifier_key.label.right_shift", defaultValue: "Right Shift", comment: "")
        default: return nil
        }
    }
    ...
    static func symbolLabel(for keyCode: UInt16) -> String? {
        switch keyCode {
        case 55: return String(localized: "modifier_key.symbol.left_cmd", defaultValue: "Left ⌘", comment: "")
        case 54: return String(localized: "modifier_key.symbol.right_cmd", defaultValue: "Right ⌘", comment: "")
        case 63: return String(localized: "modifier_key.symbol.fn", defaultValue: "fn", comment: "")
        case 59: return String(localized: "modifier_key.symbol.left_ctrl", defaultValue: "Left ⌃", comment: "")
        case 62: return String(localized: "modifier_key.symbol.right_ctrl", defaultValue: "Right ⌃", comment: "")
        case 58: return String(localized: "modifier_key.symbol.left_option", defaultValue: "Left ⌥", comment: "")
        case 61: return String(localized: "modifier_key.symbol.right_option", defaultValue: "Right ⌥", comment: "")
        case 56: return String(localized: "modifier_key.symbol.left_shift", defaultValue: "Left ⇧", comment: "")
        case 60: return String(localized: "modifier_key.symbol.right_shift", defaultValue: "Right ⇧", comment: "")
        default: return nil
        }
    }
    ...
    static let computerUseDefault = HotkeyConfig(keyCode: 54, label: String(localized: "hotkey.default.computer_use.right_cmd", defaultValue: "Right Cmd", comment: ""))
