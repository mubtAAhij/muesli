...
struct BackendOption: Equatable {
    ...
    static let parakeetMultilingual = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v3.title", defaultValue: "Parakeet v3", bundle: .module, comment: "Title for Parakeet v3 backend option"),
        sizeLabel: String(localized: "backend_option.parakeet_v3.size", defaultValue: "~450 MB", bundle: .module, comment: "Approximate download size label for Parakeet v3 backend option"),
    ...
    static let parakeetEnglish = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v2.title", defaultValue: "Parakeet v2", bundle: .module, comment: "Title for Parakeet v2 backend option"),
        sizeLabel: String(localized: "backend_option.parakeet_v2.size", defaultValue: "~450 MB", bundle: .module, comment: "Approximate download size label for Parakeet v2 backend option"),
    ...
    static let whisperSmall = BackendOption(
        backend: "whisper",
        model: "small",
        label: String(localized: "backend_option.whisper_small.title", defaultValue: "Whisper Small Multilingual", bundle: .module, comment: "Title for Whisper Small multilingual backend option"),
        sizeLabel: String(localized: "backend_option.whisper_small.size", defaultValue: "~250 MB", bundle: .module, comment: "Approximate download size label for Whisper Small backend option"),
    ...
    static let whisperTiny = BackendOption(
        backend: "whisper",
        model: "tiny",
        label: String(localized: "backend_option.whisper_tiny.title", defaultValue: "Whisper Tiny Multilingual", bundle: .module, comment: "Title for Whisper Tiny multilingual backend option"),
        sizeLabel: String(localized: "backend_option.whisper_tiny.size", defaultValue: "~153 MB", bundle: .module, comment: "Approximate download size label for Whisper Tiny backend option"),
    ...
    static let whisperLargeTurbo = BackendOption(
        ...
        label: String(localized: "backend_option.whisper_large_turbo.title", defaultValue: "Whisper Large Turbo Multilingual", bundle: .module, comment: "Title for Whisper Large Turbo multilingual backend option"),
        sizeLabel: String(localized: "backend_option.whisper_large_turbo.size", defaultValue: "~626 MB", bundle: .module, comment: "Approximate download size label for Whisper Large Turbo backend option"),
    ...
    static let whisperTinyEnglish = BackendOption(
        backend: "whisper",
        model: "tiny.en",
        label: String(localized: "backend_option.whisper_tiny_english.title", defaultValue: "Whisper Tiny English", bundle: .module, comment: "Title for Whisper Tiny English-only backend option"),
        sizeLabel: String(localized: "backend_option.whisper_tiny_english.size", defaultValue: "~153 MB", bundle: .module, comment: "Approximate download size label for Whisper Tiny English backend option"),
    ...
    static let whisperSmallEnglish = BackendOption(
        backend: "whisper",
        model: "small.en",
        label: String(localized: "backend_option.whisper_small_english.title", defaultValue: "Whisper Small English", bundle: .module, comment: "Title for Whisper Small English-only backend option"),
        sizeLabel: String(localized: "backend_option.whisper_small_english.size", defaultValue: "~250 MB", bundle: .module, comment: "Approximate download size label for Whisper Small English backend option"),
    ...
    static let whisperMediumEnglish = BackendOption(
        backend: "whisper",
        model: "medium.en",
        label: String(localized: "backend_option.whisper_medium_english.title", defaultValue: "Whisper Medium English", bundle: .module, comment: "Title for Whisper Medium English backend option"),
        sizeLabel: String(localized: "backend_option.whisper_medium_english.size", defaultValue: "~1.5 GB", bundle: .module, comment: "Approximate download size label for Whisper Medium English backend option"),
    ...
    static let nemotron35Multilingual = BackendOption(
        ...
        label: String(localized: "backend_option.nemotron35_multilingual.title", defaultValue: "Nemotron 3.5 Multilingual", bundle: .module, comment: "Title for Nemotron 3.5 multilingual backend option"),
        sizeLabel: String(localized: "backend_option.nemotron35_multilingual.size", defaultValue: "~665 MB", bundle: .module, comment: "Approximate download size label for Nemotron 3.5 multilingual backend option"),
    ...
    static let cohereTranscribe = BackendOption(
        ...
        label: String(localized: "backend_option.cohere_transcribe.title", defaultValue: "Cohere Transcribe", bundle: .module, comment: "Title for Cohere Transcribe backend option"),
        sizeLabel: String(localized: "backend_option.cohere_transcribe.size", defaultValue: "~3.8 GB", bundle: .module, comment: "Approximate download size label for Cohere Transcribe backend option"),
    ...
    static let indicASR = BackendOption(
        ...
        label: String(localized: "backend_option.indic_asr.title", defaultValue: "Indic ASR", bundle: .module, comment: "Title for Indic ASR backend option"),
        sizeLabel: String(localized: "backend_option.indic_asr.size", defaultValue: "~618 MB", bundle: .module, comment: "Approximate download size label for Indic ASR backend option"),
    ...
    static let senseVoiceSmall = BackendOption(
        ...
        label: String(localized: "backend_option.sensevoice_small.title", defaultValue: "SenseVoice Small", bundle: .module, comment: "Title for SenseVoice Small backend option"),
    ...
    static let gemma4E2BLiteRT = BackendOption(
        ...
        label: String(localized: "backend_option.gemma4_e2b.title", defaultValue: "Gemma 4 E2B", bundle: .module, comment: "Title for Gemma 4 E2B backend option"),
        sizeLabel: String(localized: "backend_option.gemma4_e2b.size", defaultValue: "~2.6 GB", bundle: .module, comment: "Approximate download size label for Gemma 4 E2B backend option"),
    ...
    static let appleSpeechAnalyzer = BackendOption(
        ...
        label: String(localized: "backend_option.apple_speech.title", defaultValue: "Apple Speech", bundle: .module, comment: "Title for Apple Speech backend option"),
        sizeLabel: String(localized: "backend_option.apple_speech.size", defaultValue: "System managed", bundle: .module, comment: "Size/status label indicating Apple Speech is managed by the system"),
    ...
    static let qwen3Asr = BackendOption(
        ...
        label: String(localized: "backend_option.qwen3_asr.title", defaultValue: "Qwen3 ASR", bundle: .module, comment: "Title for Qwen3 ASR backend option"),
        sizeLabel: String(localized: "backend_option.qwen3_asr.size", defaultValue: "~1.3 GB", bundle: .module, comment: "Approximate download size label for Qwen3 ASR backend option"),
...
enum Nemotron35Language: String, CaseIterable, Codable, Sendable {
    ...
    var label: String {
        switch self {
        case .auto: return String(localized: "language.label.auto_detect", defaultValue: "Auto-detect", bundle: .module, comment: "Language label for automatic language detection")
        case .english: return String(localized: "language.label.english", defaultValue: "English", bundle: .module, comment: "Language label for English")
        case .hindi: return String(localized: "language.label.hindi", defaultValue: "Hindi", bundle: .module, comment: "Language label for Hindi")
        case .spanish: return String(localized: "language.label.spanish", defaultValue: "Spanish", bundle: .module, comment: "Language label for Spanish")
        case .french: return String(localized: "language.label.french", defaultValue: "French", bundle: .module, comment: "Language label for French")
        case .german: return String(localized: "language.label.german", defaultValue: "German", bundle: .module, comment: "Language label for German")
        case .italian: return String(localized: "language.label.italian", defaultValue: "Italian", bundle: .module, comment: "Language label for Italian")
        case .portuguese: return String(localized: "language.label.portuguese", defaultValue: "Portuguese", bundle: .module, comment: "Language label for Portuguese")
        case .chinese: return String(localized: "language.label.chinese", defaultValue: "Chinese", bundle: .module, comment: "Language label for Chinese")
        case .japanese: return String(localized: "language.label.japanese", defaultValue: "Japanese", bundle: .module, comment: "Language label for Japanese")
        case .korean: return String(localized: "language.label.korean", defaultValue: "Korean", bundle: .module, comment: "Language label for Korean")
        case .russian: return String(localized: "language.label.russian", defaultValue: "Russian", bundle: .module, comment: "Language label for Russian")
        case .arabic: return String(localized: "language.label.arabic", defaultValue: "Arabic", bundle: .module, comment: "Language label for Arabic")
        }
    }
...
enum MeetingLiveCaptionBackend: String, CaseIterable, Codable, Sendable {
    ...
    var settingsLabel: String {
        switch self {
        case .parakeetRealtimeEOU: return String(format: String(localized: "settings.label.live_preview_only", defaultValue: "%@ (live preview only)", bundle: .module, comment: "Label suffix indicating live preview only mode"), "\(label)")
        case .nemotron35: return String(format: String(localized: "settings.label.live_and_final", defaultValue: "%@ (live + final)", bundle: .module, comment: "Label suffix indicating live plus final mode"), "\(label)")
        }
    }
...
struct SummaryModelPreset {
    ...
    static func menuPresets(_ presets: [SummaryModelPreset], currentModel: String) -> [SummaryModelPreset] {
        ...
        return presets + [SummaryModelPreset(id: trimmedModel, label: String(format: String(localized: "summary_model.custom", defaultValue: "Custom: %@", bundle: .module, comment: "Summary model label showing custom model name"), "\(trimmedModel)"))]
    }
...
extension OpenRouterModel {
    ...
    var summaryPresetLabel: String {
        if let contextLength, contextLength > 0 {
            return String(format: String(localized: "summary.preset.label_with_context", defaultValue: "%@ (%@ ctx)", bundle: .module, comment: "Summary preset label with context length suffix"), "\(name)", "\(Self.formatContextLength(contextLength))")
        }
        return name
    }
...
struct MeetingSummaryBackendOption: Equatable {
    ...
    static let customLLM = MeetingSummaryBackendOption(
        backend: "custom_llm",
        label: String(localized: "meeting_summary.backend.custom_llm", defaultValue: "Custom LLM", bundle: .module, comment: "Meeting summary backend label for custom LLM")
    )
...
struct PostProcessorOption: Identifiable, Equatable {
    ...
    static let finetunedV2 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v2.title", defaultValue: "Muesli Cleanup (Legacy)", bundle: .module, comment: "Title for legacy Muesli cleanup postprocessor"),
        sizeLabel: String(localized: "postprocessor.finetuned_v2.size", defaultValue: "~390 MB", bundle: .module, comment: "Approximate download size label for legacy Muesli cleanup postprocessor"),
        description: String(localized: "postprocessor.finetuned_v2.description", defaultValue: "An earlier cleanup model for Muesli dictation. It handles filler words, corrections, and spoken lists, but is less consistent than the current model.", bundle: .module, comment: "Description for legacy Muesli cleanup postprocessor"),
    ...
    static let qwen35_0_8b = PostProcessorOption(
        id: "qwen35-0.8b",
        label: String(localized: "postprocessor.qwen35_0_8b.title", defaultValue: "Qwen Basic Cleanup", bundle: .module, comment: "Title for Qwen Basic Cleanup postprocessor"),
        sizeLabel: String(localized: "postprocessor.qwen35_0_8b.size", defaultValue: "~533 MB", bundle: .module, comment: "Approximate download size label for Qwen Basic Cleanup postprocessor"),
        description: String(localized: "postprocessor.qwen35_0_8b.description", defaultValue: "A general-purpose option for typos and filler words. It may miss “scratch that” edits and spoken list formatting.", bundle: .module, comment: "Description for Qwen Basic Cleanup postprocessor"),
    ...
    static let finetunedV3 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v3.title", defaultValue: "Muesli Cleanup", bundle: .module, comment: "Title for Muesli Cleanup postprocessor"),
        sizeLabel: String(localized: "postprocessor.finetuned_v3.size", defaultValue: "~505 MB", bundle: .module, comment: "Approximate download size for Muesli Cleanup postprocessor"),
        description: String(localized: "postprocessor.finetuned_v3.description", defaultValue: "The best overall choice for everyday dictation. It removes filler words, follows “scratch that,” and turns spoken list cues into clean formatting.", bundle: .module, comment: "Description for Muesli Cleanup postprocessor"),
...
struct HotkeyConfig: Codable, Equatable {
    ...
    static let computerUseDefault = HotkeyConfig(keyCode: 54, label: String(localized: "hotkey.default.computer_use.right_cmd", defaultValue: "Right Cmd", bundle: .module, comment: "Default computer-use hotkey label for right Command key"))
