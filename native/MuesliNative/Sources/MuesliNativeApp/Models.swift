...
struct BackendOption: Equatable {
    ...
    static let parakeetMultilingual = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v3.title", defaultValue: "Parakeet v3", comment: "Backend option title for Parakeet v3 model."),
        sizeLabel: String(localized: "backend_option.parakeet_v3.size", defaultValue: "~450 MB", comment: "Backend option size label for Parakeet v3 model."),
        description: String(localized: "backend_option.parakeet_v3.description", defaultValue: "The best default for everyday dictation: quick enough to feel responsive, reliable in normal rooms, and able to follow 25 languages.", comment: "Backend option description for Parakeet v3 model."),
        recommended: true
    )
    ...
    static let parakeetEnglish = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v2.title", defaultValue: "Parakeet v2", comment: "Backend option title for Parakeet v2 model."),
        sizeLabel: String(localized: "backend_option.parakeet_v2.size", defaultValue: "~450 MB", comment: "Backend option size label for Parakeet v2 model."),
        description: String(localized: "backend_option.parakeet_v2.description", defaultValue: "A quick, dependable English-only option. Choose it if you mainly dictate in English and prefer the older Parakeet model.", comment: "Backend option description for Parakeet v2 model."),
        recommended: false
    )
    ...
    static let whisperSmall = BackendOption(
        backend: "whisper",
        model: "small",
        label: String(localized: "backend_option.whisper_small.title", defaultValue: "Whisper Small Multilingual", comment: "Backend option title for Whisper Small multilingual model."),
        sizeLabel: String(localized: "backend_option.whisper_small.size", defaultValue: "~250 MB", comment: "Backend option size label for Whisper Small multilingual model."),
        description: String(localized: "backend_option.whisper_small.description", defaultValue: "A balanced multilingual Whisper option for everyday notes. It handles accents and background noise better than Tiny while keeping the download modest. Auto-detect language by default, or choose one yourself.", comment: "Backend option description for Whisper Small multilingual model."),
        recommended: false
    )
    ...
    static let whisperTiny = BackendOption(
        backend: "whisper",
        model: "tiny",
        label: String(localized: "backend_option.whisper_tiny.title", defaultValue: "Whisper Tiny Multilingual", comment: "Backend option title for Whisper Tiny multilingual model."),
        sizeLabel: String(localized: "backend_option.whisper_tiny.size", defaultValue: "~153 MB", comment: "Backend option size label for Whisper Tiny multilingual model."),
        description: String(localized: "backend_option.whisper_tiny.description", defaultValue: "The quickest Whisper download and lightest multilingual option for occasional notes. It gives up some accuracy on accents, noise, and longer speech. Auto-detect language by default, or choose one yourself.", comment: "Backend option description for Whisper Tiny multilingual model."),
        recommended: false
    )
    ...
    static let whisperLargeTurbo = BackendOption(
        ...
        label: String(localized: "backend_option.whisper_large_turbo.title", defaultValue: "Whisper Large Turbo Multilingual", comment: "Backend option title for Whisper Large Turbo multilingual model."),
        sizeLabel: String(localized: "backend_option.whisper_large_turbo.size", defaultValue: "~626 MB", comment: "Backend option size label for Whisper Large Turbo multilingual model."),
        description: String(localized: "backend_option.whisper_large_turbo.description", defaultValue: "Whisper's strongest multilingual option. Better for mixed languages and difficult audio, with a larger download and more processing time than Small. Auto-detect language by default, or pin a language.", comment: "Backend option description for Whisper Large Turbo multilingual model."),
        recommended: false
    )
    ...
    static let whisperTinyEnglish = BackendOption(
        backend: "whisper",
        model: "tiny.en",
        label: String(localized: "backend_option.whisper_tiny_english.title", defaultValue: "Whisper Tiny English", comment: "Backend option title for Whisper Tiny English model."),
        sizeLabel: String(localized: "backend_option.whisper_tiny_english.size", defaultValue: "~153 MB", comment: "Backend option size label for Whisper Tiny English model."),
        description: String(localized: "backend_option.whisper_tiny_english.description", defaultValue: "The quickest English-only Whisper option for lightweight notes. Choose it when you always speak English and do not need automatic language detection.", comment: "Backend option description for Whisper Tiny English model."),
        recommended: false
    )
    ...
    static let whisperSmallEnglish = BackendOption(
        backend: "whisper",
        model: "small.en",
        label: String(localized: "backend_option.whisper_small_english.title", defaultValue: "Whisper Small English", comment: "Backend option title for Whisper Small English model."),
        sizeLabel: String(localized: "backend_option.whisper_small_english.size", defaultValue: "~250 MB", comment: "Backend option size label for Whisper Small English model."),
        description: String(localized: "backend_option.whisper_small_english.description", defaultValue: "A balanced English-only Whisper option for everyday dictation. It handles accents and background noise better than Tiny when you do not need other languages.", comment: "Backend option description for Whisper Small English model."),
        recommended: false
    )
    ...
    static let whisperMediumEnglish = BackendOption(
        backend: "whisper",
        model: "medium.en",
        label: String(localized: "backend_option.whisper_medium_english.title", defaultValue: "Whisper Medium English", comment: "Backend option title for Whisper Medium English model."),
        sizeLabel: String(localized: "backend_option.whisper_medium_english.size", defaultValue: "~1.5 GB", comment: "Backend option size label for Whisper Medium English model."),
        description: String(localized: "backend_option.whisper_medium_english.description", defaultValue: "A larger English-only Whisper option for difficult accents and noisier recordings. It favors accuracy over download size and speed.", comment: "Backend option description for Whisper Medium English model."),
        recommended: false
    )
    ...
    static let nemotron35Multilingual = BackendOption(
        ...
        label: String(localized: "backend_option.nemotron35_multilingual.title", defaultValue: "Nemotron 3.5 Multilingual", comment: "Backend option title for Nemotron 3.5 multilingual model."),
        sizeLabel: String(localized: "backend_option.nemotron35_multilingual.size", defaultValue: "~665 MB", comment: "Backend option size label for Nemotron 3.5 multilingual model."),
        description: String(localized: "backend_option.nemotron35_multilingual.description", defaultValue: "Live text appears as you speak in more than 100 locales, including Hindi, Chinese, and Japanese, with language auto-detection and punctuation. It works for hold-to-talk, hands-free dictation, and meetings, but it only appends words—it does not go back to correct earlier text.", comment: "Backend option description for Nemotron 3.5 multilingual model."),
        recommended: false
    )
    ...
    static let cohereTranscribe = BackendOption(
        ...
        label: String(localized: "backend_option.cohere_transcribe.title", defaultValue: "Cohere Transcribe", comment: "Backend option title for Cohere Transcribe model."),
        sizeLabel: String(localized: "backend_option.cohere_transcribe.size", defaultValue: "~3.8 GB", comment: "Backend option size label for Cohere Transcribe model."),
        description: String(localized: "backend_option.cohere_transcribe.description", defaultValue: "The most deliberate option for difficult accents and tricky audio. It supports 14 languages and can be more accurate than faster models, but the download is large and you only see the result after you stop speaking.", comment: "Backend option description for Cohere Transcribe model."),
        recommended: false
    )
    ...
    static let indicASR = BackendOption(
        ...
        label: String(localized: "backend_option.indic_asr.title", defaultValue: "Indic ASR", comment: "Backend option title for Indic ASR model."),
        sizeLabel: String(localized: "backend_option.indic_asr.size", defaultValue: "~618 MB", comment: "Backend option size label for Indic ASR model."),
        description: String(localized: "backend_option.indic_asr.description", defaultValue: "Built specifically for seven Indian languages. Choose your language before recording; it can help where general multilingual models struggle, but results still vary enough to keep it experimental.", comment: "Backend option description for Indic ASR model."),
        recommended: false
    )
    ...
    static let gemma4E2BLiteRT = BackendOption(
        ...
        label: String(localized: "backend_option.gemma4_e2b.title", defaultValue: "Gemma 4 E2B", comment: "Backend option title for Gemma 4 E2B model."),
        sizeLabel: String(localized: "backend_option.gemma4_e2b.size", defaultValue: "~2.6 GB", comment: "Backend option size label for Gemma 4 E2B model."),
        description: String(localized: "backend_option.gemma4_e2b.description", defaultValue: "A research preview, not a dependable dictation model yet. It is large, slow to get ready, requires macOS 15 or later, and may produce an answer instead of a faithful transcript.", comment: "Backend option description for Gemma 4 E2B model."),
        recommended: false
    )
    ...
    static let appleSpeechAnalyzer = BackendOption(
        ...
        label: String(localized: "backend_option.apple_speech.title", defaultValue: "Apple Speech", comment: "Backend option title for Apple Speech recognition."),
        sizeLabel: String(localized: "backend_option.apple_speech.size", defaultValue: "System managed", comment: "Backend option size/status label for Apple Speech model managed by system."),
        description: String(localized: "backend_option.apple_speech.description", defaultValue: "Apple's private, on-device speech model for macOS 26. It is designed for dictation, meetings, distant speakers, and long recordings, while macOS manages the language assets and updates.", comment: "Backend option description for Apple Speech model."),
        recommended: false
    )
    ...
    static let qwen3Asr = BackendOption(
        ...
        label: String(localized: "backend_option.qwen3_asr.title", defaultValue: "Qwen3 ASR", comment: "Backend option title for Qwen3 ASR model."),
        sizeLabel: String(localized: "backend_option.qwen3_asr.size", defaultValue: "~1.3 GB", comment: "Backend option size label for Qwen3 ASR model."),
        description: String(localized: "backend_option.qwen3_asr.description", defaultValue: "Strong multilingual transcription across 52 languages when accuracy matters more than instant results. Expect a short 2–3 second wait compared with Parakeet, and about 30 seconds of one-time preparation the first time it runs.", comment: "Backend option description for Qwen3 ASR model."),
        recommended: false
    )
...
enum Nemotron35Language: String, CaseIterable, Codable, Sendable {
    ...
    var label: String {
        switch self {
        case .auto: return String(localized: "language.label.auto_detect", defaultValue: "Auto-detect", comment: "Language label for automatic language detection.")
        case .english: return String(localized: "language.label.english", defaultValue: "English", comment: "Language label for English.")
        case .hindi: return String(localized: "language.label.hindi", defaultValue: "Hindi", comment: "Language label for Hindi.")
        case .spanish: return String(localized: "language.label.spanish", defaultValue: "Spanish", comment: "Language label for Spanish.")
        case .french: return String(localized: "language.label.french", defaultValue: "French", comment: "Language label for French.")
        case .german: return String(localized: "language.label.german", defaultValue: "German", comment: "Language label for German.")
        case .italian: return String(localized: "language.label.italian", defaultValue: "Italian", comment: "Language label for Italian.")
        case .portuguese: return String(localized: "language.label.portuguese", defaultValue: "Portuguese", comment: "Language label for Portuguese.")
        case .chinese: return String(localized: "language.label.chinese", defaultValue: "Chinese", comment: "Language label for Chinese.")
        case .japanese: return String(localized: "language.label.japanese", defaultValue: "Japanese", comment: "Language label for Japanese.")
        case .korean: return String(localized: "language.label.korean", defaultValue: "Korean", comment: "Language label for Korean.")
        case .russian: return String(localized: "language.label.russian", defaultValue: "Russian", comment: "Language label for Russian.")
        case .arabic: return String(localized: "language.label.arabic", defaultValue: "Arabic", comment: "Language label for Arabic.")
        }
    }
...
enum MeetingLiveCaptionBackend: String, CaseIterable, Codable, Sendable {
    ...
    var settingsLabel: String {
        switch self {
        case .parakeetRealtimeEOU: return String(format: String(localized: "settings.label.live_preview_only", defaultValue: "%@ (live preview only)", comment: "Settings label suffix indicating mode provides live preview only."), "\(label)")
        case .nemotron35: return String(format: String(localized: "settings.label.live_and_final", defaultValue: "%@ (live + final)", comment: "Settings label suffix indicating mode provides live and final output."), "\(label)")
        }
    }
...
struct SummaryModelPreset {
    ...
    static func menuPresets(_ presets: [SummaryModelPreset], currentModel: String) -> [SummaryModelPreset] {
        ...
        return presets + [SummaryModelPreset(id: trimmedModel, label: String(format: String(localized: "summary_model.custom", defaultValue: "Custom: %@", comment: "Summary model label for a custom model identifier."), "\(trimmedModel)"))]
    }
...
extension OpenRouterModel {
    ...
    var summaryPresetLabel: String {
        if let contextLength, contextLength > 0 {
            return String(format: String(localized: "summary.preset.label_with_context", defaultValue: "%@ (%@ ctx)", comment: "Summary preset label including preset name and context length."), "\(name)", "\(Self.formatContextLength(contextLength))")
        }
        return name
    }
...
struct MeetingSummaryBackendOption: Equatable {
    ...
    static let customLLM = MeetingSummaryBackendOption(
        backend: "custom_llm",
        label: String(localized: "meeting_summary.backend.custom_llm", defaultValue: "Custom LLM", comment: "Meeting summary backend label for custom LLM provider.")
    )
...
struct PostProcessorOption: Identifiable, Equatable {
    ...
    static let finetunedV2 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v2.title", defaultValue: "Muesli Cleanup (Legacy)", comment: "Postprocessor option title for legacy Muesli cleanup model."),
        sizeLabel: String(localized: "postprocessor.finetuned_v2.size", defaultValue: "~390 MB", comment: "Postprocessor option size label for legacy Muesli cleanup model."),
        description: String(localized: "postprocessor.finetuned_v2.description", defaultValue: "An earlier cleanup model for Muesli dictation. It handles filler words, corrections, and spoken lists, but is less consistent than the current model.", comment: "Postprocessor option description for legacy Muesli cleanup model."),
    ...
    static let qwen35_0_8b = PostProcessorOption(
        id: "qwen35-0.8b",
        label: String(localized: "postprocessor.qwen35_0_8b.title", defaultValue: "Qwen Basic Cleanup", comment: "Postprocessor option title for Qwen basic cleanup model."),
        sizeLabel: String(localized: "postprocessor.qwen35_0_8b.size", defaultValue: "~533 MB", comment: "Postprocessor option size label for Qwen basic cleanup model."),
        description: String(localized: "postprocessor.qwen35_0_8b.description", defaultValue: "A general-purpose option for typos and filler words. It may miss “scratch that” edits and spoken list formatting.", comment: "Postprocessor option description for Qwen basic cleanup model."),
    ...
    static let finetunedV3 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v3.title", defaultValue: "Muesli Cleanup", comment: "Postprocessor option title for current Muesli cleanup model."),
        sizeLabel: String(localized: "postprocessor.finetuned_v3.size", defaultValue: "~505 MB", comment: "Postprocessor option size label for current Muesli cleanup model."),
        description: String(localized: "postprocessor.finetuned_v3.description", defaultValue: "The best overall choice for everyday dictation. It removes filler words, follows “scratch that,” and turns spoken list cues into clean formatting.", comment: "Postprocessor option description for current Muesli cleanup model."),
...
enum TranscriptCleanupPrompts {
    ...
    static let builtIns: [TranscriptCleanupPromptPreset] = [
        TranscriptCleanupPromptPreset(
            id: defaultID,
            name: String(localized: "transcript_cleanup_preset.default_cleanup.title", defaultValue: "Default Cleanup", comment: "Transcript cleanup preset title for default cleanup behavior."),
...
enum IndicatorAnchor: String, Codable, CaseIterable {
    ...
    var label: String {
        switch self {
        case .topLeading: return String(localized: "position.label.top_left", defaultValue: "Top Left", comment: "Position label for top-left placement.")
        case .topCenter: return String(localized: "position.label.top_center", defaultValue: "Top Center", comment: "Position label for top-center placement.")
        case .topTrailing: return String(localized: "position.label.top_right", defaultValue: "Top Right", comment: "Position label for top-right placement.")
        case .midLeading: return String(localized: "position.label.middle_left", defaultValue: "Middle Left", comment: "Position label for middle-left placement.")
        case .midTrailing: return String(localized: "position.label.middle_right", defaultValue: "Middle Right", comment: "Position label for middle-right placement.")
        case .bottomLeading: return String(localized: "position.label.bottom_left", defaultValue: "Bottom Left", comment: "Position label for bottom-left placement.")
        case .bottomCenter: return String(localized: "position.label.bottom_center", defaultValue: "Bottom Center", comment: "Position label for bottom-center placement.")
        case .bottomTrailing: return String(localized: "position.label.bottom_right", defaultValue: "Bottom Right", comment: "Position label for bottom-right placement.")
        case .custom: return String(localized: "position.label.custom", defaultValue: "Custom", comment: "Position label for custom placement.")
        }
    }
}
...
struct HotkeyConfig: Codable, Equatable {
    ...
    var label: String = String(localized: "modifier_key.label.right_option", defaultValue: "Right Option", comment: "Modifier key label for right Option key.")
    ...
    static func label(for keyCode: UInt16) -> String? {
        switch keyCode {
        case 55: return String(localized: "modifier_key.label.left_cmd", defaultValue: "Left Cmd", comment: "Modifier key label for left Command key.")
        case 54: return String(localized: "modifier_key.label.right_cmd", defaultValue: "Right Cmd", comment: "Modifier key label for right Command key.")
        case 63: return String(localized: "modifier_key.label.fn", defaultValue: "Fn", comment: "Modifier key label for Fn key.")
        case 59: return String(localized: "modifier_key.label.left_ctrl", defaultValue: "Left Ctrl", comment: "Modifier key label for left Control key.")
        case 62: return String(localized: "modifier_key.label.right_ctrl", defaultValue: "Right Ctrl", comment: "Modifier key label for right Control key.")
        case 58: return String(localized: "modifier_key.label.left_option", defaultValue: "Left Option", comment: "Modifier key label for left Option key.")
        case 61: return String(localized: "modifier_key.label.right_option", defaultValue: "Right Option", comment: "Modifier key label for right Option key.")
        case 56: return String(localized: "modifier_key.label.left_shift", defaultValue: "Left Shift", comment: "Modifier key label for left Shift key.")
        case 60: return String(localized: "modifier_key.label.right_shift", defaultValue: "Right Shift", comment: "Modifier key label for right Shift key.")
        default: return nil
        }
    }
    ...
    static func symbolLabel(for keyCode: UInt16) -> String? {
        switch keyCode {
        case 55: return String(localized: "modifier_key.symbol.left_cmd", defaultValue: "Left ⌘", comment: "Modifier key symbol label for left Command key.")
        case 54: return String(localized: "modifier_key.symbol.right_cmd", defaultValue: "Right ⌘", comment: "Modifier key symbol label for right Command key.")
        case 63: return String(localized: "modifier_key.symbol.fn", defaultValue: "fn", comment: "Modifier key symbol label for Fn key.")
        case 59: return String(localized: "modifier_key.symbol.left_ctrl", defaultValue: "Left ⌃", comment: "Modifier key symbol label for left Control key.")
        case 62: return String(localized: "modifier_key.symbol.right_ctrl", defaultValue: "Right ⌃", comment: "Modifier key symbol label for right Control key.")
        case 58: return String(localized: "modifier_key.symbol.left_option", defaultValue: "Left ⌥", comment: "Modifier key symbol label for left Option key.")
        case 61: return String(localized: "modifier_key.symbol.right_option", defaultValue: "Right ⌥", comment: "Modifier key symbol label for right Option key.")
        case 56: return String(localized: "modifier_key.symbol.left_shift", defaultValue: "Left ⇧", comment: "Modifier key symbol label for left Shift key.")
        case 60: return String(localized: "modifier_key.symbol.right_shift", defaultValue: "Right ⇧", comment: "Modifier key symbol label for right Shift key.")
        default: return nil
        }
    }
    ...
    static let computerUseDefault = HotkeyConfig(keyCode: 54, label: String(localized: "hotkey.default.computer_use.right_cmd", defaultValue: "Right Cmd", comment: "Default hotkey label for computer use using right Command key."))
