...
struct BackendOption: Equatable {
    ...
    static let parakeetMultilingual = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v3.title", defaultValue: "Parakeet v3", bundle: .module, comment: "Backend option title for Parakeet v3 model."),
        sizeLabel: String(localized: "backend_option.parakeet_v3.size", defaultValue: "~450 MB", bundle: .module, comment: "Displayed model download size for Parakeet v3 option."),
        description: String(localized: "backend_option.parakeet_v3.description", defaultValue: "The best default for everyday dictation: quick enough to feel responsive, reliable in normal rooms, and able to follow 25 languages.", bundle: .module, comment: "Description text for Parakeet v3 backend option."),
        recommended: true
    )
    ...
    static let parakeetEnglish = BackendOption(
        ...
        label: String(localized: "backend_option.parakeet_v2.title", defaultValue: "Parakeet v2", bundle: .module, comment: "Backend option title for Parakeet v2 model."),
        sizeLabel: String(localized: "backend_option.parakeet_v2.size", defaultValue: "~450 MB", bundle: .module, comment: "Displayed model download size for Parakeet v2 option."),
        description: String(localized: "backend_option.parakeet_v2.description", defaultValue: "A quick, dependable English-only option. Choose it if you mainly dictate in English and prefer the older Parakeet model.", bundle: .module, comment: "Description text for Parakeet v2 backend option."),
        recommended: false
    )
    ...
    static let whisperSmall = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.whisper_small.size", defaultValue: "~250 MB", bundle: .module, comment: "Displayed model download size for Whisper Small multilingual option."),
        description: String(localized: "backend_option.whisper_small.description", defaultValue: "A balanced multilingual Whisper option for everyday notes. It handles accents and background noise better than Tiny while keeping the download modest. Auto-detect language by default, or choose one yourself.", bundle: .module, comment: "Description text for Whisper Small multilingual backend option."),
        recommended: false
    )
    ...
    static let whisperTiny = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.whisper_tiny.size", defaultValue: "~153 MB", bundle: .module, comment: "Displayed model download size for Whisper Tiny multilingual option."),
        description: String(localized: "backend_option.whisper_tiny.description", defaultValue: "The quickest Whisper download and lightest multilingual option for occasional notes. It gives up some accuracy on accents, noise, and longer speech. Auto-detect language by default, or choose one yourself.", bundle: .module, comment: "Description text for Whisper Tiny multilingual backend option."),
        recommended: false
    )
    ...
    static let whisperLargeTurbo = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.whisper_large_turbo.size", defaultValue: "~626 MB", bundle: .module, comment: "Displayed model download size for Whisper Large Turbo multilingual option."),
        description: String(localized: "backend_option.whisper_large_turbo.description", defaultValue: "Whisper's strongest multilingual option. Better for mixed languages and difficult audio, with a larger download and more processing time than Small. Auto-detect language by default, or pin a language.", bundle: .module, comment: "Description text for Whisper Large Turbo multilingual backend option."),
        recommended: false
    )
    ...
    static let whisperTinyEnglish = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.whisper_tiny_english.size", defaultValue: "~153 MB", bundle: .module, comment: "Displayed model download size for Whisper Tiny English option."),
        description: String(localized: "backend_option.whisper_tiny_english.description", defaultValue: "The quickest English-only Whisper option for lightweight notes. Choose it when you always speak English and do not need automatic language detection.", bundle: .module, comment: "Description text for Whisper Tiny English backend option."),
        recommended: false
    )
    ...
    static let whisperSmallEnglish = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.whisper_small_english.size", defaultValue: "~250 MB", bundle: .module, comment: "Displayed model download size for Whisper Small English option."),
        description: String(localized: "backend_option.whisper_small_english.description", defaultValue: "A balanced English-only Whisper option for everyday dictation. It handles accents and background noise better than Tiny when you do not need other languages.", bundle: .module, comment: "Description text for Whisper Small English backend option."),
        recommended: false
    )
    ...
    static let whisperMediumEnglish = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.whisper_medium_english.size", defaultValue: "~1.5 GB", bundle: .module, comment: "Displayed model download size for Whisper Medium English option."),
        description: String(localized: "backend_option.whisper_medium_english.description", defaultValue: "A larger English-only Whisper option for difficult accents and noisier recordings. It favors accuracy over download size and speed.", bundle: .module, comment: "Description text for Whisper Medium English backend option."),
        recommended: false
    )
    ...
    static let cohereTranscribe = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.cohere_transcribe.size", defaultValue: "~3.8 GB", bundle: .module, comment: "Displayed model download size for Cohere Transcribe option."),
        description: String(localized: "backend_option.cohere_transcribe.description", defaultValue: "The most deliberate option for difficult accents and tricky audio. It supports 14 languages and can be more accurate than faster models, but the download is large and you only see the result after you stop speaking.", bundle: .module, comment: "Description text for Cohere Transcribe backend option."),
        recommended: false
    )
    ...
    static let indicASR = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.indic_asr.size", defaultValue: "~618 MB", bundle: .module, comment: "Displayed model download size for Indic ASR option."),
        description: String(localized: "backend_option.indic_asr.description", defaultValue: "Built specifically for seven Indian languages. Choose your language before recording; it can help where general multilingual models struggle, but results still vary enough to keep it experimental.", bundle: .module, comment: "Description text for Indic ASR backend option."),
        recommended: false
    )
    ...
    static let gemma4E2BLiteRT = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.gemma4_e2b.size", defaultValue: "~2.6 GB", bundle: .module, comment: "Displayed model download size for Gemma 4 E2B option."),
        description: String(localized: "backend_option.gemma4_e2b.description", defaultValue: "A research preview, not a dependable dictation model yet. It is large, slow to get ready, requires macOS 15 or later, and may produce an answer instead of a faithful transcript.", bundle: .module, comment: "Description text for Gemma 4 E2B backend option."),
        recommended: false
    )
    ...
    static let appleSpeechAnalyzer = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.apple_speech.size", defaultValue: "System managed", bundle: .module, comment: "Displayed size text for system-managed Apple Speech backend."),
        description: String(localized: "backend_option.apple_speech.description", defaultValue: "Apple's private, on-device speech model for macOS 26. It is designed for dictation, meetings, distant speakers, and long recordings, while macOS manages the language assets and updates.", bundle: .module, comment: "Description text for Apple Speech backend option."),
        recommended: false
    )
    ...
    static let qwen3Asr = BackendOption(
        ...
        sizeLabel: String(localized: "backend_option.qwen3_asr.size", defaultValue: "~1.3 GB", bundle: .module, comment: "Displayed model download size for Qwen3 ASR option."),
        description: String(localized: "backend_option.qwen3_asr.description", defaultValue: "Strong multilingual transcription across 52 languages when accuracy matters more than instant results. Expect a short 2–3 second wait compared with Parakeet, and about 30 seconds of one-time preparation the first time it runs.", bundle: .module, comment: "Description text for Qwen3 ASR backend option."),
        recommended: false
    )
...
enum Nemotron35Language: String, CaseIterable, Codable, Sendable {
    ...
    var label: String {
        switch self {
        case .auto: return String(localized: "language.label.auto_detect", defaultValue: "Auto-detect", bundle: .module, comment: "Language label for automatic language detection option.")
        case .english: return String(localized: "language.label.english", defaultValue: "English", bundle: .module, comment: "Language label for English option.")
        case .hindi: return String(localized: "language.label.hindi", defaultValue: "Hindi", bundle: .module, comment: "Language label for Hindi option.")
        case .spanish: return String(localized: "language.label.spanish", defaultValue: "Spanish", bundle: .module, comment: "Language label for Spanish option.")
        case .french: return String(localized: "language.label.french", defaultValue: "French", bundle: .module, comment: "Language label for French option.")
        case .german: return String(localized: "language.label.german", defaultValue: "German", bundle: .module, comment: "Language label for German option.")
        case .italian: return String(localized: "language.label.italian", defaultValue: "Italian", bundle: .module, comment: "Language label for Italian option.")
        case .portuguese: return String(localized: "language.label.portuguese", defaultValue: "Portuguese", bundle: .module, comment: "Language label for Portuguese option.")
        case .chinese: return String(localized: "language.label.chinese", defaultValue: "Chinese", bundle: .module, comment: "Language label for Chinese option.")
        case .japanese: return String(localized: "language.label.japanese", defaultValue: "Japanese", bundle: .module, comment: "Language label for Japanese option.")
        case .korean: return String(localized: "language.label.korean", defaultValue: "Korean", bundle: .module, comment: "Language label for Korean option.")
        case .russian: return String(localized: "language.label.russian", defaultValue: "Russian", bundle: .module, comment: "Language label for Russian option.")
        case .arabic: return String(localized: "language.label.arabic", defaultValue: "Arabic", bundle: .module, comment: "Language label for Arabic option.")
        }
    }
...
enum MeetingLiveCaptionBackend: String, CaseIterable, Codable, Sendable {
    ...
    var settingsLabel: String {
        switch self {
        case .parakeetRealtimeEOU: return String(format: String(localized: "settings.label.live_preview_only", defaultValue: "%@ (live preview only)", bundle: .module, comment: "Settings label indicating live preview only mode."), "\(label)")
        case .nemotron35: return String(format: String(localized: "settings.label.live_and_final", defaultValue: "%@ (live + final)", bundle: .module, comment: "Settings label indicating live and final mode."), "\(label)")
        }
    }
...
struct SummaryModelPreset {
    ...
    static func menuPresets(_ presets: [SummaryModelPreset], currentModel: String) -> [SummaryModelPreset] {
        ...
        return presets + [SummaryModelPreset(id: trimmedModel, label: String(format: String(localized: "summary_model.custom", defaultValue: "Custom: %@", bundle: .module, comment: "Summary model label for custom model name."), "\(trimmedModel)"))]
    }
...
extension OpenRouterModel {
    ...
    var summaryPresetLabel: String {
        if let contextLength, contextLength > 0 {
            return String(format: String(localized: "summary.preset.label_with_context", defaultValue: "%@ (%@ ctx)", bundle: .module, comment: "Summary preset label with formatted context length."), "\(name)", "\(Self.formatContextLength(contextLength))")
        }
        return name
    }
...
struct MeetingSummaryBackendOption: Equatable {
    ...
    static let customLLM = MeetingSummaryBackendOption(
        backend: "custom_llm",
        label: String(localized: "meeting_summary.backend.custom_llm", defaultValue: "Custom LLM", bundle: .module, comment: "Meeting summary backend label for custom LLM option.")
    )
...
struct PostProcessorOption: Identifiable, Equatable {
    ...
    static let finetunedV2 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v2.title", defaultValue: "Muesli Cleanup (Legacy)", bundle: .module, comment: "Postprocessor option title for legacy Muesli cleanup model."),
        sizeLabel: String(localized: "postprocessor.finetuned_v2.size", defaultValue: "~390 MB", bundle: .module, comment: "Displayed model download size for legacy Muesli cleanup postprocessor."),
        description: String(localized: "postprocessor.finetuned_v2.description", defaultValue: "An earlier cleanup model for Muesli dictation. It handles filler words, corrections, and spoken lists, but is less consistent than the current model.", bundle: .module, comment: "Postprocessor option description for legacy Muesli cleanup model."),
    ...
    static let qwen35_0_8b = PostProcessorOption(
        id: "qwen35-0.8b",
        label: String(localized: "postprocessor.qwen35_0_8b.title", defaultValue: "Qwen Basic Cleanup", bundle: .module, comment: "Postprocessor option title for Qwen Basic Cleanup model."),
        sizeLabel: String(localized: "postprocessor.qwen35_0_8b.size", defaultValue: "~533 MB", bundle: .module, comment: "Displayed model download size for Qwen Basic Cleanup postprocessor."),
        description: String(localized: "postprocessor.qwen35_0_8b.description", defaultValue: "A general-purpose option for typos and filler words. It may miss “scratch that” edits and spoken list formatting.", bundle: .module, comment: "Postprocessor option description for Qwen Basic Cleanup model."),
    ...
    static let finetunedV3 = PostProcessorOption(
        ...
        label: String(localized: "postprocessor.finetuned_v3.title", defaultValue: "Muesli Cleanup", bundle: .module, comment: "Postprocessor option title for current Muesli cleanup model."),
        sizeLabel: String(localized: "postprocessor.finetuned_v3.size", defaultValue: "~505 MB", bundle: .module, comment: "Displayed model download size for current Muesli cleanup postprocessor."),
        description: String(localized: "postprocessor.finetuned_v3.description", defaultValue: "The best overall choice for everyday dictation. It removes filler words, follows “scratch that,” and turns spoken list cues into clean formatting.", bundle: .module, comment: "Postprocessor option description for current Muesli cleanup model."),
...
enum TranscriptCleanupPrompts {
    ...
    static let builtIns: [TranscriptCleanupPromptPreset] = [
        TranscriptCleanupPromptPreset(
            id: defaultID,
            name: String(localized: "transcript_cleanup_preset.default_cleanup.title", defaultValue: "Default Cleanup", bundle: .module, comment: "Transcript cleanup preset title for default cleanup option."),
...
enum IndicatorAnchor: String, Codable, CaseIterable {
    ...
    var label: String {
        switch self {
        case .topLeading: return String(localized: "position.label.top_left", defaultValue: "Top Left", bundle: .module, comment: "Position label for top-left placement option.")
        case .topCenter: return String(localized: "position.label.top_center", defaultValue: "Top Center", bundle: .module, comment: "Position label for top-center placement option.")
        case .topTrailing: return String(localized: "position.label.top_right", defaultValue: "Top Right", bundle: .module, comment: "Position label for top-right placement option.")
        case .midLeading: return String(localized: "position.label.middle_left", defaultValue: "Middle Left", bundle: .module, comment: "Position label for middle-left placement option.")
        case .midTrailing: return String(localized: "position.label.middle_right", defaultValue: "Middle Right", bundle: .module, comment: "Position label for middle-right placement option.")
        case .bottomLeading: return String(localized: "position.label.bottom_left", defaultValue: "Bottom Left", bundle: .module, comment: "Position label for bottom-left placement option.")
        case .bottomCenter: return String(localized: "position.label.bottom_center", defaultValue: "Bottom Center", bundle: .module, comment: "Position label for bottom-center placement option.")
        case .bottomTrailing: return String(localized: "position.label.bottom_right", defaultValue: "Bottom Right", bundle: .module, comment: "Position label for bottom-right placement option.")
        case .custom: return String(localized: "position.label.custom", defaultValue: "Custom", bundle: .module, comment: "Position label for custom placement option.")
        }
    }
}
...
struct HotkeyConfig: Codable, Equatable {
    ...
    var label: String = String(localized: "modifier_key.label.right_option", defaultValue: "Right Option", bundle: .module, comment: "Modifier key label for right Option key.")
    ...
    static func label(for keyCode: UInt16) -> String? {
        switch keyCode {
        case 55: return String(localized: "modifier_key.label.left_cmd", defaultValue: "Left Cmd", bundle: .module, comment: "Modifier key label for left Command key.")
        case 54: return String(localized: "modifier_key.label.right_cmd", defaultValue: "Right Cmd", bundle: .module, comment: "Modifier key label for right Command key.")
        case 63: return String(localized: "modifier_key.label.fn", defaultValue: "Fn", bundle: .module, comment: "Modifier key label for function key.")
        case 59: return String(localized: "modifier_key.label.left_ctrl", defaultValue: "Left Ctrl", bundle: .module, comment: "Modifier key label for left Control key.")
        case 62: return String(localized: "modifier_key.label.right_ctrl", defaultValue: "Right Ctrl", bundle: .module, comment: "Modifier key label for right Control key.")
        case 58: return String(localized: "modifier_key.label.left_option", defaultValue: "Left Option", bundle: .module, comment: "Modifier key label for left Option key.")
        case 61: return String(localized: "modifier_key.label.right_option", defaultValue: "Right Option", bundle: .module, comment: "Modifier key label for right Option key.")
        case 56: return String(localized: "modifier_key.label.left_shift", defaultValue: "Left Shift", bundle: .module, comment: "Modifier key label for left Shift key.")
        case 60: return String(localized: "modifier_key.label.right_shift", defaultValue: "Right Shift", bundle: .module, comment: "Modifier key label for right Shift key.")
        default: return nil
        }
    }
