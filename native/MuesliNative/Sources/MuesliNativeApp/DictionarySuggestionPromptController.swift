...
final class DictionarySuggestionPromptController: NSObject {
    ...
    func show(
        ...
        dismissButton.toolTip = String(localized: "dictionary_suggestion_prompt.dismiss", defaultValue: "Dismiss", bundle: .module, comment: "Button label to dismiss the dictionary suggestion prompt.")
...
private final class DictionarySuggestionPromptView: NSView {
    ...
    private func setup() {
        ...
        let title = label(String(localized: "dictionary_suggestion_prompt.add_correction_prompt", defaultValue: "Add correction?", bundle: .module, comment: "Prompt asking whether to add a suggested dictionary correction."), font: .systemFont(ofSize: 13, weight: .semibold), color: .white)
        ...
        let add = button(title: String(localized: "dictionary_suggestion_prompt.action.add", defaultValue: "Add", bundle: .module, comment: "Action button label to add a suggested dictionary correction."), action: #selector(addTapped), isPrimary: true)
        add.frame = NSRect(x: addX, y: buttonY, width: buttonWidth, height: buttonHeight)
        cardView.addSubview(add)

        let ignore = button(title: String(localized: "dictionary_suggestion_prompt.action.ignore", defaultValue: "Ignore", bundle: .module, comment: "Action button label to ignore a suggested dictionary correction."), action: #selector(ignoreTapped), isPrimary: false)
