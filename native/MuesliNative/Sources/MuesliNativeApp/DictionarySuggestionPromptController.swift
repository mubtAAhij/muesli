...
final class DictionarySuggestionPromptController: NSObject {
    ...
    func show(
        ...
        dismissButton.toolTip = String(localized: "dictionary_suggestion_prompt.dismiss", defaultValue: "Dismiss", bundle: .module, comment: "Button title to close dictionary suggestion prompt.")
...
private final class DictionarySuggestionPromptView: NSView {
    ...
    private func setup() {
        ...
        let title = label(String(localized: "dictionary_suggestion_prompt.add_correction_prompt", defaultValue: "Add correction?", bundle: .module, comment: "Prompt title asking whether to add a dictionary correction."), font: .systemFont(ofSize: 13, weight: .semibold), color: .white)
        ...
        let add = button(title: String(localized: "dictionary_suggestion_prompt.action.add", defaultValue: "Add", bundle: .module, comment: "Confirmation button title to add a dictionary correction."), action: #selector(addTapped), isPrimary: true)
        add.frame = NSRect(x: addX, y: buttonY, width: buttonWidth, height: buttonHeight)
        cardView.addSubview(add)

        let ignore = button(title: String(localized: "dictionary_suggestion_prompt.action.ignore", defaultValue: "Ignore", bundle: .module, comment: "Button title to ignore a dictionary correction suggestion."), action: #selector(ignoreTapped), isPrimary: false)
