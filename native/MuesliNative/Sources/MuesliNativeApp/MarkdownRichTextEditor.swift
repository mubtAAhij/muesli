...
struct MarkdownRichTextEditor: NSViewRepresentable {
    ...
    var placeholder: String = String(localized: "markdown.editor.placeholder.write_notes_here", defaultValue: "Write notes here...", bundle: .module, comment: "Placeholder shown in the markdown editor when empty.")
