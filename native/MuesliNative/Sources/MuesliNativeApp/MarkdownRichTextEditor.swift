...
struct MarkdownRichTextEditor: NSViewRepresentable {
    ...
    var placeholder: String = String(localized: "markdown.editor.placeholder.write_notes_here", defaultValue: "Write notes here...", comment: "Placeholder text for markdown notes editor")
