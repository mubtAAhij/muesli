...
struct ShortcutsView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: MuesliTheme.spacing24) {
                Text(String(localized: "shortcuts.title", defaultValue: "Shortcuts", bundle: .module, comment: "Title for shortcuts settings view."))
                    .font(MuesliTheme.title1())
                    .foregroundStyle(MuesliTheme.textPrimary)

                Text(String(localized: "shortcuts.subtitle", defaultValue: "Choose your preferred shortcuts for dictation and computer use commands.", bundle: .module, comment: "Subtitle describing purpose of shortcuts settings."))
        ...
        VStack(alignment: .leading, spacing: MuesliTheme.spacing16) {
            HStack(alignment: .top) {
                VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                    Text(String(localized: "shortcuts.dictation.push_to_talk.title", defaultValue: "Push to Talk", bundle: .module, comment: "Title for push-to-talk dictation shortcut."))
                        .font(MuesliTheme.headline())
                        .foregroundStyle(MuesliTheme.textPrimary)
                    Text(String(localized: "shortcuts.dictation.push_to_talk.description", defaultValue: "Hold to record, release to transcribe", bundle: .module, comment: "Description for push-to-talk dictation shortcut behavior."))
    ...
    private var computerUseShortcutSection: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing16) {
            HStack(alignment: .top) {
                VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                    Text(String(localized: "shortcuts.computer_use_command.title", defaultValue: "Computer Use Command", bundle: .module, comment: "Title for computer use command shortcut."))
                        .font(MuesliTheme.headline())
                        .foregroundStyle(MuesliTheme.textPrimary)
    ...
    private var meetingRecordingShortcutSection: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing16) {
            HStack(alignment: .top) {
                VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                    Text(String(localized: "shortcuts.meeting_recording.title", defaultValue: "Meeting Recording", bundle: .module, comment: "Title for meeting recording shortcut."))
                        .font(MuesliTheme.headline())
                        .foregroundStyle(MuesliTheme.textPrimary)
    ...
    private func thresholdInput(value: Int, onChange: @escaping (Int) -> Void) -> some View {
        ...
        .help(String(format: String(localized: "shortcuts.threshold.range", defaultValue: "Hold threshold: %d-%d ms", bundle: .module, comment: "Displayed range for hold threshold milliseconds."), HotkeyTriggerTiming.minThresholdMilliseconds, HotkeyTriggerTiming.maxThresholdMilliseconds))
    }
    ...
    private func changeButton(for target: ShortcutTarget) -> some View {
        Button {
            ...
            Text(recordingTarget == target ? recordingPrompt(for: target) : String(localized: "shortcuts.change_shortcut", defaultValue: "Change Shortcut", bundle: .module, comment: "Button title to change assigned shortcut."))
                .font(MuesliTheme.body())
    ...
    private func recordingPrompt(for target: ShortcutTarget) -> String {
        switch target {
        case .meetingRecording:
            return String(localized: "shortcuts.recording_prompt.key_or_modifier", defaultValue: "Press a key or modifier...", bundle: .module, comment: "Prompt shown while recording any shortcut key.")
        case .dictation, .computerUse:
            return String(localized: "shortcuts.recording_prompt.modifier_only", defaultValue: "Press a modifier key...", bundle: .module, comment: "Prompt shown while recording modifier-only shortcut.")
        }
    }
    ...
    private var doubleTapSection: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing16) {
            HStack(alignment: .top) {
                VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                    Text(String(localized: "shortcuts.hands_free_mode.title", defaultValue: "Hands-Free Mode", bundle: .module, comment: "Title for hands-free shortcut mode option."))
                        .font(MuesliTheme.headline())
                        .foregroundStyle(MuesliTheme.textPrimary)
                    Text(String(localized: "shortcuts.hands_free_mode.description", defaultValue: "Double-tap dictation or CUA to start, tap again to stop", bundle: .module, comment: "Description for hands-free mode behavior."))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textSecondary)
                }
                Spacer()
    ...
    private var resetButton: some View {
        Button {
            ...
            Text(String(localized: "shortcuts.reset_to_defaults", defaultValue: "Reset to Defaults", bundle: .module, comment: "Action title to reset shortcuts to default values."))
                .font(MuesliTheme.body())
                .foregroundStyle(MuesliTheme.textSecondary)
        }
        .buttonStyle(.plain)
