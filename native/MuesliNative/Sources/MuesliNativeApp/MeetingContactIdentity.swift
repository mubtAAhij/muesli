...
enum MeetingContactIdentity {
    static let unnamedFallback = String(localized: "meeting_contact_identity.unnamed_fallback", defaultValue: "Unnamed contact", bundle: .module, comment: "Fallback contact name when no name is available.")
