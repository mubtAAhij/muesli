...
enum MeetingContactIdentity {
    static let unnamedFallback = String(localized: "meeting_contact_identity.unnamed_fallback", defaultValue: "Unnamed contact", comment: "Fallback contact name when no identity is available")
