...
enum UpcomingMeetingsWindow: Int, CaseIterable, Identifiable {
    ...
    var label: String {
        switch self {
        case .today:
            return String(localized: "upcoming_meetings_window.range_label.today_only", defaultValue: "Today only", comment: "Range option label for showing only today's meetings")
        case .twoDays:
            return String(localized: "upcoming_meetings_window.range_label.two_days", defaultValue: "Two days", comment: "Range option label for showing two days of meetings")
        case .threeDays:
            return String(localized: "upcoming_meetings_window.range_label.three_days", defaultValue: "Three days", comment: "Range option label for showing three days of meetings")
        }
    }
