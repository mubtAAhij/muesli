...
struct ModelsView: View {
    ...
    var body: some View {
        ...
        .alert(
            String(format: String(localized: "models.alert.delete_transcription_model_title", defaultValue: "Delete \"%@\"?", bundle: .module, comment: "Alert title asking confirmation to delete selected transcription model"), "\(modelToDelete?.label ?? "")"),
            isPresented: Binding(
                get: { modelToDelete != nil },
                set: { if !$0 { modelToDelete = nil } }
            )
        ) {
            Button(String(localized: "models.alert.cancel.delete_transcription_model", defaultValue: "Cancel", bundle: .module, comment: "Cancel action title for transcription model deletion alert"), role: .cancel) {
                modelToDelete = nil
            }
            Button(String(localized: "models.alert.delete_action.transcription_model", defaultValue: "Delete", bundle: .module, comment: "Delete action title for transcription model deletion alert"), role: .destructive) {
                guard let option = modelToDelete else { return }
                deleteModel(option)
                modelToDelete = nil
            }
        } message: {
            Text(String(localized: "models.alert.delete_model_message.transcription", defaultValue: "The downloaded model files will be removed from this Mac. You can download the model again later.", bundle: .module, comment: "Warning message for deleting downloaded transcription model files"))
        }
        .alert(
            String(format: String(localized: "models.alert.delete_cleanup_model_title", defaultValue: "Delete \"%@\"?", bundle: .module, comment: "Alert title asking confirmation to delete selected cleanup model"), "\(postProcModelToDelete?.label ?? "")"),
            isPresented: Binding(
                get: { postProcModelToDelete != nil },
                set: { if !$0 { postProcModelToDelete = nil } }
            )
        ) {
            Button(String(localized: "models.alert.cancel.delete_cleanup_model", defaultValue: "Cancel", bundle: .module, comment: "Cancel action title for cleanup model deletion alert"), role: .cancel) {
                postProcModelToDelete = nil
            }
            Button(String(localized: "models.alert.delete_action.cleanup_model", defaultValue: "Delete", bundle: .module, comment: "Delete action title for cleanup model deletion alert"), role: .destructive) {
                guard let option = postProcModelToDelete else { return }
                deletePostProcModel(option)
                postProcModelToDelete = nil
            }
        } message: {
            Text(String(localized: "models.alert.delete_model_message.cleanup", defaultValue: "The downloaded model files will be removed from this Mac. You can download the model again later.", bundle: .module, comment: "Warning message for deleting downloaded cleanup model files"))
        }
        .alert(
            String(format: String(localized: "models.alert.delete_live_meeting_model_title", defaultValue: "Delete \"%@\"?", bundle: .module, comment: "Alert title asking confirmation to delete live meeting model"), "\(MeetingLiveCaptionModelStore.label)"),
            isPresented: $showDeleteLiveCaptionModelConfirmation
        ) {
            Button(String(localized: "models.alert.cancel.delete_live_meeting_model", defaultValue: "Cancel", bundle: .module, comment: "Cancel action title for live meeting model deletion alert"), role: .cancel) {}
            Button(String(localized: "models.alert.delete_action.live_meeting_model", defaultValue: "Delete", bundle: .module, comment: "Delete action title for live meeting model deletion alert"), role: .destructive) {
                deleteLiveCaptionModel()
            }
        } message: {
            Text(String(localized: "models.live_meetings.fallback_warning", defaultValue: "Live meetings will fall back to standard chunk-by-chunk captions until this model is downloaded again.", bundle: .module, comment: "Warning message shown after deleting live meetings model"))
        }
    }
        ...
        case .dictation:
            ForEach(BackendOption.systemManaged, id: \.model) { option in
                ...
                modelCard(
                    ...
                    downloadedLabel: String(localized: "models.status.available", defaultValue: "Available", bundle: .module, comment: "Status text indicating model is available")
                )
            ...
            familyCard(
                ...
                subtitle: String(localized: "models.family.parakeet.description", defaultValue: "The most responsive choices for everyday dictation, with multilingual and English-only options.", bundle: .module, comment: "Description for Parakeet model family section"),
                defaultBadge: String(localized: "models.family.default_v3", defaultValue: "Default: v3", bundle: .module, comment: "Default variant label for Parakeet family"),
                logo: "nvidia-logo",
            ...
            familyCard(
                ...
                defaultBadge: String(localized: "models.family.default_small", defaultValue: "Default: Small", bundle: .module, comment: "Default variant label for Whisper family"),
                logo: "openai-logo",
    ...
    private var comingSoonSection: some View {
        if !BackendOption.comingSoon.isEmpty {
            VStack(alignment: .leading, spacing: MuesliTheme.spacing8) {
                Text(String(localized: "models.coming_soon.section_title", defaultValue: "COMING SOON", bundle: .module, comment: "Section title for upcoming model options"))
    ...
    private var streamingSection: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
            VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                Text(String(localized: "models.live_meetings.section_title", defaultValue: "LIVE MEETINGS", bundle: .module, comment: "Section title for live meetings model options"))
                    .font(.system(size: 11, weight: .semibold))
                    .foregroundStyle(MuesliTheme.textTertiary)

                Text(String(localized: "models.streaming.description", defaultValue: "Choose how words appear while a meeting is in progress. Nemotron also creates the saved transcript; Parakeet prioritizes a faster English preview.", bundle: .module, comment: "Description of streaming behavior choices during live meetings"))
        ...
        return VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
            HStack(alignment: .top, spacing: MuesliTheme.spacing12) {
                ...
                VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                    ...
                    Text(String(localized: "models.live_caption.description", defaultValue: "Fast English captions while a meeting is in progress. They are a provisional preview; your regular meeting model creates the transcript you keep.", bundle: .module, comment: "Description for live caption model behavior during meetings"))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textSecondary)
                }
                ...
                if isActive {
                    Text(String(localized: "models.status.active", defaultValue: "Active", bundle: .module, comment: "Status badge label when model is active"))
                        .font(.system(size: 11, weight: .semibold))
                    ...
                    Text(String(localized: "models.status.ready", defaultValue: "Ready", bundle: .module, comment: "Status badge label when model is ready"))
            ...
            HStack(spacing: MuesliTheme.spacing8) {
                if isDownloadingLiveCaptionModel {
                    Button(isCancellingLiveCaptionModelDownload ? String(localized: "models.actions.pausing", defaultValue: "Pausing…", bundle: .module, comment: "Button/state label while pausing model activity") : String(localized: "models.actions.cancel.pausing", defaultValue: "Cancel", bundle: .module, comment: "Cancel action title while pausing model activity")) {
                        ...
                        if let snapshot = downloadSnapshots[MeetingLiveCaptionModelStore.modelID] {
                            downloadSnapshots[MeetingLiveCaptionModelStore.modelID] = snapshot.replacing(
                                phase: .paused,
                                message: String(localized: "models.live_caption.paused_resume_hint", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Hint shown when live caption model is paused and can be resumed")
                            )
                        }
                    }
                    ...
                    if !isActive {
                        Button(String(localized: "models.actions.set_active", defaultValue: "Set Active", bundle: .module, comment: "Action title to set selected model as active")) {
                            controller.updateConfig {
                    ...
                    Button(String(localized: "models.actions.download", defaultValue: "Download", bundle: .module, comment: "Action title to download selected model")) {
        ...
        VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
            Button {
                ...
                HStack(alignment: .firstTextBaseline, spacing: MuesliTheme.spacing12) {
                    ...
                    Text(String(localized: "models.experimental.badge_early_access", defaultValue: "Early access", bundle: .module, comment: "Badge label indicating an early-access model"))
                    ...
                    ForEach(BackendOption.experimental, id: \.model) { option in
                        if !appState.selectedPostProcessorBackend.isCompatible(with: option) {
                            modelCard(
                                option: option,
                                logo: logoForBackend(option),
                                downloadedLabel: String(localized: "models.experimental.used_for_cleanup", defaultValue: "Used for Cleanup", bundle: .module, comment: "Status label indicating model is currently used for cleanup"),
                                activationDisabledReason: String(localized: "models.experimental.unavailable_due_to_cleanup_selection", defaultValue: "Unavailable while Gemma 4 is selected for cleanup. Choose another cleanup backend first.", bundle: .module, comment: "Availability warning when experimental model conflicts with selected cleanup backend")
                            )
                        } else {
    ...
    private var gemmaCleanupModelCard: some View {
        ...
        return modelCard(
            ...
            activeLabel: String(localized: "models.cleanup.status.active", defaultValue: "Cleanup Active", bundle: .module, comment: "Status badge text when cleanup backend is active"),
            downloadedLabel: isCompatible ? String(localized: "models.status.downloaded", defaultValue: "Downloaded", bundle: .module, comment: "Status badge text when model is downloaded") : String(localized: "models.cleanup.used_for_dictation", defaultValue: "Used for Dictation", bundle: .module, comment: "Status badge text when model is currently used for dictation"),
            actionTitle: String(localized: "models.cleanup.action_use_for_cleanup", defaultValue: "Use for Cleanup", bundle: .module, comment: "Action title to use selected model for cleanup"),
            activationDisabledReason: isCompatible
                ? nil
                : String(localized: "models.cleanup.unavailable_due_to_dictation_selection", defaultValue: "Unavailable while Gemma 4 is selected for dictation. Choose another dictation model first.", bundle: .module, comment: "Availability warning when Gemma is selected for dictation")
        )
    }
    ...
    private func postProcModelCard(_ option: PostProcessorOption) -> some View {
        ...
        return VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
            HStack(alignment: .top, spacing: MuesliTheme.spacing12) {
                ...
                if isActive {
                    Text(String(localized: "models.status.active.general", defaultValue: "Active", bundle: .module, comment: "General status badge text when model is active"))
                        .font(.system(size: 11, weight: .semibold))
                        .foregroundStyle(MuesliTheme.success)
                        .padding(.horizontal, 8)
                        .padding(.vertical, 3)
                    ...
                    Text(String(localized: "models.status.downloaded.general", defaultValue: "Downloaded", bundle: .module, comment: "General status badge text when model is downloaded"))
                        .font(.system(size: 11, weight: .medium))
                        .foregroundStyle(MuesliTheme.textTertiary)
                        .padding(.horizontal, 8)
                        .padding(.vertical, 3)
            ...
            HStack(spacing: MuesliTheme.spacing8) {
                if isDownloading {
                    Button(String(localized: "models.actions.pause", defaultValue: "Pause", bundle: .module, comment: "Action title to pause model download or activity")) {
                    ...
                    if !isActive {
                        Button(String(localized: "models.actions.set_active.general", defaultValue: "Set Active", bundle: .module, comment: "General action title to set selected model active")) {
                    ...
                    Button(String(localized: "models.actions.download.general", defaultValue: "Download", bundle: .module, comment: "General action title to download selected model")) {
    ...
    private func familyCard(
        ...
        return VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
            ...
            HStack(alignment: .center, spacing: MuesliTheme.spacing12) {
                Text(String(localized: "models.family.variant_label", defaultValue: "Variant", bundle: .module, comment: "Label for model variant value in model details"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textTertiary)
            ...
            if selectedOption.supportsWhisperLanguageSelection {
                HStack(alignment: .center, spacing: MuesliTheme.spacing12) {
                    Text(String(localized: "models.family.language_label", defaultValue: "Language", bundle: .module, comment: "Label for model language value in model details"))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textTertiary)
    ...
    private func familyStatusBadge(isActive: Bool, isDownloaded: Bool) -> some View {
        if isActive {
            Text(String(localized: "models.status.active.variant", defaultValue: "Active", bundle: .module, comment: "Variant status badge text when selected variant is active"))
                .font(.system(size: 11, weight: .semibold))
                .foregroundStyle(MuesliTheme.success)
                .padding(.horizontal, 8)
                .padding(.vertical, 3)
            ...
            Text(String(localized: "models.status.downloaded.variant", defaultValue: "Downloaded", bundle: .module, comment: "Variant status badge text when selected variant is downloaded"))
                .font(.system(size: 11, weight: .medium))
                .foregroundStyle(MuesliTheme.textTertiary)
                .padding(.horizontal, 8)
                .padding(.vertical, 3)
        ...
        if let snapshot = downloadSnapshots[modelID] {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ProgressView(value: fallbackProgress)
                    .tint(MuesliTheme.accent)
                Text(fallbackMessage ?? String(format: String(localized: "models.download.progress.percent_downloading", defaultValue: "%d%% downloading...", bundle: .module, comment: "Fallback percentage progress text while downloading a model"), Int(fallbackProgress * 100)))
                    .font(.system(size: 11))
                    .foregroundStyle(MuesliTheme.textTertiary)
            }
        }
    ...
    private func downloadPhaseLabel(_ phase: ModelDownloadPhase) -> String {
        ...
        case .failed: return String(localized: "models.download.phase.failed", defaultValue: "Failed", bundle: .module, comment: "Download phase label when model download has failed")
        }
    }
    ...
    private func downloadDetailText(_ snapshot: ModelDownloadProgress) -> String? {
        ...
        if snapshot.totalFileCount > 0 {
            ...
            if remaining > 0 {
                details.append(String(format: String(localized: "models.download.detail.files_remaining", defaultValue: "%d %@ left", bundle: .module, comment: "Download detail showing remaining file count with localized noun"), remaining, "\(downloadFileNoun(remaining))"))
            }
        }
        ...
        if snapshot.phase == .downloading {
            ...
            if snapshot.retryCount > 0 {
                details.append(String(format: String(localized: "models.download.detail.retry_count", defaultValue: "retry %d/3", bundle: .module, comment: "Download detail showing retry attempt count"), snapshot.retryCount))
            }
    ...
    private func actionButtons(
        ...
        isDownloaded: Bool,
        isDownloading: Bool,
        actionTitle: String = String(localized: "models.actions.set_active", defaultValue: "Set Active", bundle: .module, comment: "Action title to set selected model active"),
        activationDisabledReason: String? = nil,
        onSetActive: (() -> Void)? = nil
    ) -> some View {
        HStack(spacing: MuesliTheme.spacing8) {
            if isDownloading {
                Button(String(localized: "models.actions.pause.general", defaultValue: "Pause", bundle: .module, comment: "General action title to pause model activity")) {
                ...
                Button(String(localized: "models.actions.download.fallback", defaultValue: "Download", bundle: .module, comment: "Fallback action title to download model")) {
    ...
    private func modelCard(
        ...
        activeLabel: String = String(localized: "models.status.active", defaultValue: "Active", bundle: .module, comment: "Status badge text when model is active"),
        downloadedLabel: String = String(localized: "models.status.downloaded", defaultValue: "Downloaded", bundle: .module, comment: "Status badge text when model is downloaded"),
        actionTitle: String = String(localized: "models.actions.set_active", defaultValue: "Set Active", bundle: .module, comment: "Action title to set selected model active"),
        activationDisabledReason: String? = nil
    ) -> some View {
        ...
        return VStack(alignment: .leading, spacing: MuesliTheme.spacing12) {
                ...
                VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                    HStack(spacing: MuesliTheme.spacing8) {
                        ...
                        if option.recommended {
                            Text(String(localized: "models.badge.recommended", defaultValue: "Recommended", bundle: .module, comment: "Badge label marking recommended model option"))
                                .font(.system(size: 10, weight: .semibold))
            ...
            if option.supportsWhisperLanguageSelection {
                HStack(alignment: .center, spacing: MuesliTheme.spacing12) {
                    Text(String(localized: "models.language_label.inline", defaultValue: "Language", bundle: .module, comment: "Inline language label for model row metadata"))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textTertiary)
                        .frame(width: 64, alignment: .leading)
            ...
            if option.backend == BackendOption.nemotron35Multilingual.backend {
                HStack(alignment: .center, spacing: MuesliTheme.spacing12) {
                    Text(String(localized: "models.language_label", defaultValue: "Language", bundle: .module, comment: "Language label for model detail metadata"))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textTertiary)
                        .frame(width: 64, alignment: .leading)
                ...
                if isDownloaded && nemotron35UpdateAvailable && !isDownloading {
                    HStack(spacing: MuesliTheme.spacing8) {
                        Image(systemName: "arrow.triangle.2.circlepath")
                            .font(.system(size: 11))
                            .foregroundStyle(MuesliTheme.accent)
                        Text(String(localized: "models.update_available.message", defaultValue: "A newer model build is available.", bundle: .module, comment: "Message shown when an updated model build can be downloaded"))
                            .font(MuesliTheme.caption())
                            .foregroundStyle(MuesliTheme.textSecondary)
                        Button(String(localized: "common.actions.update", defaultValue: "Update", bundle: .module, comment: "Common action title to update an item")) { updateNemotron35(option) }
                            .buttonStyle(.plain)
                            .font(.system(size: 12, weight: .medium))
                            .foregroundStyle(MuesliTheme.accent)
                    }
            ...
            HStack(alignment: .top) {
                VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                    HStack(spacing: MuesliTheme.spacing8) {
                        ...
                        Text(String(localized: "models.coming_soon.card_title", defaultValue: "Coming soon", bundle: .module, comment: "Card title for upcoming model option"))
                            .font(.system(size: 10, weight: .semibold))
                            .foregroundStyle(MuesliTheme.textTertiary)
                            .padding(.horizontal, 6)
                            .padding(.vertical, 2)
                ...
                await MainActor.run {
                    ...
                    withAnimation {
                        ...
                        downloadMessages[option.id] = isCancelled
                            ? String(localized: "models.download.paused_resume_hint.inline", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Inline hint shown when a model download is paused")
    ...
    private func validateGGUFHeader(at url: URL) throws {
        ...
        guard header == Data([0x47, 0x47, 0x55, 0x46]) else {
            throw NSError(domain: "PostProcDownload", code: 1, userInfo: [
                NSLocalizedDescriptionKey: String(localized: "models.errors.invalid_gguf_model", defaultValue: "Downloaded post-processor file is not a GGUF model", bundle: .module, comment: "Error text when downloaded post-processor file is not valid GGUF model"),
            ])
        }
    }
    ...
    private func cancelPostProcDownload(_ option: PostProcessorOption) {
        ...
        Task {
            ...
            await MainActor.run {
                ...
                if option.isDownloaded {
                    ...
                    downloadMessages[option.id] = String(localized: "models.download.paused_resume_hint.primary", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Primary paused hint shown for download resume guidance")
                }
                downloadGenerations.removeValue(forKey: option.id)
            }
        }
        withAnimation {
            ...
            if let snapshot = downloadSnapshots[option.id] {
                downloadSnapshots[option.id] = snapshot.replacing(phase: .paused, message: String(localized: "models.download.paused_resume_hint.secondary", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Secondary paused hint shown for download resume guidance"))
            }
            downloadTasksPostProc.removeValue(forKey: option.id)
        }
    }
            ...
            do {
                ...
                guard !Task.isCancelled else {
                    await MainActor.run {
                        ...
                        withAnimation {
                            ...
                            downloadMessages[option.model] = String(localized: "models.download.paused_resume_hint.tertiary", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Tertiary paused hint shown for download resume guidance")
                            if let snapshot = downloadSnapshots[option.model] {
                                downloadSnapshots[option.model] = snapshot.replacing(
                                    phase: .paused,
                                    message: String(localized: "models.download.paused_resume_hint.quaternary", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Quaternary paused hint shown for download resume guidance")
                                )
                            }
                ...
                guard isModelDownloaded(option, fm: FileManager.default) else {
                    throw NSError(
                        ...
                        code: 1,
                        userInfo: [NSLocalizedDescriptionKey: String(format: String(localized: "models.errors.download_failed_with_label", defaultValue: "%@ was not downloaded successfully.", bundle: .module, comment: "Error text when specific model option failed to download"), "\(option.label)")]
                    )
                }
                guard !Task.isCancelled else {
                    await MainActor.run {
                        ...
                        withAnimation {
                            downloadingModels.remove(option.model)
                            downloadProgress.removeValue(forKey: option.model)
                            downloadMessages[option.model] = String(localized: "models.download.paused_resume_hint.quinary", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Quinary paused hint shown for download resume guidance")
                            if let snapshot = downloadSnapshots[option.model] {
                                downloadSnapshots[option.model] = snapshot.replacing(
                                    phase: .paused,
                                    message: String(localized: "models.download.paused_resume_hint.senary", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Senary paused hint shown for download resume guidance")
                                )
                            }
                            downloadGenerations.removeValue(forKey: option.model)
                            downloadTasks.removeValue(forKey: option.model)
                    ...
                    withAnimation {
                        ...
                        if isCancelled {
                            if let snapshot = downloadSnapshots[option.model] {
                                downloadSnapshots[option.model] = snapshot.replacing(
                                    phase: .paused,
                                    message: String(localized: "models.download.paused_resume_hint.septenary", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Septenary paused hint shown for download resume guidance")
                                )
                            }
                        } else {
    ...
    private func cancelDownload(_ option: BackendOption) {
        ...
        withAnimation {
            ...
            downloadMessages[modelID] = String(localized: "models.download.paused_resume_hint.octonary", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "Octonary paused hint shown for download resume guidance")
            ...
            if let snapshot = downloadSnapshots[modelID] {
                downloadSnapshots[modelID] = snapshot.replacing(
                    phase: .paused,
                    message: String(localized: "models.download.paused_resume_hint.general", defaultValue: "Paused — select Download to resume", bundle: .module, comment: "General paused hint shown for download resume guidance")
                )
            }
        }
        Task {
