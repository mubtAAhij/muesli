...
enum MeetingMicHealthState: String, Codable, Equatable {
    ...
    var userMessage: String? {
        ...
        case .healthy, .waitingForAudio:
            return nil
        case .micCallbacksMissing:
            return String(localized: "meeting_mic_health_tracker.user_message.audio_not_reaching", defaultValue: "Microphone audio is not reaching Muesli. This meeting transcript may miss your side.", bundle: .module, comment: "User warning when microphone input is not reaching the app.")
        case .micAllZeroWhileSystemActive:
            return String(localized: "meeting_mic_health_tracker.user_message.audio_silent", defaultValue: "Microphone audio is silent. This meeting transcript may miss your side.", bundle: .module, comment: "User warning when microphone input appears silent.")
        }
    }
}
