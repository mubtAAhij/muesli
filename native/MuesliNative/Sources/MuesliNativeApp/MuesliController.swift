...
public final class MuesliController: NSObject {
    ...
    func shouldTerminateApplication() -> Bool {
        ...
        alert.addButton(withTitle: String(
            localized: "muesli-controller.quit-confirmation.keep-running",
            defaultValue: "Keep Muesli Running",
            comment: ""
        ))
        alert.addButton(withTitle: String(
            localized: "muesli-controller.quit-confirmation.quit-anyway",
    ...
    @objc func discardMeetingWithConfirmation() {
        ...
        if hasManualNotes {
            ...
            alert.addButton(withTitle: String(
                localized: "muesli-controller.discard-recording.confirmation-title",
            ...
            alert.addButton(withTitle: String(
                localized: "muesli-controller.discard-recording.confirm-button",
    ...
    private static func makeDiscardMeetingAccessoryView() -> MeetingDiscardAccessory {
        let label = NSTextField(labelWithString: String(
            localized: "muesli-controller.discard-recording.will-delete-label",
            defaultValue: "Will delete:",
            comment: ""
        ))
        label.font = .systemFont(ofSize: NSFont.systemFontSize)
        label.textColor = .secondaryLabelColor

        let recordingCheckbox = NSButton(checkboxWithTitle: String(
            localized: "muesli-controller.discard-recording.item.recording-audio",
            defaultValue: "Recording audio",
            comment: ""
        ), target: nil, action: nil)
        recordingCheckbox.state = .on
        recordingCheckbox.isEnabled = false

        let notesCheckbox = NSButton(checkboxWithTitle: String(
            localized: "muesli-controller.discard-recording.item.manual-notes",
            defaultValue: "Manual notes",
            comment: ""
        ), target: nil, action: nil)
    ...
    private func promptToSaveMeetingRecording(for title: String) async -> Bool {
        ...
        alert.addButton(withTitle: String(
            localized: "muesli-controller.save-recording.confirmation-title",
            defaultValue: "Save Recording",
            comment: ""
        ))
        alert.addButton(withTitle: String(
            localized: "muesli-controller.save-recording.dont-save-button",
