...
struct OnboardingView: View {
    ...
    private var onboardingModelDescription: String {
        if BackendOption.onboardingDefault == .appleSpeechAnalyzer {
            return String(localized: "onboarding.model.description.apple_speech_or_local", defaultValue: "Use Apple Speech, or choose another local model to download while you continue setup.", bundle: .module, comment: "Onboarding description for Apple Speech or local model download option")
        }
        return String(localized: "onboarding.model.description.fast_local_model", defaultValue: "Start with a fast local model. Larger models can download while you continue setup.", bundle: .module, comment: "Onboarding description for starting with fast local model")
    }
        ...
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                HStack(spacing: MuesliTheme.spacing12) {
                    if canGoBack {
                        Button(String(localized: "onboarding.navigation.back", defaultValue: "Back", bundle: .module, comment: "Onboarding navigation button label to go back")) {
                            goToPreviousStep()
                        }
                        .buttonStyle(.plain)
    ...
    private var primaryButton: some View {
        switch currentStep {
        case 0:
            onboardingButton(String(localized: "onboarding.navigation.continue", defaultValue: "Continue", bundle: .module, comment: "Onboarding navigation button label to continue"), enabled: !userName.trimmingCharacters(in: .whitespaces).isEmpty) {
                goToNextStep()
            }
        case 1:
            onboardingButton(selectedBackend.isDownloaded ? String(localized: "onboarding.navigation.continue", defaultValue: "Continue", bundle: .module, comment: "Onboarding navigation button label to continue") : String(localized: "onboarding.navigation.download_and_continue", defaultValue: "Download & Continue", bundle: .module, comment: "Onboarding navigation button label to download model and continue"), enabled: true) {
                startDownload()
            }
        case 2:
            onboardingButton(String(localized: "onboarding.navigation.continue", defaultValue: "Continue", bundle: .module, comment: "Onboarding navigation button label to continue"), enabled: true) {
                goToNextStep()
            }
        case 3:
            onboardingButton(currentStepIndex == orderedSteps.count - 1 ? String(localized: "onboarding.navigation.finish", defaultValue: "Finish", bundle: .module, comment: "Onboarding navigation button label to finish setup") : String(localized: "onboarding.navigation.continue", defaultValue: "Continue", bundle: .module, comment: "Onboarding navigation button label to continue"), enabled: requiredPermissionsGranted) {
        ...
        case 4:
            if dictationTestResult != nil {
                onboardingButton(selectedUseCase.includesMeetings ? String(localized: "onboarding.navigation.continue", defaultValue: "Continue", bundle: .module, comment: "Onboarding navigation button label to continue") : String(localized: "onboarding.navigation.finish", defaultValue: "Finish", bundle: .module, comment: "Onboarding navigation button label to finish setup"), enabled: true) {
                ...
                HStack(spacing: MuesliTheme.spacing12) {
                    ...
                    onboardingButton(selectedUseCase.includesMeetings ? String(localized: "onboarding.navigation.continue", defaultValue: "Continue", bundle: .module, comment: "Onboarding navigation button label to continue") : String(localized: "onboarding.navigation.finish", defaultValue: "Finish", bundle: .module, comment: "Onboarding navigation button label to finish setup"), enabled: false) {
                        if selectedUseCase.includesMeetings {
                            goToNextStep()
                        } else {
                            finishOnboarding(withKey: false)
        ...
        case 6:
            HStack(spacing: MuesliTheme.spacing12) {
                ...
                onboardingButton(String(localized: "onboarding.navigation.finish", defaultValue: "Finish", bundle: .module, comment: "Onboarding navigation button label to finish setup"), enabled: true) {
    ...
    private func skipButton(action: @escaping () -> Void) -> some View {
        Button(String(localized: "onboarding.navigation.skip", defaultValue: "Skip", bundle: .module, comment: "Onboarding navigation button label to skip current step"), action: action)
            .buttonStyle(.plain)
            .font(MuesliTheme.body())
            .foregroundStyle(MuesliTheme.textSecondary)
            .padding(.horizontal, MuesliTheme.spacing16)
    ...
    private var modelDownloadIndicatorTitle: String {
        if let snapshot = modelDownloadSnapshot {
            ...
            case .downloading: return String(format: String(localized: "onboarding.model_download.downloading", defaultValue: "Downloading %@", bundle: .module, comment: "Onboarding model download status while downloading selected backend"), "\(selectedBackend.label)")
            case .preparing: return String(format: String(localized: "onboarding.model_download.preparing", defaultValue: "Preparing %@", bundle: .module, comment: "Onboarding model download status while preparing selected backend"), "\(selectedBackend.label)")
            case .ready: return String(format: String(localized: "onboarding.model_download.backend_ready", defaultValue: "%@ ready", bundle: .module, comment: "Onboarding model download status when selected backend is ready"), "\(selectedBackend.label)")
            case .paused: return String(localized: "onboarding.model_download.paused", defaultValue: "Download paused", bundle: .module, comment: "Onboarding model download status when download is paused")
            case .failed: return String(localized: "onboarding.model_download.failed", defaultValue: "Download failed", bundle: .module, comment: "Onboarding model download status when download fails")
            }
        }
        if modelDownloadError != nil {
            return String(localized: "onboarding.model_download.failed_secondary", defaultValue: "Download failed", bundle: .module, comment: "Secondary onboarding model download status when download fails")
        }
        if isShowingModelReadyIndicator {
            return String(format: String(localized: "onboarding.model_download.backend_ready", defaultValue: "%@ ready", bundle: .module, comment: "Onboarding model download status when selected backend is ready"), "\(selectedBackend.label)")
        }
        return String(format: String(localized: "onboarding.model_download.preparing_backend", defaultValue: "Preparing %@", bundle: .module, comment: "Onboarding model download status while preparing selected backend"), "\(selectedBackend.label)")
    }
    ...
    private func modelDownloadIndicatorDetail(progress: Double?) -> String {
        ...
        if isShowingModelReadyIndicator {
            return String(localized: "onboarding.model_download.ready_to_test", defaultValue: "Ready to test", bundle: .module, comment: "Onboarding model download status when model is ready for dictation test")
        }
        if let snapshot = modelDownloadSnapshot {
        ...
        if let progress {
            return String(format: String(localized: "onboarding.model_download.percent_complete", defaultValue: "%d%% complete", bundle: .module, comment: "Onboarding model download progress percentage"), Int((progress * 100).rounded()))
        }
        return String(localized: "onboarding.model_download.downloading_ellipsis", defaultValue: "Downloading...", bundle: .module, comment: "Onboarding model download status while downloading")
    }
    ...
    private func modelDownloadSnapshotDetail(_ snapshot: ModelDownloadProgress) -> String {
        ...
        if snapshot.totalFileCount > 0 {
            ...
            details.append(String(format: String(localized: "onboarding.model_download.files_completed", defaultValue: "%d of %d files", bundle: .module, comment: "Onboarding model download completed files progress"), completed, snapshot.totalFileCount))
            if remaining > 0 {
                details.append(String(format: String(localized: "onboarding.model_download.remaining_time", defaultValue: "%@ left", bundle: .module, comment: "Onboarding model download remaining time text"), "\(remaining)"))
            }
        }
        if let total = snapshot.totalBytes, total > 0 {
            ...
            if snapshot.completedBytes < total {
                details.append(String(format: String(localized: "onboarding.model_download.bytes_left_total", defaultValue: "%@ left", bundle: .module, comment: "Onboarding model download remaining total bytes text"), "\(ModelDownloadDisplayFormatting.bytes(total - snapshot.completedBytes))"))
            }
            ...
            if snapshot.currentFileCompletedBytes < currentTotal {
                details.append(String(format: String(localized: "onboarding.model_download.current_file_bytes_left", defaultValue: "%@ left", bundle: .module, comment: "Onboarding model download current file remaining bytes text"), "\(ModelDownloadDisplayFormatting.bytes(currentTotal - snapshot.currentFileCompletedBytes))"))
            }
        }
        if snapshot.phase == .downloading {
            ...
            if let eta = snapshot.estimatedSecondsRemaining,
               let formattedETA = ModelDownloadDisplayFormatting.eta(eta) {
                details.append(String(format: String(localized: "onboarding.model_download.eta_left", defaultValue: "%@ left", bundle: .module, comment: "Onboarding model download ETA remaining text"), "\(formattedETA)"))
            }
            if snapshot.retryCount > 0 {
                details.append(String(format: String(localized: "onboarding.model_download.retry_status", defaultValue: "retry %d/3", bundle: .module, comment: "Onboarding model download retry status text"), snapshot.retryCount))
            }
        } else if let message = snapshot.message, !message.isEmpty {
            details.append(message)
        }
        return details.isEmpty ? (snapshot.message ?? String(localized: "onboarding.model_download.downloading_ellipsis_secondary", defaultValue: "Downloading...", bundle: .module, comment: "Secondary onboarding model download status while downloading")) : details.joined(separator: " · ")
    }
    ...
    private var dictationTestSubtitle: AttributedString {
        ...
        if isSelectedModelReadyForDictationTest {
            markdown = selectedUseCase.includesVoiceNotes
                ? String(format: String(localized: "onboarding.dictation_test.subtitle_voice_note", defaultValue: "Hold **%@** to record a voice note, then release.\nYour words should appear below.", bundle: .module, comment: "Onboarding dictation test subtitle for voice note flow with selected hotkey"), "\(selectedHotkey.label)")
                : String(format: String(localized: "onboarding.dictation_test.subtitle_say_something", defaultValue: "Hold **%@** and say something, then release.\nYour words should appear below.", bundle: .module, comment: "Onboarding dictation test subtitle for speak flow with selected hotkey"), "\(selectedHotkey.label)")
        } else {
    ...
    private var dictationTestPreparationSubtitleMarkdown: String {
        ...
        if isModelPreparingAfterDownload {
            return String(format: String(localized: "onboarding.dictation_test.preparation.optimizing_subtitle", defaultValue: "Optimizing **%@** for this Mac.\n%@ will unlock when it is ready.", bundle: .module, comment: "Onboarding subtitle while optimizing selected backend before dictation test"), "\(selectedBackend.label)", "\(unlockCopy)")
        }
        return String(format: String(localized: "onboarding.dictation_test.preparation.preparing_subtitle", defaultValue: "Preparing **%@** for your first test.\n%@ will unlock when the model is ready.", bundle: .module, comment: "Onboarding subtitle while preparing selected backend before first dictation test"), "\(selectedBackend.label)", "\(unlockCopy)")
    }

    private var modelPreparationHints: [String] {
        if selectedBackend.backend == "whisper" {
            return [
                String(localized: "onboarding.model_preparation.hint.compiling_coreml", defaultValue: "Compiling CoreML files for the Neural Engine", bundle: .module, comment: "Onboarding hint text while compiling CoreML files for Neural Engine"),
                String(localized: "onboarding.model_preparation.hint.preparing_first_dictation_test", defaultValue: "Preparing the first dictation test", bundle: .module, comment: "Onboarding hint text while preparing first dictation test"),
                String(localized: "onboarding.model_preparation.hint.future_launches_skip_most", defaultValue: "Future launches will skip most of this", bundle: .module, comment: "Onboarding hint text indicating future launches skip preparation"),
                String(localized: "onboarding.model_preparation.hint.bring_forward_when_ready", defaultValue: "We'll bring Muesli forward when ready", bundle: .module, comment: "Onboarding hint text indicating app will come forward when ready"),
            ]
        }
        return [
            String(localized: "onboarding.model_preparation.status.preparing_first_dictation_test", defaultValue: "Preparing the first dictation test", bundle: .module, comment: "Onboarding preparation status text for first dictation test"),
            String(localized: "onboarding.model_preparation.status.future_launches_skip_most", defaultValue: "Future launches will skip most of this", bundle: .module, comment: "Onboarding preparation status text about future launches skipping preparation"),
            String(localized: "onboarding.model_preparation.status.bring_forward_when_ready", defaultValue: "We'll bring Muesli forward when ready", bundle: .module, comment: "Onboarding preparation status text indicating app will come forward when ready"),
        ]
    }
    ...
    private var welcomeStep: some View {
        VStack(spacing: MuesliTheme.spacing16) {
            ...
            VStack(spacing: MuesliTheme.spacing8) {
                Text(String(localized: "onboarding.welcome.title", defaultValue: "Welcome to Muesli", bundle: .module, comment: "Onboarding welcome screen title"))
                    .font(MuesliTheme.title1())
                    .foregroundStyle(MuesliTheme.textPrimary)

                Text(String(localized: "onboarding.welcome.subtitle", defaultValue: "Local-first dictation and meeting transcription for macOS.", bundle: .module, comment: "Onboarding welcome screen subtitle"))
                    .font(MuesliTheme.body())
                    .foregroundStyle(MuesliTheme.textSecondary)
            }

            VStack(alignment: .leading, spacing: MuesliTheme.spacing8) {
                Text(String(localized: "onboarding.welcome.name_label", defaultValue: "Your name", bundle: .module, comment: "Onboarding field label for user name"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textTertiary)

                OnboardingTextField(text: $userName, placeholder: String(localized: "onboarding.welcome.name_placeholder", defaultValue: "Enter your name", bundle: .module, comment: "Onboarding placeholder for user name input"), onSubmit: {
            ...
            VStack(spacing: MuesliTheme.spacing8) {
                Text(String(localized: "onboarding.welcome.use_case_prompt", defaultValue: "What will you use Muesli for?", bundle: .module, comment: "Onboarding prompt asking intended use case"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textTertiary)
                ...
                LazyVGrid(
                    ...
                    useCaseCard(
                        icon: "waveform",
                        title: String(localized: "onboarding.welcome.use_case.voice_notes.title", defaultValue: "Voice Notes", bundle: .module, comment: "Onboarding use case option title for voice notes"),
                        subtitle: String(localized: "onboarding.welcome.use_case.voice_notes.subtitle", defaultValue: "Record in Muesli", bundle: .module, comment: "Onboarding use case option subtitle for voice notes"),
                    ...
                    useCaseCard(
                        icon: "keyboard.fill",
                        title: String(localized: "onboarding.welcome.use_case.dictation.title", defaultValue: "Dictation", bundle: .module, comment: "Onboarding use case option title for dictation"),
                        subtitle: String(localized: "onboarding.welcome.use_case.dictation.subtitle", defaultValue: "Paste into apps", bundle: .module, comment: "Onboarding use case option subtitle for dictation"),
                    ...
                    useCaseCard(
                        icon: "person.2.fill",
                        title: String(localized: "onboarding.welcome.use_case.meetings.title", defaultValue: "Meetings", bundle: .module, comment: "Onboarding use case option title for meetings"),
                        subtitle: String(localized: "onboarding.welcome.use_case.meetings.subtitle", defaultValue: "Notes and summaries", bundle: .module, comment: "Onboarding use case option subtitle for meetings"),
                    ...
                    useCaseCard(
                        ...
                        title: String(localized: "onboarding.welcome.use_case.everything.title", defaultValue: "Everything", bundle: .module, comment: "Onboarding use case option title for combined usage"),
                        subtitle: String(localized: "onboarding.welcome.use_case.everything.subtitle", defaultValue: "Dictation + meetings", bundle: .module, comment: "Onboarding use case option subtitle for combined dictation and meetings"),
    ...
    private var modelStep: some View {
        VStack(spacing: MuesliTheme.spacing16) {
            VStack(spacing: MuesliTheme.spacing8) {
                Text(String(localized: "onboarding.model.choose_transcription_model", defaultValue: "Choose your transcription model", bundle: .module, comment: "Onboarding step title for selecting transcription model"))
                    .font(MuesliTheme.title1())
                    .foregroundStyle(MuesliTheme.textPrimary)
            ...
            ScrollView {
                VStack(spacing: MuesliTheme.spacing8) {
                    ...
                    Button {
                        ...
                        HStack(spacing: 4) {
                            Text(String(localized: "onboarding.model.other_models", defaultValue: "Other models", bundle: .module, comment: "Section label for additional model choices during onboarding"))
                                .font(MuesliTheme.caption())
                    ...
                    if showMoreModels {
                        ...
                        Text(String(localized: "onboarding.model.more_models_after_onboarding", defaultValue: "More models are available after onboarding.", bundle: .module, comment: "Helper text noting more models available after onboarding"))
    ...
    private var cohereLanguageCard: some View {
        VStack(alignment: .leading, spacing: MuesliTheme.spacing8) {
            ...
            Text(String(localized: "onboarding.cohere.language_description", defaultValue: "Cohere does not auto-detect language, so pick the language you want it to transcribe.", bundle: .module, comment: "Description for Cohere language selection explaining manual choice"))
                .font(MuesliTheme.caption())
                .foregroundStyle(MuesliTheme.textSecondary)
                ...
                VStack(alignment: .leading, spacing: 2) {
                    HStack(spacing: 6) {
                        ...
                        if option == BackendOption.onboardingDefault {
                            Text(String(localized: "onboarding.model.recommended", defaultValue: "Recommended", bundle: .module, comment: "Badge label indicating recommended model option"))
                                .font(.system(size: 9, weight: .semibold))
                                .foregroundStyle(.white)
    ...
    private var permissionSteps: [(icon: String, name: String, description: String, granted: Bool, action: () -> Void)] {
        var steps: [(String, String, String, Bool, () -> Void)] = [
            ("mic.fill", "Microphone", String(localized: "onboarding.permissions.step.microphone.description", defaultValue: "Record audio for voice notes, dictation, and meetings", bundle: .module, comment: "Permissions step description for microphone access"), micGranted, {
        ...
        if selectedUseCase.includesPushToTalk {
            if selectedUseCase.includesDictation {
                steps += [
                    ("hand.raised.fill", "Accessibility", String(localized: "onboarding.permissions.step.accessibility.description", defaultValue: "Paste transcribed text into other apps", bundle: .module, comment: "Permissions step description for accessibility access"), accessibilityGranted, requestAccessibilityPermission),
                ]
            }
            steps += [
            ("keyboard.fill", "Input Monitoring", String(localized: "onboarding.permissions.step.input_monitoring.description", defaultValue: "Detect hotkey for push-to-talk recording", bundle: .module, comment: "Permissions step description for input monitoring access"), inputMonitoringGranted, {
    ...
    private var permissionsStep: some View {
        ...
        return VStack(spacing: MuesliTheme.spacing24) {
            ...
            if displayIndex < total {
                ...
                VStack(spacing: MuesliTheme.spacing8) {
                    Text(String(format: String(localized: "onboarding.permissions.progress.permission_of_total", defaultValue: "Permission %d of %d", bundle: .module, comment: "Progress label for current permission step out of total steps"), displayIndex + 1, total))
                ...
                if isWaitingForNativePermissionPrompt(step.name) {
                    Text(String(localized: "onboarding.permissions.respond_prompt", defaultValue: "Respond to the macOS permission prompt", bundle: .module, comment: "Instruction to respond to macOS permission prompt"))
                        .font(.system(size: 11))
                        .foregroundStyle(MuesliTheme.textTertiary)
                } else {
                    Button {
                ...
                if step.name == "Input Monitoring", grantingPermissionName == step.name {
                    Button {
                        ...
                        Text(String(localized: "onboarding.permissions.manual_add_hint", defaultValue: "Need to add Muesli manually? Open Applications", bundle: .module, comment: "Hint for manually adding Muesli in permissions settings"))
                            .font(.system(size: 11))
                            .foregroundStyle(MuesliTheme.textTertiary)
                    }
                    .buttonStyle(.plain)
                ...
                if selectedUseCase.canSwitchToVoiceNotesOnly && step.name == "Accessibility" {
                    Button {
                        ...
                        VStack(spacing: 2) {
                            Text(String(localized: "onboarding.permissions.use_voice_notes", defaultValue: "Use Voice Notes instead", bundle: .module, comment: "Action label to switch to voice notes flow"))
                                .font(.system(size: 12, weight: .semibold))
                            Text(String(localized: "onboarding.permissions.voice_notes_subtitle", defaultValue: "Keeps the hotkey, skips paste permission", bundle: .module, comment: "Subtitle explaining voice notes alternative permission path"))
    ...
    private func permissionButtonTitle(for permissionName: String, isConfirmingGrant: Bool) -> String {
        if isConfirmingGrant { return String(localized: "onboarding.permissions.button.granted", defaultValue: "Granted", bundle: .module, comment: "Permission button label when permission is already granted") }
        if isWaitingForNativePermissionPrompt(permissionName) { return String(localized: "onboarding.permissions.button.waiting_for_macos", defaultValue: "Waiting for macOS...", bundle: .module, comment: "Permission button label while waiting for macOS permission update") }
        ...
        return String(localized: "onboarding.permissions.button.grant_permission", defaultValue: "Grant Permission", bundle: .module, comment: "Permission button label to grant permission")
    }
    ...
    private func permissionRow(icon: String, name: String, description: String, granted: Bool, action: @escaping () -> Void) -> some View {
        HStack(spacing: MuesliTheme.spacing12) {
            ...
            if granted {
                ...
                Button(String(localized: "onboarding.permissions.grant_button", defaultValue: "Grant", bundle: .module, comment: "Generic grant action button label in onboarding permissions")) {
                    action()
                }
                .buttonStyle(.plain)
    ...
    private var hotkeyStep: some View {
        VStack(spacing: MuesliTheme.spacing24) {
            ...
            VStack(spacing: MuesliTheme.spacing8) {
                Text(String(localized: "onboarding.hotkey.title", defaultValue: "Dictation Shortcut", bundle: .module, comment: "Onboarding step title for selecting dictation shortcut"))
                    .font(MuesliTheme.title1())
                    .foregroundStyle(MuesliTheme.textPrimary)

                Text(String(localized: "onboarding.hotkey.instructions", defaultValue: "Choose the key you'll hold to dictate. Press and hold the key to record, release to transcribe.", bundle: .module, comment: "Instructions for choosing and using dictation hotkey during onboarding"))
                    .font(MuesliTheme.body())
                    .foregroundStyle(MuesliTheme.textSecondary)
                    .multilineTextAlignment(.center)
            }
            ...
            VStack(spacing: MuesliTheme.spacing16) {
                ...
                Button {
                    ...
                    Text(isRecordingHotkey ? String(localized: "onboarding.hotkey.press_modifier_prompt", defaultValue: "Press a modifier key...", bundle: .module, comment: "Prompt shown while waiting for modifier key input") : String(localized: "onboarding.hotkey.change_shortcut", defaultValue: "Change Shortcut", bundle: .module, comment: "Button label to change selected dictation shortcut"))
                        .font(MuesliTheme.body())
            ...
            Text(String(localized: "onboarding.hotkey.supported_keys", defaultValue: "Supported: Left Cmd, Right Cmd, Fn, Ctrl, Option, Shift", bundle: .module, comment: "Help text listing supported modifier keys for dictation shortcut"))
                .font(MuesliTheme.caption())
                .foregroundStyle(MuesliTheme.textTertiary)
    ...
    private var dictationTestStep: some View {
        VStack(spacing: MuesliTheme.spacing24) {
            ...
            VStack(spacing: MuesliTheme.spacing8) {
                Text(selectedUseCase.includesVoiceNotes ? String(localized: "onboarding.dictation_test.voice_note", defaultValue: "Test Voice Note", bundle: .module, comment: "Button label for running voice note test during onboarding") : String(localized: "onboarding.dictation_test.test_dictation", defaultValue: "Test Dictation", bundle: .module, comment: "Button label for testing dictation during onboarding"))
                    .font(MuesliTheme.title1())
                    .foregroundStyle(MuesliTheme.textPrimary)
                ...
                if isSelectedModelReadyForDictationTest {
                    Text(String(localized: "onboarding.dictation_test.try_saying_example", defaultValue: "Try saying: \"testing this one out\"", bundle: .module, comment: "Example phrase prompt for onboarding dictation test"))
            ...
            if !isSelectedModelReadyForDictationTest {
                VStack(spacing: MuesliTheme.spacing8) {
                    if isModelPreparingAfterDownload {
                        ...
                        Text(modelDownloadStatus ?? String(format: String(localized: "onboarding.dictation_test.status.preparing_backend", defaultValue: "Preparing %@...", bundle: .module, comment: "Dictation test status while preparing selected backend"), "\(selectedBackend.label)"))
                            .font(.system(size: 11, weight: .medium, design: .rounded))
                            .foregroundStyle(MuesliTheme.textTertiary)
                        Text(String(localized: "onboarding.dictation_test.first_run_timing", defaultValue: "This usually takes 20-60 seconds the first time.", bundle: .module, comment: "Helper text about first run preparation timing for dictation test"))
                            .font(.system(size: 10, weight: .medium, design: .rounded))
                            .foregroundStyle(MuesliTheme.textTertiary)
                        ...
                        ProgressView(value: modelDownloadProgress, total: 1.0)
                            .frame(width: 260)
                        Text(modelDownloadStatus ?? String(format: String(localized: "onboarding.dictation_test.model_download.percent_complete", defaultValue: "%d%% complete", bundle: .module, comment: "Model download progress percentage during dictation test onboarding"), Int((modelDownloadProgress * 100).rounded())))
                            .font(.system(size: 11, weight: .medium, design: .rounded))
                            .foregroundStyle(MuesliTheme.textTertiary)
                    } else {
                        ProgressView()
                            .controlSize(.regular)
                        Text(modelDownloadStatus ?? String(format: String(localized: "onboarding.dictation_test.status.preparing_backend_secondary", defaultValue: "Preparing %@...", bundle: .module, comment: "Secondary dictation test status while preparing selected backend"), "\(selectedBackend.label)"))
                            .font(.system(size: 11, weight: .medium, design: .rounded))
                            .foregroundStyle(MuesliTheme.textTertiary)
                    }
                    Text(String(localized: "onboarding.dictation_test.disabled_until_warmup", defaultValue: "The dictation test is disabled until download and warmup complete.", bundle: .module, comment: "Disabled state message for dictation test before download and warmup finish"))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textTertiary)
                        .multilineTextAlignment(.center)
                    ...
                    if let modelDownloadError {
                        ...
                        Button(String(localized: "onboarding.dictation_test.retry_download", defaultValue: "Retry Download", bundle: .module, comment: "Action button label to retry model download during dictation test onboarding")) {
                ...
                VStack(spacing: MuesliTheme.spacing16) {
                    Text(dictationTestResult ?? String(localized: "onboarding.dictation_test.placeholder.transcription_output", defaultValue: "Your transcription will appear here...", bundle: .module, comment: "Placeholder text for dictation test transcription output area"))
                    ...
                    if isDictationTesting {
                        HStack(spacing: 8) {
                            ProgressView()
                                .controlSize(.small)
                            Text(String(format: String(localized: "onboarding.dictation_test.status.listening_release_hotkey", defaultValue: "Listening... release %@ when done", bundle: .module, comment: "Dictation test listening status with selected hotkey instruction"), "\(selectedHotkey.label)"))
                                .font(MuesliTheme.caption())
                                .foregroundStyle(MuesliTheme.textSecondary)
                        }
                        ...
                        HStack(spacing: 6) {
                            Image(systemName: "keyboard")
                                .font(.system(size: 14))
                            Text(String(format: String(localized: "onboarding.dictation_test.status.hold_hotkey_to_start", defaultValue: "Hold %@ to start", bundle: .module, comment: "Dictation test prompt to hold selected hotkey to begin"), "\(selectedHotkey.label)"))
                                .font(MuesliTheme.body())
                        }
                        .foregroundStyle(MuesliTheme.textTertiary)
                    }
                    ...
                    if dictationTestResult != nil {
                        HStack(spacing: 6) {
                            Image(systemName: "checkmark.circle.fill")
                                .foregroundStyle(MuesliTheme.success)
                            Text(String(localized: "onboarding.dictation_test.success", defaultValue: "Dictation is working!", bundle: .module, comment: "Success message after dictation test works"))
                                .font(MuesliTheme.body())
                                .foregroundStyle(MuesliTheme.success)
                        }
                    }
    ...
    private var meetingSummaryStep: some View {
        VStack(spacing: MuesliTheme.spacing24) {
            ...
            VStack(spacing: MuesliTheme.spacing8) {
                Text(String(localized: "onboarding.meeting_summary.title", defaultValue: "Meeting Summaries", bundle: .module, comment: "Onboarding step title for meeting summaries setup"))
                    .font(MuesliTheme.title1())
                    .foregroundStyle(MuesliTheme.textPrimary)
            ...
            HStack(spacing: 0) {
                providerTab(String(localized: "onboarding.meeting_summary.provider.chatgpt", defaultValue: "ChatGPT", bundle: .module, comment: "Meeting summaries provider option label for ChatGPT"), selected: summaryBackend == .chatGPT) {
                    summaryBackend = .chatGPT
                    apiKey = ""
                }
                providerTab(String(localized: "onboarding.meeting_summary.provider.openai", defaultValue: "OpenAI", bundle: .module, comment: "Meeting summaries provider option label for OpenAI"), selected: summaryBackend == .openAI) {
                    summaryBackend = .openAI
                    apiKey = ""
                }
                providerTab(String(localized: "onboarding.meeting_summary.provider.openrouter", defaultValue: "OpenRouter", bundle: .module, comment: "Meeting summaries provider option label for OpenRouter"), selected: summaryBackend == .openRouter) {
                    summaryBackend = .openRouter
                    apiKey = ""
                }
                providerTab(String(localized: "onboarding.meeting_summary.provider.ollama", defaultValue: "Ollama", bundle: .module, comment: "Meeting summaries provider option label for Ollama"), selected: summaryBackend == .ollama) {
            ...
            if summaryBackend == .chatGPT {
                Text(String(localized: "onboarding.meeting_summary.chatgpt_subscription_note", defaultValue: "Use your ChatGPT Plus or Pro subscription.", bundle: .module, comment: "Helper note for ChatGPT provider subscription requirement"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textSecondary)
                ...
                if appState.isChatGPTAuthenticated || chatGPTSignInDone {
                    HStack(spacing: 6) {
                        ...
                        Text(String(localized: "onboarding.meeting_summary.chatgpt_signed_in", defaultValue: "Signed in with ChatGPT", bundle: .module, comment: "Status text indicating ChatGPT account is signed in during onboarding"))
                    ...
                    HStack(spacing: 8) {
                        ProgressView()
                            .controlSize(.small)
                        Text(String(localized: "onboarding.meeting_summary.signing_in", defaultValue: "Signing in...", bundle: .module, comment: "Status text while signing into ChatGPT during onboarding"))
                            .font(.system(size: 12))
                            .foregroundStyle(MuesliTheme.textSecondary)
                    }
                } else {
                    Button {
                        ...
                        HStack(spacing: 6) {
                            OpenAILogoShape()
                                .fill(.white)
                                .frame(width: 14, height: 14)
                            Text(String(localized: "onboarding.meeting_summary.sign_in_chatgpt", defaultValue: "Sign in with ChatGPT", bundle: .module, comment: "Action button text to sign in with ChatGPT during onboarding"))
                                .font(.system(size: 13, weight: .medium))
                                .foregroundStyle(.white)
                        }
                        .padding(.horizontal, 16)
                ...
                Text(String(localized: "onboarding.meeting_summary.ollama_description", defaultValue: "Run AI models locally on your device with Ollama.\nNo API key needed — just install Ollama and pull a model.", bundle: .module, comment: "Description text for Ollama provider option during onboarding"))
                    .font(MuesliTheme.caption())
                    .foregroundStyle(MuesliTheme.textSecondary)
                    .multilineTextAlignment(.center)

                VStack(alignment: .leading, spacing: MuesliTheme.spacing8) {
                    Text(String(localized: "onboarding.meeting_summary.ollama_default_url", defaultValue: "Ollama is served by default at http://localhost:11434", bundle: .module, comment: "Helper text showing default Ollama server URL during onboarding"))
                        .font(.system(size: 11))
                        .foregroundStyle(MuesliTheme.textTertiary)
                    ...
                    HStack(spacing: 4) {
                        ...
                        Text(String(localized: "onboarding.meeting_summary.no_auth_required", defaultValue: "No authentication required", bundle: .module, comment: "Helper text indicating selected provider requires no authentication"))
                            .font(.system(size: 11))
                            .foregroundStyle(MuesliTheme.success)
                    }
                }
                ...
                if summaryBackend == .openRouter {
                    Text(String(localized: "onboarding.meeting_summary.openrouter_description", defaultValue: "OpenRouter supports many model providers through one API key.", bundle: .module, comment: "Description text for OpenRouter provider option during onboarding"))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textTertiary)
                }

                VStack(alignment: .leading, spacing: MuesliTheme.spacing8) {
                    Text(String(localized: "onboarding.meeting_summary.api_key_label", defaultValue: "API Key", bundle: .module, comment: "Label for API key field in meeting summary provider setup"))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textTertiary)
                    ...
                    HStack(spacing: 4) {
                        Circle()
                            ...
                            .frame(width: 6, height: 6)
                        Text(apiKey.isEmpty ? String(localized: "onboarding.meeting_summary.no_api_key", defaultValue: "No API key", bundle: .module, comment: "Status text indicating no API key is entered") : String(localized: "onboarding.meeting_summary.key_entered", defaultValue: "Key entered", bundle: .module, comment: "Status text indicating an API key has been entered"))
                            .font(.system(size: 11))
    ...
    private func ensureModelDownloadStarted() {
        if modelReadyBackend == selectedBackend {
            ...
            modelDownloadStatus = String(format: String(localized: "onboarding.model_preparation.selected_backend_ready.primary", defaultValue: "%@ ready", bundle: .module, comment: "Primary onboarding status indicating selected backend is ready"), "\(selectedBackend.label)")
            modelDownloadError = nil
            publishModelPreparationStatus(
                title: String(format: String(localized: "onboarding.model_preparation.selected_backend_ready.secondary", defaultValue: "%@ ready", bundle: .module, comment: "Secondary onboarding status indicating selected backend is ready"), "\(selectedBackend.label)"),
                detail: String(localized: "onboarding.model_preparation.ready_for_transcription.secondary", defaultValue: "Ready for transcription", bundle: .module, comment: "Secondary onboarding status text indicating readiness for transcription"),
                progress: 1.0,
                isPreparing: false,
                isComplete: true
            )
        ...
        modelDownloadStatus = alreadyDownloaded
            ? String(format: String(localized: "onboarding.model_preparation.warming_up", defaultValue: "Warming up %@...", bundle: .module, comment: "Onboarding status text while warming up selected backend"), "\(backend.label)")
            : (modelDownloadStatus ?? initialDownloadStatus(for: backend))
        modelDownloadError = nil
        modelDownloadSnapshot = nil
        publishModelPreparationStatus(
            title: String(format: String(localized: "onboarding.model_preparation.preparing_backend", defaultValue: "Preparing %@", bundle: .module, comment: "Onboarding status text while preparing selected backend"), "\(backend.label)"),
        ...
        modelDownloadTask = Task {
            ...
            do {
                ...
                await MainActor.run {
                    ...
                    modelDownloadSnapshot = nil
                    isModelPreparingAfterDownload = false
                    modelDownloadStatus = String(format: String(localized: "onboarding.model_preparation.backend_ready.primary", defaultValue: "%@ ready", bundle: .module, comment: "Primary onboarding status indicating backend is ready"), "\(backend.label)")
                    modelDownloadError = nil
                    withAnimation { isModelStillDownloading = false }
                    publishModelPreparationStatus(
                        title: String(format: String(localized: "onboarding.model_preparation.backend_ready.secondary", defaultValue: "%@ ready", bundle: .module, comment: "Secondary onboarding status indicating backend is ready"), "\(backend.label)"),
                        detail: String(localized: "onboarding.model_preparation.ready_for_transcription.primary", defaultValue: "Ready for transcription", bundle: .module, comment: "Primary onboarding status text indicating readiness for transcription"),
                        progress: 1.0,
                        isPreparing: false,
                        isComplete: true
                    )
                ...
                await MainActor.run {
                    ...
                    modelDownloadStatus = backend.isDownloaded ? String(localized: "onboarding.model_preparation.paused.model_setup", defaultValue: "Model setup paused", bundle: .module, comment: "Onboarding status text when model setup is paused") : String(localized: "onboarding.model_preparation.paused.download", defaultValue: "Download paused", bundle: .module, comment: "Onboarding status text when download is paused")
                    ...
                    isModelStillDownloading = false
                    publishModelPreparationStatus(
                        title: backend.isDownloaded ? String(localized: "onboarding.model_preparation.paused.model_setup.secondary", defaultValue: "Model setup paused", bundle: .module, comment: "Status text when model setup is paused (secondary instance).") : String(localized: "onboarding.model_preparation.paused.download.secondary", defaultValue: "Download paused", bundle: .module, comment: "Status text when download is paused (secondary instance)."),
    ...
    private func applyModelDownloadSnapshot(
        ...
        case .preparing:
            ...
            modelDownloadProgress = nil
            modelDownloadStatus = snapshot.message ?? String(format: String(localized: "onboarding.model_preparation.progress.preparing_backend.ellipsis", defaultValue: "Preparing %@...", bundle: .module, comment: "Progress text while preparing the selected backend with trailing ellipsis."), "\(backend.label)")
        case .ready:
            modelDownloadStatus = snapshot.message ?? String(format: String(localized: "onboarding.model_preparation.progress.backend_ready", defaultValue: "%@ ready", bundle: .module, comment: "Progress text indicating selected backend is ready."), "\(backend.label)")
        case .paused:
            isModelStillDownloading = false
            isModelPreparingAfterDownload = false
            modelDownloadStatus = snapshot.message ?? String(localized: "onboarding.model_download.paused.progress", defaultValue: "Download paused", bundle: .module, comment: "Model download progress state when paused.")
        case .failed:
            isModelStillDownloading = false
            isModelPreparingAfterDownload = false
            modelDownloadError = snapshot.message
            modelDownloadStatus = snapshot.message ?? String(localized: "onboarding.model_download.failed", defaultValue: "Download failed", bundle: .module, comment: "")
        }
    ...
    private func applyModelPreparationProgress(
        ...
        guard modelDownloadGeneration == generation,
              modelDownloadBackend == backend,
              selectedBackend == backend else { return }
        let detail = status ?? String(format: String(localized: "onboarding.model_preparation.status.preparing_backend.ellipsis", defaultValue: "Preparing %@...", bundle: .module, comment: "Status text while preparing backend with trailing ellipsis."), "\(backend.label)")
        ...
        if isPreparing {
            isModelPreparingAfterDownload = true
            modelDownloadStatus = String(format: String(localized: "onboarding.model_preparation.optimizing_for_mac", defaultValue: "Optimizing %@ for this Mac...", bundle: .module, comment: "Status text while optimizing backend for current Mac."), "\(backend.label)")
            publishModelPreparationStatus(
                title: String(format: String(localized: "onboarding.model_preparation.status.preparing_backend", defaultValue: "Preparing %@", bundle: .module, comment: "Status text while preparing backend without ellipsis."), "\(backend.label)"),
                detail: modelDownloadStatus,
                progress: nil,
                isPreparing: true,
                isComplete: false
    ...
    private func initialDownloadStatus(for backend: BackendOption) -> String {
        ...
        if !size.isEmpty {
            return String(format: String(localized: "onboarding.model_download.initial_status", defaultValue: "0 MB of %@", bundle: .module, comment: "Initial model download size status before progress begins."), "\(size)")
        }
        return String(format: String(localized: "onboarding.model_download.starting_download", defaultValue: "Starting %@ download...", bundle: .module, comment: "Status text when beginning backend model download."), "\(backend.label)")
    }

    private func modelPreparationFailureMessage(for backend: BackendOption) -> String {
        backend.isDownloaded
            ? String(localized: "onboarding.model_preparation.failure_setup", defaultValue: "Model setup failed. Restart Muesli or retry from Models.", bundle: .module, comment: "Failure message for model setup.")
            : String(localized: "onboarding.model_download.failure_check_connection", defaultValue: "Download failed. Check your connection and retry.", bundle: .module, comment: "Failure message for model download with retry guidance.")
    }
    ...
    private var googleCalendarStep: some View {
        VStack(spacing: MuesliTheme.spacing24) {
            ...
            VStack(spacing: MuesliTheme.spacing8) {
                Text(String(localized: "onboarding.google_calendar.title", defaultValue: "Google Calendar", bundle: .module, comment: "Onboarding section title for Google Calendar integration."))
                    .font(MuesliTheme.title1())
                    .foregroundStyle(MuesliTheme.textPrimary)

                Text(String(localized: "onboarding.google_calendar.connect_description", defaultValue: "Connect Google Calendar to see upcoming meetings.\nYou can set this up later in Settings.", bundle: .module, comment: "Description text for Google Calendar onboarding connection step."))
                    .font(MuesliTheme.body())
                    .foregroundStyle(MuesliTheme.textSecondary)
                    .multilineTextAlignment(.center)
            }
            ...
            VStack(spacing: MuesliTheme.spacing12) {
                if googleCalSignInDone {
                    HStack(spacing: 6) {
                        Image(systemName: "checkmark.circle.fill")
                            .foregroundStyle(MuesliTheme.success)
                        Text(String(localized: "onboarding.google_calendar.connected", defaultValue: "Google Calendar connected", bundle: .module, comment: "Status text indicating Google Calendar is connected."))
                            .font(MuesliTheme.body())
                            .foregroundStyle(MuesliTheme.textPrimary)
                    }
                    ...
                    HStack(spacing: 8) {
                        ProgressView()
                            .controlSize(.small)
                        Text(String(localized: "onboarding.google_calendar.connecting", defaultValue: "Connecting...", bundle: .module, comment: "Status text while connecting Google Calendar."))
                            .font(MuesliTheme.body())
                            .foregroundStyle(MuesliTheme.textSecondary)
                    }
                    ...
                    VStack(spacing: 6) {
                        HStack(spacing: 6) {
                            Image(systemName: "calendar.badge.plus")
                                .font(.system(size: 14))
                            Text(String(localized: "onboarding.google_calendar.connect_action", defaultValue: "Connect Google Calendar", bundle: .module, comment: "Action button title to connect Google Calendar."))
                                .font(.system(size: 14, weight: .medium))
                        }
                        ...
                        Text(String(localized: "onboarding.google_calendar.oauth_verification_pending", defaultValue: "Google OAuth verification pending", bundle: .module, comment: "Status text for pending Google OAuth verification."))
                            .font(MuesliTheme.caption())
                            .foregroundStyle(MuesliTheme.textTertiary)
                    }
                    ...
                    Button {
                        ...
                        HStack(spacing: 6) {
                            Image(systemName: "calendar.badge.plus")
                                .font(.system(size: 14))
                            Text(String(localized: "onboarding.google_calendar.connect_action.secondary", defaultValue: "Connect Google Calendar", bundle: .module, comment: "Secondary connect action label for Google Calendar onboarding."))
                                .font(.system(size: 14, weight: .medium))
                        }
                        .foregroundStyle(.white)
                        .padding(.horizontal, MuesliTheme.spacing16)
                    ...
                    Text(String(localized: "onboarding.google_calendar.credentials_not_configured", defaultValue: "Google Calendar credentials not configured.", bundle: .module, comment: "Error text when Google Calendar credentials are missing."))
                        .font(MuesliTheme.caption())
                        .foregroundStyle(MuesliTheme.textTertiary)
                }
            }
    ...
    private func finishOnboarding(withKey: Bool) {
        ...
        if shouldContinueModelPreparation {
            ...
            publishModelPreparationStatus(
                title: modelReadyBackend == selectedBackend ? String(format: String(localized: "onboarding.model_preparation.ready", defaultValue: "%@ ready", bundle: .module, comment: "Model preparation status indicating selected backend is ready."), "\(selectedBackend.label)") : String(format: String(localized: "onboarding.model_preparation.preparing", defaultValue: "Preparing %@", bundle: .module, comment: "Model preparation status while preparing selected backend."), "\(selectedBackend.label)"),
                detail: modelReadyBackend == selectedBackend ? String(localized: "onboarding.model_preparation.ready_for_transcription", defaultValue: "Ready for transcription", bundle: .module, comment: "Model preparation status indicating transcription readiness.") : modelDownloadStatus,
