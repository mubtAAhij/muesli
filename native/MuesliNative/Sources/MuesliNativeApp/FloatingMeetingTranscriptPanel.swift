...
private struct FloatingMeetingTranscriptPanelView: View {
    ...
    private var header: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            Text(String(localized: "floating_meeting_transcript_panel.header.live_transcript", defaultValue: "Live transcript", bundle: .module, comment: "Header title for the floating live meeting transcript panel."))
            ...
            Text(model.isPaused ? String(localized: "floating_meeting_transcript_panel.status.paused", defaultValue: "Paused", bundle: .module, comment: "Status label when floating live transcript is paused.") : String(localized: "floating_meeting_transcript_panel.status.live", defaultValue: "Live", bundle: .module, comment: "Status label when floating live transcript is active."))
            ...
            .buttonStyle(.plain)
            .help(String(localized: "floating_meeting_transcript_panel.help.hide_live_transcript", defaultValue: "Hide live transcript", bundle: .module, comment: "Help text for control that hides the floating live transcript panel."))
            ...
            .help(String(localized: "floating_meeting_transcript_panel.help.copy_transcript", defaultValue: "Copy transcript", bundle: .module, comment: "Help text for control that copies transcript text from the floating panel."))
        }
