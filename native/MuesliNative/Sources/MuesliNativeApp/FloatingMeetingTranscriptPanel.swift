...
private struct FloatingMeetingTranscriptPanelView: View {
    ...
    private var header: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            Text(String(localized: "floating_meeting_transcript_panel.header.live_transcript", defaultValue: "Live transcript", comment: "Header title for floating live transcript panel"))
            ...
            Text(model.isPaused ? String(localized: "floating_meeting_transcript_panel.status.paused", defaultValue: "Paused", comment: "Status text when live transcript is paused") : String(localized: "floating_meeting_transcript_panel.status.live", defaultValue: "Live", comment: "Status text when live transcript is active"))
            ...
            .buttonStyle(.plain)
            .help(String(localized: "floating_meeting_transcript_panel.help.hide_live_transcript", defaultValue: "Hide live transcript", comment: "Help text for control that hides live transcript panel"))
