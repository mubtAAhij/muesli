...
private struct FloatingMeetingTranscriptPanelView: View {
    ...
    private var header: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            Text(String(localized: "floating_meeting_transcript_panel.header.live_transcript", defaultValue: "Live transcript", comment: "Header title for the floating live meeting transcript panel"))
            ...
            Text(model.isPaused ? String(localized: "floating_meeting_transcript_panel.status.paused", defaultValue: "Paused", comment: "Status label when the floating meeting transcript is paused") : String(localized: "floating_meeting_transcript_panel.status.live", defaultValue: "Live", comment: "Status label when the floating meeting transcript is live"))
            ...
            .buttonStyle(.plain)
            .help(String(localized: "floating_meeting_transcript_panel.help.hide_live_transcript", defaultValue: "Hide live transcript", comment: "Help text for control that hides the live transcript panel"))
            ...
            .help(String(localized: "floating_meeting_transcript_panel.help.copy_transcript", defaultValue: "Copy transcript", comment: "Help text for control that copies transcript text"))
        }
