...
private struct FloatingMeetingTranscriptPanelView: View {
    ...
    private var header: some View {
        HStack(spacing: MuesliTheme.spacing8) {
            ...
            Text(model.isPaused ? String(localized: "floating_meeting_transcript_panel.status.paused", defaultValue: "Paused", bundle: .module, comment: "Status label when live meeting transcript is paused.") : String(localized: "floating_meeting_transcript_panel.status.live", defaultValue: "Live", bundle: .module, comment: "Status label when live meeting transcript is active."))
            ...
            .buttonStyle(.plain)
            .help(String(localized: "floating_meeting_transcript_panel.help.hide_live_transcript", defaultValue: "Hide live transcript", bundle: .module, comment: "Help text for control that hides the live transcript panel."))
            ...
            .help(String(localized: "floating_meeting_transcript_panel.help.copy_transcript", defaultValue: "Copy transcript", bundle: .module, comment: "Help text for control that copies the transcript content."))
        }
