...
struct MeetingRecordingPlayerView: View {
    ...
    var body: some View {
        HStack(spacing: MuesliTheme.spacing12) {
            ...
            .buttonStyle(.plain)
            .disabled(player == nil)
            .help(isPlaying ? String(localized: "meeting_recording_player.help.pause_recording", defaultValue: "Pause recording", bundle: .module, comment: "Accessibility help text for pause recording playback control") : String(localized: "meeting_recording_player.help.play_recording", defaultValue: "Play recording", bundle: .module, comment: "Accessibility help text for play recording playback control"))
            ...
            Group {
                if let waveform {
                    ...
                    Text(String(localized: "meeting_recording_player.status.recording_unavailable", defaultValue: "Recording unavailable", bundle: .module, comment: "Status text shown when recording is unavailable in player view"))
...
private struct RecordingWaveformView: View {
    ...
    var body: some View {
        ...
        .frame(minHeight: 36)
        .accessibilityLabel(String(localized: "meeting_recording_player.accessibility.waveform_label", defaultValue: "Recording waveform", bundle: .module, comment: "Accessibility label for meeting recording waveform visualization"))
    }
