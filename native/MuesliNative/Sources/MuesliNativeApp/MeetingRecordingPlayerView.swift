...
struct MeetingRecordingPlayerView: View {
    ...
    var body: some View {
        HStack(spacing: MuesliTheme.spacing12) {
            ...
            .buttonStyle(.plain)
            .disabled(player == nil)
            .help(isPlaying ? String(localized: "meeting_recording_player.help.pause_recording", defaultValue: "Pause recording", bundle: .module, comment: "Accessibility/help label for pause recording control.") : String(localized: "meeting_recording_player.help.play_recording", defaultValue: "Play recording", bundle: .module, comment: "Accessibility/help label for play recording control."))
            ...
            Group {
                if let waveform {
                    ...
                    Text(String(localized: "meeting_recording_player.status.recording_unavailable", defaultValue: "Recording unavailable", bundle: .module, comment: "Status text when meeting recording cannot be played."))
                    ...
                    HStack(spacing: MuesliTheme.spacing8) {
                        ProgressView()
                            .controlSize(.small)
                        Text(String(localized: "meeting_recording_player.status.loading_recording", defaultValue: "Loading recording", bundle: .module, comment: "Status text while meeting recording is loading."))
                            .font(MuesliTheme.captionMedium())
                            .foregroundStyle(MuesliTheme.textTertiary)
                    }
                    .frame(maxWidth: .infinity, alignment: .leading)
...
private struct RecordingWaveformView: View {
    ...
    var body: some View {
        ...
        .frame(minHeight: 36)
        .accessibilityLabel(String(localized: "meeting_recording_player.accessibility.waveform_label", defaultValue: "Recording waveform", bundle: .module, comment: "Accessibility label for waveform visualization of a recording."))
    }
