...
enum MuesliBridgeDeviceIdentity {
    ...
    private static func currentDeviceName() -> String {
        ...
        return hostName.isEmpty ? String(localized: "sync.device.this_mac", defaultValue: "This Mac", bundle: .module, comment: "Device label referring to the current Mac in sync UI.") : hostName
    }
...
private enum ICloudSyncAccountError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .noAccount:
            return String(localized: "sync.error.account_unavailable", defaultValue: "Sign in to iCloud on this Mac to sync text records.", bundle: .module, comment: "Sync error when iCloud account is not signed in on this Mac.")
        case .restricted:
            return String(localized: "sync.error.restricted", defaultValue: "iCloud is restricted for this Mac.", bundle: .module, comment: "Error message shown when iCloud access is restricted on the device")
        case .temporarilyUnavailable:
            return String(localized: "sync.error.temporarily_unavailable", defaultValue: "iCloud is temporarily unavailable. Try syncing again shortly.", bundle: .module, comment: "Sync error when iCloud service is temporarily unavailable.")
        case .couldNotDetermine:
            return String(localized: "sync.error.cannot_determine_account_status", defaultValue: "Couldn't determine iCloud account status.", bundle: .module, comment: "Sync error when iCloud account status cannot be determined.")
        }
    }
}
...
enum ICloudSyncDeadlineError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        String(localized: "sync.error.timeout_retry", defaultValue: "iCloud did not respond in time. Your text is safe and will be retried.", bundle: .module, comment: "Sync timeout message assuring user their text will be retried safely.")
    }
}
