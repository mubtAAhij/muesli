...
enum MeetingFollowUpPolicy {
    static let titlePrefix = String(localized: "meeting_follow_up_policy.title_prefix", defaultValue: "Follow-up:", bundle: .module, comment: "Prefix used before follow-up meeting title text.") + " "
    ...
    static func followUpTitle(from predecessorTitle: String) -> String {
        ...
        guard !base.isEmpty else { return String(localized: "meeting_follow_up_policy.follow_up_title", defaultValue: "Follow-up meeting", bundle: .module, comment: "Default title for a follow-up meeting.") }
    ...
    static func carriedContext(fromPredecessorNotes notes: String) -> String? {
        ...
        return String(trimmed.prefix(maxCarriedNotesLength)) + "\n" + String(localized: "meeting_follow_up_policy.carried_context.truncated_marker", defaultValue: "[…previous notes truncated]", bundle: .module, comment: "Marker inserted when earlier carried notes are truncated.")
    }
}
