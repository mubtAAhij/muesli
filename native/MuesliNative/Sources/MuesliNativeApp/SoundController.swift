...
enum SoundController {
    ...
    static let maraudersMapPresets: [(id: String, label: String)] = [
        ("bbc_world_news", String(localized: "sound.marauders_map.clip.bbc_world_news.label", defaultValue: "BBC World News", bundle: .module, comment: "Sound clip label for BBC World News in Marauders Map sound options.")),
        ("ndtv", String(localized: "sound.marauders_map.clip.ndtv.label", defaultValue: "NDTV", bundle: .module, comment: "Sound clip label for NDTV in Marauders Map sound options.")),
    ]
    ...
    static func labelForClip(id: String, customPath: String?) -> String {
        ...
        return maraudersMapPresets.first(where: { $0.id == id })?.label ?? String(localized: "sound.marauders_map.selection.bbc_world_news.label", defaultValue: "BBC World News", bundle: .module, comment: "Selected sound label for BBC World News in Marauders Map options.")
    }
