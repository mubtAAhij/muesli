...
enum SoundController {
    ...
    static let maraudersMapPresets: [(id: String, label: String)] = [
        ("bbc_world_news", String(localized: "sound.marauders_map.clip.bbc_world_news.label", defaultValue: "BBC World News", bundle: .module, comment: "Label for the BBC World News sound clip option.")),
        ("ndtv", String(localized: "sound.marauders_map.clip.ndtv.label", defaultValue: "NDTV", bundle: .module, comment: "Label for the NDTV sound clip option.")),
    ]
    ...
    static func labelForClip(id: String, customPath: String?) -> String {
        ...
        return maraudersMapPresets.first(where: { $0.id == id })?.label ?? String(localized: "sound.marauders_map.selection.bbc_world_news.label", defaultValue: "BBC World News", bundle: .module, comment: "Label for selected BBC World News sound clip value.")
    }
