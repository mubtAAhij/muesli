...
enum SoundController {
    ...
    static let maraudersMapPresets: [(id: String, label: String)] = [
        ("bbc_world_news", String(localized: "sound.marauders_map.clip.bbc_world_news.label", defaultValue: "BBC World News", comment: "Display label for the BBC World News preset clip")),
        ("ndtv", String(localized: "sound.marauders_map.clip.ndtv.label", defaultValue: "NDTV", comment: "Display label for the NDTV preset clip")),
    ]
    ...
    static func labelForClip(id: String, customPath: String?) -> String {
        ...
        return maraudersMapPresets.first(where: { $0.id == id })?.label ?? String(localized: "sound.marauders_map.clip.bbc_world_news.label", defaultValue: "BBC World News", comment: "Fallback display label for the BBC World News preset clip")
    }
