...
final class MeetingNotificationController {
    ...
    func show(
        ...
        title: String,
        subtitle: String,
        actionLabel: String = String(localized: "meeting_notification.button.start_recording", defaultValue: "Start Recording", bundle: Bundle.module, comment: "Button title to start meeting recording from notification."),
        meetingURL: URL? = nil,
        ...
        dismissButton.toolTip = String(localized: "meeting_notification.button.dismiss", defaultValue: "Dismiss", bundle: Bundle.module, comment: "Button title to dismiss a meeting notification.")
        ...
        if hasJoinButton {
            ...
            let joinButton = NSButton(title: String(localized: "meeting_notification.button.join_record", defaultValue: "Join & Record", bundle: Bundle.module, comment: "Button title to join meeting and start recording."), target: self, action: #selector(handleJoinAndRecord))
    ...
    @objc private func handleChevronClick(_ sender: NSButton) {
        let menu = NSMenu()
        let joinOnlyItem = NSMenuItem(title: String(localized: "meeting_notification.button.join_only", defaultValue: "Join Only", bundle: Bundle.module, comment: "Button title to join meeting without recording."), action: #selector(handleJoinOnly), keyEquivalent: "")
        joinOnlyItem.target = self
        menu.addItem(joinOnlyItem)

        let recordOnlyItem = NSMenuItem(title: String(localized: "meeting_notification.button.record_only", defaultValue: "Record Only", bundle: Bundle.module, comment: "Button title to start recording without joining call controls."), action: #selector(handleStartRecording), keyEquivalent: "")
