...
final class MeetingNotificationController {
    ...
    func show(
        ...
        dismissButton.toolTip = String(localized: "meeting_notification.button.dismiss", defaultValue: "Dismiss", bundle: .module, comment: "Button title to dismiss a meeting notification.")
        ...
        if hasJoinButton {
            ...
            let joinButton = NSButton(title: String(localized: "meeting_notification.button.join_record", defaultValue: "Join & Record", bundle: .module, comment: "Button title to join meeting and start recording."), target: self, action: #selector(handleJoinAndRecord))
    ...
    @objc private func handleChevronClick(_ sender: NSButton) {
        ...
        let recordOnlyItem = NSMenuItem(title: String(localized: "meeting_notification.button.record_only", defaultValue: "Record Only", bundle: .module, comment: "Button title to start recording without joining call controls."), action: #selector(handleStartRecording), keyEquivalent: "")
