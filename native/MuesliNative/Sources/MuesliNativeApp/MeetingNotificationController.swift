...
final class MeetingNotificationController {
    ...
    @objc private func handleChevronClick(_ sender: NSButton) {
        ...
        let recordOnlyItem = NSMenuItem(title: String(localized: "meeting_notification.button.record_only", defaultValue: "Record Only", bundle: .module, comment: "Button title to record meeting without joining"), action: #selector(handleStartRecording), keyEquivalent: "")
