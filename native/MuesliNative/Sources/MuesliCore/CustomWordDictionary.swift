...
public enum CustomWordDictionaryCodec {
    ...
    public enum Error: Swift.Error, Equatable, LocalizedError {
        ...
        public var errorDescription: String? {
            String(localized: "custom_word_dictionary.error.invalid_dictionary_file", defaultValue: "The file is not a valid Muesli dictionary.", comment: "Error shown when imported custom word dictionary file has invalid format")
        }
    }
