...
func ensureDatabaseAvailable(_ context: CLIContext, command: String) throws {
    guard context.store.databaseExists else {
        throw CLIError.databaseUnavailable(
            String(localized: "cli.error.database_missing_at_resolved_path", defaultValue: "No Muesli database exists at the resolved path.", comment: "Error shown when resolved database path has no Muesli database."),
...
struct MuesliCLI: AsyncParsableCommand {
    ...
    static func specPayload() -> CommandSpecPayload {
        CommandSpecPayload(commands: [
            .init(name: "spec", usage: "muesli-cli spec", summary: String(localized: "cli.spec.description", defaultValue: "Dump the command tree and CLI schema metadata.", comment: "Description for spec command."), examples: ["muesli-cli spec"]),
            .init(name: "info", usage: "muesli-cli info [--db-path <path>] [--support-dir <dir>]", summary: String(localized: "cli.info.description", defaultValue: "Show resolved support and database paths.", comment: "Description for info command."), examples: ["muesli-cli info", "muesli-cli info --support-dir ~/Library/Application\\ Support/Muesli"]),
            .init(name: "transcribe", usage: "muesli-cli transcribe <file> [--format text|json|markdown] [--model parakeet-v3|parakeet-v2|parakeet-eou-320ms|sensevoice|qwen3-asr|nemotron35|whisper-tiny|whisper-tiny-english|whisper-small|whisper-small-english|whisper-medium-english|whisper-large-turbo] [--summarize] [--save-meeting] [--title <title>] [--output <path>] [--dictionary <path>]", summary: String(localized: "cli.transcribe.description", defaultValue: "Transcribe a local mp3, mp4, m4a, or wav file with Muesli's bundled local ASR models.", comment: "Description for transcribe command."), examples: ["muesli-cli transcribe call.mp3", "muesli-cli transcribe call.m4a --format json", "muesli-cli transcribe call.wav --model nemotron35 --dictionary dictionary.json"]),
            .init(name: "meetings list", usage: "muesli-cli meetings list [--limit <n>] [--folder-id <id>]", summary: String(localized: "cli.meetings.list.description", defaultValue: "List recent meetings.", comment: "Description for meetings list command."), examples: ["muesli-cli meetings list --limit 5", "muesli-cli meetings list --folder-id 2"]),
            .init(name: "meetings get", usage: "muesli-cli meetings get <id>", summary: String(localized: "cli.meetings.get.description", defaultValue: "Return a full meeting record.", comment: "Description for meetings get command."), examples: ["muesli-cli meetings get 42"]),
            .init(name: "meetings update-notes", usage: "muesli-cli meetings update-notes <id> (--stdin | --file <path>)", summary: String(localized: "cli.meetings.update_notes.description", defaultValue: "Replace stored meeting notes only.", comment: "Description for meetings update-notes command."), examples: ["muesli-cli meetings update-notes 42 --file notes.md", "cat notes.md | muesli-cli meetings update-notes 42 --stdin"]),
            .init(name: "dictations list", usage: "muesli-cli dictations list [--limit <n>]", summary: String(localized: "cli.dictations.list.description", defaultValue: "List recent dictations.", comment: "Description for dictations list command."), examples: ["muesli-cli dictations list --limit 10"]),
            .init(name: "dictations get", usage: "muesli-cli dictations get <id>", summary: String(localized: "cli.dictations.get.description", defaultValue: "Return a full dictation record.", comment: "Description for dictations get command."), examples: ["muesli-cli dictations get 7"]),
        ])
    }
}

struct SpecCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "spec", abstract: String(localized: "cli.spec.abstract", defaultValue: "Dump CLI command metadata as JSON.", comment: "Abstract for spec command."))
...
struct InfoCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "info", abstract: String(localized: "cli.info.abstract", defaultValue: "Show resolved support and database paths.", comment: "Abstract for info command."))
    @OptionGroup var global: GlobalOptions
...
struct MeetingsCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "meetings", abstract: String(localized: "cli.meetings.abstract", defaultValue: "Inspect and update Muesli meetings.", comment: "Abstract for meetings command group."), subcommands: [MeetingsListCommand.self, MeetingsGetCommand.self, MeetingsUpdateNotesCommand.self])
}

struct MeetingsListCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "list", abstract: String(localized: "cli.meetings.list.abstract", defaultValue: "List recent meetings.", comment: "Abstract for meetings list command."))
    @OptionGroup var global: GlobalOptions
    ...
    func run() throws {
        ...
        if !context.store.databaseExists {
            emitSuccess(command: "muesli-cli meetings list", data: [MeetingListRow](), dbPath: context.databaseURL, warnings: [String(localized: "cli.info.database_missing_at_resolved_path", defaultValue: "No Muesli database exists at the resolved path.", comment: "Info command message when resolved database path has no Muesli database.")])
            return
        }
...
struct MeetingsGetCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "get", abstract: String(localized: "cli.meetings.get.abstract", defaultValue: "Return a full meeting record.", comment: "Abstract for meetings get command."))
    @OptionGroup var global: GlobalOptions
    ...
    func run() throws {
        ...
        guard let meeting = try context.store.meeting(id: id) else {
            throw CLIError.notFound(String(format: String(localized: "cli.meetings.get.error.not_found_by_id", defaultValue: "No meeting exists with id %@.", comment: "Error when meetings get command cannot find requested meeting id."), "\(id)"), fix: "Run `muesli-cli meetings list` to find a valid ID.")
        }
...
struct MeetingsUpdateNotesCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "update-notes", abstract: String(localized: "cli.meetings.update_notes.abstract", defaultValue: "Replace stored meeting notes only.", comment: "Abstract for meetings update-notes command."))
    @OptionGroup var global: GlobalOptions
    @Argument(help: "Meeting ID") var id: Int64
    ...
    func run() throws {
        ...
        guard try context.store.meeting(id: id) != nil else {
            throw CLIError.notFound(String(format: String(localized: "cli.meetings.update_notes.error.not_found_by_id", defaultValue: "No meeting exists with id %@.", comment: "Error when update-notes command cannot find the specified meeting id."), "\(id)"), fix: "Run `muesli-cli meetings list` to find a valid ID.")
        }
        ...
        if stdin {
            ...
            throw CLIError.invalidInput(String(localized: "cli.meetings.update_notes.error.no_notes_source", defaultValue: "No notes source was provided.", comment: "Error when update-notes command has no notes input source."), fix: "Use --stdin or --file <path>.")
        }

        let trimmed = notes.trimmingCharacters(in: .whitespacesAndNewlines)
        guard !trimmed.isEmpty else {
            throw CLIError.invalidInput(String(localized: "cli.meetings.update_notes.error.empty_notes", defaultValue: "Meeting notes cannot be empty.", comment: "Error when notes content is empty for update-notes command."), fix: String(localized: "cli.meetings.update_notes.error.empty_notes_guidance", defaultValue: "Provide a non-empty markdown or plain text notes body.", comment: "Guidance shown when provided meeting notes are empty."))
        }
        ...
        guard let updated = try context.store.meeting(id: id) else {
            throw CLIError.databaseError(String(localized: "cli.error.meeting_updated_but_not_reloaded", defaultValue: "The meeting was updated but could not be reloaded.", comment: "Error when meeting update succeeds but reloading updated record fails."))
        }
...
struct DictationsCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "dictations", abstract: String(localized: "cli.dictations.abstract", defaultValue: "Inspect Muesli dictations.", comment: "Abstract for dictations command group."), subcommands: [DictationsListCommand.self, DictationsGetCommand.self])
}

struct DictationsListCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "list", abstract: String(localized: "cli.dictations.list.abstract", defaultValue: "List recent dictations.", comment: "Abstract for dictations list command."))
    @OptionGroup var global: GlobalOptions
    ...
    func run() throws {
        ...
        if !context.store.databaseExists {
            emitSuccess(command: "muesli-cli dictations list", data: [DictationListRow](), dbPath: context.databaseURL, warnings: [String(localized: "cli.dictations.list.database_missing_at_resolved_path", defaultValue: "No Muesli database exists at the resolved path.", comment: "Error shown when dictations list command cannot find database at resolved path.")])
            return
        }
...
struct DictationsGetCommand: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "get", abstract: String(localized: "cli.dictations.get.abstract", defaultValue: "Return a full dictation record.", comment: "Abstract for dictations get command."))
    @OptionGroup var global: GlobalOptions
    @Argument(help: ArgumentHelp(String(localized: "cli.dictations.get.argument.id", defaultValue: "Dictation ID", comment: "Argument help label for dictation identifier."))) var id: Int64
    ...
    func run() throws {
        ...
        guard let dictation = try context.store.dictation(id: id) else {
            throw CLIError.notFound(String(format: String(localized: "cli.dictations.get.error.not_found", defaultValue: "No dictation exists with id %@.", comment: "Error when dictations get command cannot find the specified dictation id."), "\(id)"), fix: "Run `muesli-cli dictations list` to find a valid ID.")
        }
